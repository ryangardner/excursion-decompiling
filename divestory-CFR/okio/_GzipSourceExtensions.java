...
public final class _GzipSourceExtensions {
    ...
    public static final /* synthetic */ boolean access$getBit(int n, int n2) {
        return _GzipSourceExtensions.getBit(n, n2);
    }

    private static final boolean getBit(int n, int n2) {
        boolean bl = true;
        if ((n >> n2 & 1) != 1) return false;
        return bl;
    }

    public static final GzipSource gzip(Source source2) {
        Intrinsics.checkParameterIsNotNull(source2, "$this$gzip");
        return new GzipSource(source2);
    }
}
