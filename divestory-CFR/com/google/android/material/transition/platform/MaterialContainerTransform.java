...
extends Transition {
    ...
    private static void captureValues(TransitionValues transitionValues, View view, int n, ShapeAppearanceModel shapeAppearanceModel) {
        ...
        transitionValues.values.put(PROP_BOUNDS, view);
    ...
    public Animator createAnimator(ViewGroup object, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (rectF != null && shapeAppearanceModel != null) {
            ...
            if (rectF2 != null && shapeAppearanceModel2 != null) {
                ...
                object2.setBounds(Math.round(transitionValues.left), Math.round(transitionValues.top), Math.round(transitionValues.right), Math.round(transitionValues.bottom));
                ...
                this.addListener((Transition.TransitionListener)new TransitionListenerAdapter((View)object, (TransitionDrawable)((Object)object2), view, (View)transitionValues2){
                    ...
                    public void onTransitionEnd(Transition transition) {
                        MaterialContainerTransform.this.removeListener((Transition.TransitionListener)this);
    ...
    extends Drawable {
        ...
        private TransitionDrawable(PathMotion pathMotion, View view, RectF rectF, ShapeAppearanceModel shapeAppearanceModel, float f, View view2, RectF rectF2, ShapeAppearanceModel shapeAppearanceModel2, float f2, int n, int n2, int n3, int n4, boolean bl, boolean bl2, FadeModeEvaluator fadeModeEvaluator, FitModeEvaluator fitModeEvaluator, ProgressThresholdsGroup progressThresholdsGroup, boolean bl3) {
            ...
            shapeAppearanceModel = (WindowManager)view.getContext().getSystemService("window");
            view = new DisplayMetrics();
            shapeAppearanceModel.getDefaultDisplay().getMetrics((DisplayMetrics)view);
            this.displayWidth = view.widthPixels;
            this.displayHeight = view.heightPixels;
        ...
        private void updateProgress(float f) {
            ...
            float f3 = rectF[0];
            float f4 = rectF[1];
            float f5 = Preconditions.checkNotNull(Float.valueOf(this.progressThresholds.scale.start)).floatValue();
            f2 = Preconditions.checkNotNull(Float.valueOf(this.progressThresholds.scale.end)).floatValue();
            rectF = this.fitModeEvaluator.evaluate(f, f5, f2, this.startBounds.width(), this.startBounds.height(), this.endBounds.width(), this.endBounds.height());
            this.fitModeResult = rectF;
            this.currentStartBounds.set(f3 - rectF.currentStartWidth / 2.0f, f4, this.fitModeResult.currentStartWidth / 2.0f + f3, this.fitModeResult.currentStartHeight + f4);
            this.currentEndBounds.set(f3 - this.fitModeResult.currentEndWidth / 2.0f, f4, f3 + this.fitModeResult.currentEndWidth / 2.0f, this.fitModeResult.currentEndHeight + f4);
            this.currentStartBoundsMasked.set(this.currentStartBounds);
            this.currentEndBoundsMasked.set(this.currentEndBounds);
            f4 = Preconditions.checkNotNull(Float.valueOf(this.progressThresholds.scaleMask.start)).floatValue();
            f2 = Preconditions.checkNotNull(Float.valueOf(this.progressThresholds.scaleMask.end)).floatValue();
            ...
            f2 = TransitionUtils.lerp(0.0f, 1.0f, f4, f2, f);
            if (!bl) {
                f2 = 1.0f - f2;
            }
            ...
            f5 = TransitionDrawable.calculateElevationDxMultiplier(this.currentMaskBounds, this.displayWidth);
            f4 = TransitionDrawable.calculateElevationDyMultiplier(this.currentMaskBounds, this.displayHeight);
            f2 = this.currentElevation;
            f5 = (int)(f5 * f2);
            this.currentElevationDy = f4 = (float)((int)(f4 * f2));
            this.shadowPaint.setShadowLayer(f2, f5, f4, 754974720);
            f4 = Preconditions.checkNotNull(Float.valueOf(this.progressThresholds.fade.start)).floatValue();
            f2 = Preconditions.checkNotNull(Float.valueOf(this.progressThresholds.fade.end)).floatValue();
            this.fadeModeResult = this.fadeModeEvaluator.evaluate(f, f4, f2);
