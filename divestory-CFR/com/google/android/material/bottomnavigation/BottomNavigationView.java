...
extends FrameLayout {
    ...
    public BottomNavigationView(Context context, AttributeSet object, int n) {
        ...
        if (((TintTypedArray)object).hasValue(R.styleable.BottomNavigationView_itemIconTint)) {
            this.menuView.setIconTintList(((TintTypedArray)object).getColorStateList(R.styleable.BottomNavigationView_itemIconTint));
        } else {
        ...
        this.menu.setCallback(new MenuBuilder.Callback(){
            ...
            public boolean onMenuItemSelected(MenuBuilder object, MenuItem menuItem) {
                object = BottomNavigationView.this.reselectedListener;
                boolean bl = true;
                if (object != null && menuItem.getItemId() == BottomNavigationView.this.getSelectedItemId()) {
                    BottomNavigationView.this.reselectedListener.onNavigationItemReselected(menuItem);
                    return true;
                }
                if (BottomNavigationView.this.selectedListener == null) return false;
                if (BottomNavigationView.this.selectedListener.onNavigationItemSelected(menuItem)) return false;
                return bl;
            }
    ...
    public void setItemRippleColor(ColorStateList colorStateList) {
        if (this.itemRippleColor == colorStateList) {
            ...
            if (this.menuView.getItemBackground() == null) return;
    ...
    public void setSelectedItemId(int n) {
        ...
        if (this.menu.performItemAction(menuItem, this.presenter, 0)) return;
