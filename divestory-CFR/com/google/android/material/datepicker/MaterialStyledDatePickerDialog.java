...
extends DatePickerDialog {
    ...
    public MaterialStyledDatePickerDialog(Context object, int n, DatePickerDialog.OnDateSetListener onDateSetListener, int n2, int n3, int n4) {
        ...
        n = MaterialAttributes.resolveOrThrow(this.getContext(), R.attr.colorSurface, ((Object)((Object)this)).getClass().getCanonicalName());
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            ((MaterialShapeDrawable)object).setFillColor(ColorStateList.valueOf((int)0));
        }
