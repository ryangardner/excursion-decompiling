...
Parcelable {
    ...
    public boolean equals(Object object) {
        ...
        object = (Month)object;
        if (this.month != ((Month)object).month) return false;
        if (this.year != ((Month)object).year) return false;
        return bl;
    }
    ...
    int monthsUntil(Month month) {
        if (!(this.firstOfMonth instanceof GregorianCalendar)) throw new IllegalArgumentException("Only Gregorian calendars are supported.");
