...
public class ShapeAppearanceModel {
    ...
    private static Builder builder(Context context, int n, int n2, CornerSize object) {
        ...
        try {
            ...
            Object object3 = ShapeAppearanceModel.getCornerSize((TypedArray)context, R.styleable.ShapeAppearance_cornerSize, (CornerSize)object);
            object2 = ShapeAppearanceModel.getCornerSize((TypedArray)context, R.styleable.ShapeAppearance_cornerSizeTopLeft, (CornerSize)object3);
            CornerSize cornerSize = ShapeAppearanceModel.getCornerSize((TypedArray)context, R.styleable.ShapeAppearance_cornerSizeTopRight, (CornerSize)object3);
            object = ShapeAppearanceModel.getCornerSize((TypedArray)context, R.styleable.ShapeAppearance_cornerSizeBottomRight, (CornerSize)object3);
            CornerSize cornerSize2 = ShapeAppearanceModel.getCornerSize((TypedArray)context, R.styleable.ShapeAppearance_cornerSizeBottomLeft, (CornerSize)object3);
            object3 = new Builder();
            object = ((Builder)object3).setTopLeftCorner(n, (CornerSize)object2).setTopRightCorner(n2, cornerSize).setBottomRightCorner(n3, (CornerSize)object).setBottomLeftCorner(n4, cornerSize2);
            return object;
        }
        finally {
            context.recycle();
    ...
    public static Builder builder(Context context, AttributeSet attributeSet, int n, int n2, CornerSize cornerSize) {
        ...
        n2 = attributeSet.getResourceId(R.styleable.MaterialShape_shapeAppearance, 0);
        n = attributeSet.getResourceId(R.styleable.MaterialShape_shapeAppearanceOverlay, 0);
        attributeSet.recycle();
        return ShapeAppearanceModel.builder(context, n2, n, cornerSize);
    }
    ...
    private static CornerSize getCornerSize(TypedArray typedArray, int n, CornerSize cornerSize) {
        ...
        if (typedValue.type != 6) return cornerSize;
    ...
    public boolean isRoundRect(RectF rectF) {
        boolean bl = this.leftEdge.getClass().equals(EdgeTreatment.class);
        boolean bl2 = true;
        boolean bl3 = bl && this.rightEdge.getClass().equals(EdgeTreatment.class) && this.topEdge.getClass().equals(EdgeTreatment.class) && this.bottomEdge.getClass().equals(EdgeTreatment.class);
        float f = this.topLeftCornerSize.getCornerSize(rectF);
        boolean bl4 = this.topRightCornerSize.getCornerSize(rectF) == f && this.bottomLeftCornerSize.getCornerSize(rectF) == f && this.bottomRightCornerSize.getCornerSize(rectF) == f;
        boolean bl5 = this.topRightCorner instanceof RoundedCornerTreatment && this.topLeftCorner instanceof RoundedCornerTreatment && this.bottomRightCorner instanceof RoundedCornerTreatment && this.bottomLeftCorner instanceof RoundedCornerTreatment;
        if (!bl3) return false;
        if (!bl4) return false;
        if (!bl5) return false;
        return bl2;
    ...
    public static final class Builder {
        ...
        private static float compatCornerTreatmentSize(CornerTreatment cornerTreatment) {
            ...
            if (!(cornerTreatment instanceof CutCornerTreatment)) return -1.0f;
