...
final class GraphConstants {
    ...
    extends Enum<Presence> {
        private static final /* synthetic */ Presence[] $VALUES;
        public static final /* enum */ Presence EDGE_EXISTS;

        static {
            Presence presence;
            EDGE_EXISTS = presence = new Presence();
            $VALUES = new Presence[]{presence};
        }

        public static Presence valueOf(String string2) {
            return Enum.valueOf(Presence.class, string2);
        }
