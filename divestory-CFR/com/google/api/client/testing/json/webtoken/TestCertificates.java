...
public class TestCertificates {
    ...
    public static class CertData {
        ...
        public CertData(String string2) {
            this.pem = string2;
        }
        ...
        public Certificate getCertfificate() throws IOException, CertificateException {
            ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(this.getDer());
            return SecurityUtils.getX509CertificateFactory().generateCertificate(byteArrayInputStream);
        }
