...
public final class PerspectiveTransform {
    ...
    public static PerspectiveTransform squareToQuadrilateral(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8) {
        ...
        f5 = (f11 * f10 - f9 * f5) / f6;
        return new PerspectiveTransform(f12 * f3 + (f3 - f), f5 * f7 + (f7 - f), f, f4 - f2 + f12 * f4, f8 - f2 + f5 * f8, f2, f12, f5, 1.0f);
    }
    ...
    public void transformPoints(float[] arrf) {
        ...
        while (n2 < n) {
            ...
            arrf[n2] = (f * f10 + f4 * f11 + f7) / f12;
            arrf[n3] = (f10 * f2 + f11 * f5 + f8) / f12;
            n2 += 2;
        }
    }
    ...
    public void transformPoints(float[] arrf, float[] arrf2) {
        ...
        while (n2 < n) {
            ...
            arrf[n2] = (this.a11 * f + this.a21 * f2 + this.a31) / f3;
            arrf2[n2] = (this.a12 * f + this.a22 * f2 + this.a32) / f3;
            ++n2;
        }
    }
}
