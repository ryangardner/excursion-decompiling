...
public final class SMTPCommand {
    ...
    static {
        String[] arrstring = new String[]{"HELO", "MAIL FROM:", "RCPT TO:", "DATA", "SEND FROM:", "SOML FROM:", "SAML FROM:", "RSET", "VRFY", "EXPN", "HELP", "NOOP", "TURN", "QUIT", "AUTH", "EHLO"};
        _commands = arrstring;
        if (arrstring.length != 16) throw new RuntimeException("Error in array definition");
    }
