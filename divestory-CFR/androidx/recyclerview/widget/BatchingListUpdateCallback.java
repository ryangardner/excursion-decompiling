...
implements ListUpdateCallback {
    ...
    public void onChanged(int n, int n2, Object object) {
        ...
        int n4;
        int n5;
        if (this.mLastEventType == 3 && n <= (n3 = this.mLastEventPosition) + (n5 = this.mLastEventCount) && (n4 = n + n2) >= n3 && this.mLastEventPayload == object) {
            this.mLastEventPosition = Math.min(n, n3);
            this.mLastEventCount = Math.max(n5 + n3, n4) - this.mLastEventPosition;
            return;
        }
