...
public class ContextCompat {
    ...
    public static int checkSelfPermission(Context context, String string2) {
        if (string2 == null) throw new IllegalArgumentException("permission is null");
    ...
    public static ColorStateList getColorStateList(Context context, int n) {
        if (Build.VERSION.SDK_INT < 23) return context.getResources().getColorStateList(n);
    ...
    public static File[] getExternalFilesDirs(Context context, String string2) {
        if (Build.VERSION.SDK_INT < 19) return new File[]{context.getExternalFilesDir(string2)};
        return context.getExternalFilesDirs(string2);
    }

    public static Executor getMainExecutor(Context context) {
        if (Build.VERSION.SDK_INT < 28) return new MainHandlerExecutor(new Handler(context.getMainLooper()));
    ...
    public static <T> T getSystemService(Context object, Class<T> object2) {
        ...
        if ((object2 = ContextCompat.getSystemServiceName(object, object2)) != null) {
    ...
    public static String getSystemServiceName(Context context, Class<?> class_) {
        if (Build.VERSION.SDK_INT < 23) return LegacyServiceMapHolder.SERVICES.get(class_);
    ...
    implements Executor {
        ...
        public void execute(Runnable object) {
            ...
            ((StringBuilder)object).append((Object)this.mHandler);
