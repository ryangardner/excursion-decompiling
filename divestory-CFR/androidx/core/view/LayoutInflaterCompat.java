...
public final class LayoutInflaterCompat {
    ...
    private static void forceSetFactory2(LayoutInflater layoutInflater, LayoutInflater.Factory2 factory2) {
        ...
        if ((object = sLayoutInflaterFactory2Field) == null) return;
        try {
            ((Field)object).set((Object)layoutInflater, (Object)factory2);
            return;
        }
        catch (IllegalAccessException illegalAccessException) {
            object = new StringBuilder();
            ((StringBuilder)object).append("forceSetFactory2 could not set the Factory2 on LayoutInflater ");
            ((StringBuilder)object).append((Object)layoutInflater);
