...
public final class HtmlCompat {
    ...
    public static Spanned fromHtml(String string2, int n) {
        if (Build.VERSION.SDK_INT < 24) return Html.fromHtml((String)string2);
    ...
    public static Spanned fromHtml(String string2, int n, Html.ImageGetter imageGetter, Html.TagHandler tagHandler) {
        if (Build.VERSION.SDK_INT < 24) return Html.fromHtml((String)string2, (Html.ImageGetter)imageGetter, (Html.TagHandler)tagHandler);
