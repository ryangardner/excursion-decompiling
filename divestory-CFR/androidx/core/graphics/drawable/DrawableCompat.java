...
public final class DrawableCompat {
    ...
    public static void clearColorFilter(Drawable drawable2) {
        ...
        if (!(drawable2 instanceof DrawableContainer)) return;
        DrawableContainer.DrawableContainerState drawableContainerState = (DrawableContainer.DrawableContainerState)((DrawableContainer)drawable2).getConstantState();
        if (drawableContainerState == null) return;
        int n = 0;
        int n2 = drawableContainerState.getChildCount();
        while (n < n2) {
            drawable2 = drawableContainerState.getChild(n);
            if (drawable2 != null) {
    ...
    public static int getLayoutDirection(Drawable drawable2) {
        ...
        try {
            return (Integer)method.invoke((Object)drawable2, new Object[0]);
        }
    ...
    public static void setTint(Drawable drawable2, int n) {
        ...
        if (!(drawable2 instanceof TintAwareDrawable)) return;
    ...
    public static <T extends Drawable> T unwrap(Drawable drawable2) {
        ...
        if (!(drawable2 instanceof WrappedDrawable)) return (T)drawable3;
        drawable3 = ((WrappedDrawable)drawable2).getWrappedDrawable();
        return (T)drawable3;
    }
    ...
    public static Drawable wrap(Drawable drawable2) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            if (drawable2 instanceof TintAwareDrawable) return drawable2;
