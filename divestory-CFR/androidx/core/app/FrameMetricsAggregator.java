    ...
    extends FrameMetricsBaseImpl {
        ...
        Window.OnFrameMetricsAvailableListener mListener = new Window.OnFrameMetricsAvailableListener(){
            ...
            public void onFrameMetricsAvailable(Window object, FrameMetrics frameMetrics, int n) {
                ...
                if ((FrameMetricsApi24Impl.this.mTrackingFlags & 256) == 0) return;
                object = FrameMetricsApi24Impl.this;
        ...
        public void add(Activity activity) {
            ...
            if (sHandlerThread == null) {
                arrsparseIntArray = new HandlerThread("FrameMetricsAggregator");
            ...
            do {
                ...
                if (arrsparseIntArray[n] == null && (this.mTrackingFlags & 1 << n) != 0) {
                    arrsparseIntArray[n] = new SparseIntArray();
                }
                ++n;
            } while (true);
        }
