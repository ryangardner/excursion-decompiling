...
extends Fragment {
    ...
    static void dispatch(Activity object, Lifecycle.Event event) {
        ...
        if (!(object instanceof LifecycleOwner)) return;
        if (!((object = ((LifecycleOwner)object).getLifecycle()) instanceof LifecycleRegistry)) return;
    ...
    public static void injectIfNeededIn(Activity activity) {
        ...
        if ((activity = activity.getFragmentManager()).findFragmentByTag(REPORT_FRAGMENT_TAG) != null) return;
