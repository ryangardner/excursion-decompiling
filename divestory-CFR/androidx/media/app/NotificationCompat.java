...
public class NotificationCompat {
    ...
    extends MediaStyle {
        ...
        int getBigContentViewLayoutResource(int n) {
            if (n > 3) return R.layout.notification_template_big_media_custom;
            return R.layout.notification_template_big_media_narrow_custom;
        }

        @Override
        int getContentViewLayoutResource() {
            if (this.mBuilder.getContentView() == null) return super.getContentViewLayoutResource();
    ...
    extends NotificationCompat.Style {
        ...
        public static MediaSessionCompat.Token getMediaSession(Notification notification) {
            if ((notification = androidx.core.app.NotificationCompat.getExtras(notification)) == null) return null;
            if (Build.VERSION.SDK_INT >= 21) {
            ...
            notification.writeStrongBinder(object);
        ...
        Notification.MediaStyle fillInMediaStyle(Notification.MediaStyle mediaStyle) {
            ...
            if (object != null) {
                mediaStyle.setShowActionsInCompactView((int[])object);
            }
            if ((object = this.mToken) == null) return mediaStyle;
            mediaStyle.setMediaSession((MediaSession.Token)((MediaSessionCompat.Token)object).getToken());
            return mediaStyle;
        }
        ...
        RemoteViews generateContentView() {
            ...
            int n2 = remoteViews2 == null ? 0 : Math.min(((int[])remoteViews2).length, 3);
            remoteViews.removeAllViews(R.id.media_actions);
            if (n2 > 0) {
                for (int i = 0; i < n2; ++i) {
                    if (i >= n) {
        ...
        int getBigContentViewLayoutResource(int n) {
            if (n > 3) return R.layout.notification_template_big_media;
