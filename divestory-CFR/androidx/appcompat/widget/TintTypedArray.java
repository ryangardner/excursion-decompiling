...
public class TintTypedArray {
    ...
    public ColorStateList getColorStateList(int n) {
        ...
        ColorStateList colorStateList = AppCompatResources.getColorStateList(this.mContext, n2);
    ...
    public Typeface getFont(int n, int n2, ResourcesCompat.FontCallback fontCallback) {
        ...
        if (this.mTypedValue != null) return ResourcesCompat.getFont(this.mContext, n, this.mTypedValue, n2, fontCallback);
