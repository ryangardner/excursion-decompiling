    ...
    public PopupMenu(Context object, View view, int n, int n2, int n3) {
        ...
        menuBuilder.setCallback(new MenuBuilder.Callback(){
            ...
            public boolean onMenuItemSelected(MenuBuilder menuBuilder, MenuItem menuItem) {
                if (PopupMenu.this.mMenuItemClickListener == null) return false;
        ...
        object = new MenuPopupHelper((Context)object, this.mMenu, view, false, n2, n3);
        this.mPopup = object;
        ((MenuPopupHelper)object).setGravity(n);
        this.mPopup.setOnDismissListener(new PopupWindow.OnDismissListener(){

            public void onDismiss() {
                if (PopupMenu.this.mOnDismissListener == null) return;
