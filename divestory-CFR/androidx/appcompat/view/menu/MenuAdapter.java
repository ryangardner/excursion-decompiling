...
extends BaseAdapter {
    ...
    public MenuItemImpl getItem(int n) {
        ...
        int n3 = n;
        if (n2 < 0) return arrayList.get(n3);
        n3 = n;
        if (n < n2) return arrayList.get(n3);
        n3 = n + 1;
    ...
    public View getView(int n, View object, ViewGroup object2) {
        View view = object;
        if (object == null) {
            view = this.mInflater.inflate(this.mItemLayoutRes, (ViewGroup)object2, false);
        }
        ...
        object2 = (MenuView.ItemView)view;
        if (this.mForceShowIcon) {
            ((ListMenuItemView)object).setForceShowIcon(true);
        }
        object2.initialize(this.getItem(n), 0);
        return view;
    }
