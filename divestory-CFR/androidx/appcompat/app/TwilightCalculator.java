...
class TwilightCalculator {
    ...
    public void calculateTwilight(long l, double d, double d2) {
        ...
        double d3 = f2;
        double d4 = Math.sin(d3) * 0.03341960161924362 + d3 + Math.sin(2.0f * f2) * 3.4906598739326E-4 + Math.sin(f2 * 3.0f) * 5.236000106378924E-6 + 1.796593063 + 3.141592653589793;
        d2 = -d2 / 360.0;
        d2 = (double)((float)Math.round((double)(f - 9.0E-4f) - d2) + 9.0E-4f) + d2 + Math.sin(d3) * 0.0053 + Math.sin(2.0 * d4) * -0.0069;
