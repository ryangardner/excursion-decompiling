...
extends Drawable {
    ...
    private void buildShadowCorners() {
        ...
        rectF.setShader((Shader)new RadialGradient(0.0f, 0.0f, f3 + f, new int[]{n, n, n2}, new float[]{0.0f, f2, 1.0f}, (Shader.TileMode)rectF2));
        ...
        rectF2 = Shader.TileMode.CLAMP;
        rectF.setShader((Shader)new LinearGradient(0.0f, f + f3, 0.0f, f2 - f3, new int[]{n, n, n2}, new float[]{0.0f, 0.5f, 1.0f}, (Shader.TileMode)rectF2));
    ...
    private void drawShadow(Canvas canvas) {
        ...
        f2 = this.mCardBounds.width();
        int n = f2 - (f = f4 * 2.0f) > 0.0f ? 1 : 0;
        boolean bl = this.mCardBounds.height() - f > 0.0f;
        int n2 = canvas.save();
        canvas.translate(this.mCardBounds.left + f4, this.mCardBounds.top + f4);
        canvas.drawPath(this.mCornerShadowPath, this.mCornerShadowPaint);
        if (n != 0) {
            canvas.drawRect(0.0f, f3, this.mCardBounds.width() - f, -this.mCornerRadius, this.mEdgeShadowPaint);
        }
        ...
        canvas.drawPath(this.mCornerShadowPath, this.mCornerShadowPaint);
        if (n != 0) {
            canvas.drawRect(0.0f, f3, this.mCardBounds.width() - f, -this.mCornerRadius + this.mShadowSize, this.mEdgeShadowPaint);
        }
        canvas.restoreToCount(n2);
        n = canvas.save();
        ...
        canvas.drawPath(this.mCornerShadowPath, this.mCornerShadowPaint);
        if (bl) {
            canvas.drawRect(0.0f, f3, this.mCardBounds.height() - f, -this.mCornerRadius, this.mEdgeShadowPaint);
        }
