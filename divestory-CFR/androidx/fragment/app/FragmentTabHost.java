...
implements TabHost.OnTabChangeListener {
    ...
    private FragmentTransaction doTabChanged(String object, FragmentTransaction object2) {
        ...
        object = object2;
        if (this.mLastTab == tabInfo) return object;
        object = object2;
        if (object2 == null) {
            object = this.mFragmentManager.beginTransaction();
        }
        if ((object2 = this.mLastTab) != null && ((TabInfo)object2).fragment != null) {
    ...
    protected void onAttachedToWindow() {
        ...
        do {
            if (n2 >= n) {
                this.mAttached = true;
                if ((fragmentTransaction = this.doTabChanged(string2, fragmentTransaction)) == null) return;
    ...
    public void onTabChanged(String string2) {
        ...
        if ((object = this.mOnTabChangeListener) == null) return;
