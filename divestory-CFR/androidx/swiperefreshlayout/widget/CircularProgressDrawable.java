...
implements Animatable {
    ...
    public CircularProgressDrawable(Context object) {
        this.mResources = Preconditions.checkNotNull(object).getResources();
        object = new Ring();
        this.mRing = object;
        ((Ring)object).setColors(COLORS);
    ...
    private int evaluateColorChange(float f, int n, int n2) {
        ...
        int n4 = n >> 16 & 255;
        int n5 = n >> 8 & 255;
        return n3 + (int)((float)((n2 >> 24 & 255) - n3) * f) << 24 | n4 + (int)((float)((n2 >> 16 & 255) - n4) * f) << 16 | n5 + (int)((float)((n2 >> 8 & 255) - n5) * f) << 8 | (n &= 255) + (int)(f * (float)((n2 & 255) - n));
    }
