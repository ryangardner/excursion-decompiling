...
NestedScrollingChild {
    ...
    private final Animation mAnimateToCorrectPosition = new Animation(){
        ...
        public void applyTransformation(float f, Transformation transformation) {
            ...
            int n3 = (int)((float)(n - SwipeRefreshLayout.this.mFrom) * f);
            n = SwipeRefreshLayout.this.mCircleView.getTop();
            SwipeRefreshLayout.this.setTargetOffsetTopAndBottom(n2 + n3 - n);
        ...
        if (!this.mScale) {
            animationListener = new Animation.AnimationListener(){
                ...
                public void onAnimationEnd(Animation animation) {
                    if (SwipeRefreshLayout.this.mScale) return;
    ...
    private boolean isAnimationRunning(Animation animation) {
        ...
        if (!animation.hasStarted()) return false;
        if (animation.hasEnded()) return false;
        return true;
    }
    ...
    private void moveSpinner(float f) {
        ...
        float f6 = n;
        double d = Math.max(0.0f, Math.min(f4 - f5, f6 * 2.0f) / f6) / 4.0f;
        f4 = (float)(d - Math.pow(d, 2.0)) * 2.0f;
    ...
    private Animation startAlphaAnimation(final int n, final int n2) {
        Animation animation = new Animation(){
            ...
            public void applyTransformation(float f, Transformation object) {
                ...
                int n3 = n;
                ((CircularProgressDrawable)((Object)object)).setAlpha((int)((float)n3 + (float)(n2 - n3) * f));
            }
        };
    ...
    private void startScaleDownReturnToStartAnimation(int n, Animation.AnimationListener animationListener) {
        ...
        this.mScaleDownToStartAnimation = animation = new Animation(){
    ...
    private void startScaleUpAnimation(Animation.AnimationListener animationListener) {
        ...
        this.mScaleAnimation = animation = new Animation(){
    ...
    protected void onLayout(boolean bl, int n, int n2, int n3, int n4) {
        ...
        object.layout(n, n4, n2 - this.getPaddingLeft() - this.getPaddingRight() + n, n3 - this.getPaddingTop() - this.getPaddingBottom() + n4);
        ...
        object.layout((n2 /= 2) - (n3 /= 2), n4, n2 + n3, n + n4);
    }
    ...
    public void onNestedPreScroll(View arrn, int n, int n2, int[] arrn2) {
        ...
        if (!this.dispatchNestedPreScroll(n - arrn2[0], n2 - arrn2[1], arrn = this.mParentScrollConsumed, null)) return;
    ...
    public void requestDisallowInterceptTouchEvent(boolean bl) {
        ...
        if ((view = this.mTarget) != null && !ViewCompat.isNestedScrollingEnabled(view)) {
            return;
        }
    ...
    public void setColorSchemeResources(int ... arrn) {
        ...
        do {
            ...
            arrn2[n] = ContextCompat.getColor(context, arrn[n]);
            ++n;
        } while (true);
    }
    ...
    void startScaleDownAnimation(Animation.AnimationListener animationListener) {
        Animation animation;
        this.mScaleDownAnimation = animation = new Animation(){
