...
extends ViewGroup {
    ...
    private RecyclerView.OnChildAttachStateChangeListener enforceChildFillListener() {
        return new RecyclerView.OnChildAttachStateChangeListener(){
            ...
            public void onChildViewAttachedToWindow(View object) {
                ...
                if (object.width != -1) throw new IllegalStateException("Pages must fill the whole ViewPager2 (use match_parent)");
                if (object.height != -1) throw new IllegalStateException("Pages must fill the whole ViewPager2 (use match_parent)");
            }
    ...
    private void initialize(Context object, AttributeSet object2) {
        ...
        object = new PagerSnapHelperImpl();
        this.mPagerSnapHelper = object;
        ((SnapHelper)object).attachToRecyclerView(this.mRecyclerView);
        ...
        object = new OnPageChangeCallback(){
            ...
            public void onPageSelected(int n) {
                if (ViewPager2.this.mCurrentItem == n) return;
        ...
        object2 = new OnPageChangeCallback(){
            ...
            public void onPageSelected(int n) {
                ...
                if (!ViewPager2.this.hasFocus()) return;
    ...
    public CharSequence getAccessibilityClassName() {
        if (!this.mAccessibilityProvider.handlesGetAccessibilityClassName()) return super.getAccessibilityClassName();
    ...
    int getPageSize() {
        ...
        if (this.getOrientation() == 0) {
            n = recyclerView.getWidth() - recyclerView.getPaddingLeft();
            n2 = recyclerView.getPaddingRight();
            return n - n2;
        }
        n = recyclerView.getHeight() - recyclerView.getPaddingTop();
        n2 = recyclerView.getPaddingBottom();
        return n - n2;
    }
    ...
    protected void onLayout(boolean bl, int n, int n2, int n3, int n4) {
        ...
        if (!this.mCurrentItemDirty) return;
    ...
    protected void onMeasure(int n, int n2) {
        ...
        n7 = Math.max(n3 + (n6 + n7), this.getSuggestedMinimumWidth());
        n8 = Math.max(n4 + (n8 + n9), this.getSuggestedMinimumHeight());
        this.setMeasuredDimension(ViewPager2.resolveSizeAndState((int)n7, (int)n, (int)n5), ViewPager2.resolveSizeAndState((int)n8, (int)n2, (int)(n5 << 16)));
    }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        if (!(object instanceof StatefulAdapter)) return savedState;
    ...
    public boolean performAccessibilityAction(int n, Bundle bundle) {
        if (!this.mAccessibilityProvider.handlesPerformAccessibilityAction(n, bundle)) return super.performAccessibilityAction(n, bundle);
    ...
    public void setCurrentItem(int n, boolean bl) {
        if (this.isFakeDragging()) throw new IllegalStateException("Cannot change current item when ViewPager2 is fake dragging");
    ...
    void setCurrentItemInternal(int n, boolean bl) {
        ...
        if (object == null) {
            if (this.mPendingCurrentItem == -1) return;
        ...
        this.mRecyclerView.post((Runnable)new SmoothScrollToPosition(n2, this.mRecyclerView));
    }
    ...
    public void setOffscreenPageLimit(int n) {
        if (n < 1) {
            if (n != -1) throw new IllegalArgumentException("Offscreen page limit must be OFFSCREEN_PAGE_LIMIT_DEFAULT or a number > 0");
        }
    ...
    void snapToPage() {
        ...
        if ((arrn = this.mPagerSnapHelper.calculateDistanceToFinalSnap(this.mLayoutManager, (View)arrn))[0] == 0) {
            if (arrn[1] == 0) return;
        }
    ...
    void updateCurrentItem() {
        ...
        if (pagerSnapHelper == null) throw new IllegalStateException("Design assumption violated.");
    ...
    extends AccessibilityProvider {
        ...
        public boolean handlesLmPerformAccessibilityAction(int n) {
            ...
            if (ViewPager2.this.isUserInputEnabled()) return false;
            return true;
        }
        ...
        public void onLmInitializeAccessibilityNodeInfo(AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            if (ViewPager2.this.isUserInputEnabled()) return;
        ...
        public boolean onLmPerformAccessibilityAction(int n) {
            if (!this.handlesLmPerformAccessibilityAction(n)) throw new IllegalStateException();
            return false;
        }

        @Override
        public CharSequence onRvGetAccessibilityClassName() {
            if (!this.handlesRvGetAccessibilityClassName()) throw new IllegalStateException();
    ...
    extends LinearLayoutManager {
        ...
        public boolean performAccessibilityAction(RecyclerView.Recycler recycler, RecyclerView.State state, int n, Bundle bundle) {
            if (!ViewPager2.this.mAccessibilityProvider.handlesLmPerformAccessibilityAction(n)) return super.performAccessibilityAction(recycler, state, n, bundle);
    ...
    extends AccessibilityProvider {
        private final AccessibilityViewCommand mActionPageBackward = new AccessibilityViewCommand(){
            ...
            public boolean perform(View object, AccessibilityViewCommand.CommandArguments commandArguments) {
                ...
                PageAwareAccessibilityProvider.this.setCurrentItemFromAccessibilityCommand(((ViewPager2)((Object)object)).getCurrentItem() - 1);
                return true;
            }
        };
        ...
        private void addCollectionInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            block3 : {
                block2 : {
                    block0 : {
                        block1 : {
                            if (ViewPager2.this.getAdapter() == null) break block0;
                            if (ViewPager2.this.getOrientation() != 1) break block1;
                            n = ViewPager2.this.getAdapter().getItemCount();
                            break block2;
                        }
                        n2 = ViewPager2.this.getAdapter().getItemCount();
                        n = 0;
                        break block3;
                    }
                    n = 0;
            ...
            AccessibilityNodeInfoCompat.wrap(accessibilityNodeInfo).setCollectionInfo(AccessibilityNodeInfoCompat.CollectionInfoCompat.obtain(n, n2, false, 0));
        }
        ...
        public String onGetAccessibilityClassName() {
            if (!this.handlesGetAccessibilityClassName()) throw new IllegalStateException();
            return "androidx.viewpager.widget.ViewPager";
        }
        ...
        public void onInitialize(CompositeOnPageChangeCallback compositeOnPageChangeCallback, RecyclerView recyclerView) {
            ...
            if (ViewCompat.getImportantForAccessibility((View)ViewPager2.this) != 0) return;
        ...
        public boolean onPerformAccessibilityAction(int n, Bundle bundle) {
            if (!this.handlesPerformAccessibilityAction(n, bundle)) throw new IllegalStateException();
        ...
        void updatePageAccessibilityActions() {
            ...
            if (ViewPager2.this.getOrientation() == 0) {
                ...
                if (ViewPager2.this.mCurrentItem <= 0) return;
    ...
    extends PagerSnapHelper {
        ...
        public View findSnapView(RecyclerView.LayoutManager layoutManager) {
            if (!ViewPager2.this.isFakeDragging()) return super.findSnapView(layoutManager);
            return null;
        }
    }
    ...
    extends RecyclerView {
        ...
        @Override
        public CharSequence getAccessibilityClassName() {
            if (!ViewPager2.this.mAccessibilityProvider.handlesRvGetAccessibilityClassName()) return super.getAccessibilityClassName();
    ...
    extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>(){
            ...
            public SavedState createFromParcel(Parcel object, ClassLoader classLoader) {
                if (Build.VERSION.SDK_INT < 24) return new SavedState((Parcel)object);
                return new SavedState((Parcel)object, classLoader);
            }
