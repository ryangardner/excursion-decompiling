...
public abstract class DerivedLongCumulative {
    static DerivedLongCumulative newNoopDerivedLongCumulative(String string2, String string3, String string4, List<LabelKey> list) {
        return NoopDerivedLongCumulative.create(string2, string3, string4, list);
    }
    ...
    extends DerivedLongCumulative {
        ...
        NoopDerivedLongCumulative(String string2, String string3, String string4, List<LabelKey> list) {
        ...
        static NoopDerivedLongCumulative create(String string2, String string3, String string4, List<LabelKey> list) {
            return new NoopDerivedLongCumulative(string2, string3, string4, list);
        }
