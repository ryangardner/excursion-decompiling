...
public abstract class DerivedDoubleGauge {
    static DerivedDoubleGauge newNoopDerivedDoubleGauge(String string2, String string3, String string4, List<LabelKey> list) {
        return NoopDerivedDoubleGauge.create(string2, string3, string4, list);
    }
    ...
    extends DerivedDoubleGauge {
        ...
        NoopDerivedDoubleGauge(String string2, String string3, String string4, List<LabelKey> list) {
        ...
        static NoopDerivedDoubleGauge create(String string2, String string3, String string4, List<LabelKey> list) {
            return new NoopDerivedDoubleGauge(string2, string3, string4, list);
        }
