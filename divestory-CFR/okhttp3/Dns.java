    ...
    public static final class Companion {
        ...
        implements Dns {
            ...
            public List<InetAddress> lookup(String object) {
                Intrinsics.checkParameterIsNotNull(object, "hostname");
                try {
                    Object object2 = InetAddress.getAllByName((String)object);
                    Intrinsics.checkExpressionValueIsNotNull(object2, "InetAddress.getAllByName(hostname)");
                    return ArraysKt.toList(object2);
                }
