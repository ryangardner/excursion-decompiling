 ...
 *  okhttp3.CipherSuite$Companion$ORDER_BY_NAME
 */
package okhttp3;
...
public final class CipherSuite {
    ...
    static {
        ORDER_BY_NAME = new Comparator<String>(){
            ...
            public int compare(String string2, String string3) {
                int n;
                Intrinsics.checkParameterIsNotNull(string2, "a");
                Intrinsics.checkParameterIsNotNull(string3, "b");
                int n2 = java.lang.Math.min(string2.length(), string3.length());
                int n3 = 4;
                do {
                    char c;
                    n = -1;
                ...
                n2 = string2.length();
                if (n2 == (n3 = string3.length())) return 0;
                if (n2 >= n3) return 1;
                return n;
            }
        };
    ...
    public /* synthetic */ CipherSuite(String string2, DefaultConstructorMarker defaultConstructorMarker) {
        this(string2);
    }
    ...
    public static final class Companion {
        ...
        private final CipherSuite init(String string2, int n) {
            CipherSuite cipherSuite = new CipherSuite(string2, null);
            INSTANCES.put(string2, cipherSuite);
            return cipherSuite;
        }

        private final String secondaryName(String string2) {
            CharSequence charSequence;
            if (StringsKt.startsWith$default(string2, "TLS_", false, 2, null)) {
                charSequence = new StringBuilder();
                ((StringBuilder)charSequence).append("SSL_");
            ...
            if (!StringsKt.startsWith$default(string2, "SSL_", false, 2, null)) return charSequence;
            charSequence = new StringBuilder();
            ((StringBuilder)charSequence).append("TLS_");
            if (string2 == null) throw new TypeCastException("null cannot be cast to non-null type java.lang.String");
            string2 = string2.substring(4);
            Intrinsics.checkExpressionValueIsNotNull(string2, "(this as java.lang.String).substring(startIndex)");
            ((StringBuilder)charSequence).append(string2);
        ...
        @JvmStatic
        public final CipherSuite forJavaName(String string2) {
            synchronized (this) {
                CipherSuite cipherSuite;
                Intrinsics.checkParameterIsNotNull(string2, "javaName");
                CipherSuite cipherSuite2 = cipherSuite = (CipherSuite)INSTANCES.get(string2);
                if (cipherSuite != null) return cipherSuite2;
                cipherSuite2 = cipherSuite = (CipherSuite)INSTANCES.get(this.secondaryName(string2));
                if (cipherSuite == null) {
                    cipherSuite2 = new CipherSuite(string2, null);
                }
                INSTANCES.put(string2, cipherSuite2);
                return cipherSuite2;
            }
        }
