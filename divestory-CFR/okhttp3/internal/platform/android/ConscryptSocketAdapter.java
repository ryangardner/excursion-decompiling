 ...
 *  okhttp3.internal.platform.android.ConscryptSocketAdapter$Companion$factory
...
implements SocketAdapter {
    ...
    private static final DeferredSocketAdapter.Factory factory = new DeferredSocketAdapter.Factory(){
        ...
        public boolean matchesSocket(SSLSocket sSLSocket) {
            Intrinsics.checkParameterIsNotNull(sSLSocket, "sslSocket");
            if (!ConscryptPlatform.Companion.isSupported()) return false;
            if (!Conscrypt.isConscrypt((SSLSocket)sSLSocket)) return false;
            return true;
        }
    };

    @Override
    public void configureTlsExtensions(SSLSocket sSLSocket, String arrstring, List<? extends Protocol> list) {
        Intrinsics.checkParameterIsNotNull(sSLSocket, "sslSocket");
    ...
    public String getSelectedProtocol(SSLSocket object) {
        ...
        if (!this.matchesSocket((SSLSocket)object)) return null;
    ...
    @Metadata(bv={1, 0, 3}, d1={"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002\u00a2\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0004\u00a2\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006\u00a8\u0006\u0007"}, d2={"Lokhttp3/internal/platform/android/ConscryptSocketAdapter$Companion;", "", "()V", "factory", "Lokhttp3/internal/platform/android/DeferredSocketAdapter$Factory;", "getFactory", "()Lokhttp3/internal/platform/android/DeferredSocketAdapter$Factory;", "okhttp"}, k=1, mv={1, 1, 16})
