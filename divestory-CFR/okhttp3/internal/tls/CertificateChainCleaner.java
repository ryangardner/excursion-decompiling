...
public abstract class CertificateChainCleaner {
    ...
    public static final class Companion {
        ...
        public final CertificateChainCleaner get(X509Certificate ... arrx509Certificate) {
            Intrinsics.checkParameterIsNotNull(arrx509Certificate, "caCerts");
            return new BasicCertificateChainCleaner(new BasicTrustRootIndex(Arrays.copyOf(arrx509Certificate, arrx509Certificate.length)));
        }
    }
