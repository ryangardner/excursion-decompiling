...
public final class Internal {
    public static final Headers.Builder addHeaderLenient(Headers.Builder builder, String string2) {
        Intrinsics.checkParameterIsNotNull(builder, "builder");
        Intrinsics.checkParameterIsNotNull(string2, "line");
        return builder.addLenient$okhttp(string2);
    }

    public static final Headers.Builder addHeaderLenient(Headers.Builder builder, String string2, String string3) {
        Intrinsics.checkParameterIsNotNull(builder, "builder");
        Intrinsics.checkParameterIsNotNull(string2, "name");
        Intrinsics.checkParameterIsNotNull(string3, "value");
        return builder.addLenient$okhttp(string2, string3);
    }
    ...
    public static final Cookie parseCookie(long l, HttpUrl httpUrl, String string2) {
        Intrinsics.checkParameterIsNotNull(httpUrl, "url");
        Intrinsics.checkParameterIsNotNull(string2, "setCookie");
        return Cookie.Companion.parse$okhttp(l, httpUrl, string2);
    }
}
