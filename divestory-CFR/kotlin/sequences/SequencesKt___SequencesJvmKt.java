 ...
 *  kotlin.sequences.SequencesKt___SequencesJvmKt$filterIsInstance
 */
...
extends SequencesKt__SequencesKt {
    public static final <R> Sequence<R> filterIsInstance(Sequence<?> sequence, Class<R> class_) {
        Intrinsics.checkParameterIsNotNull(sequence, "$this$filterIsInstance");
        Intrinsics.checkParameterIsNotNull(class_, "klass");
        sequence = SequencesKt.filter(sequence, (Function1)new Function1<Object, Boolean>(class_){
    ...
    public static final <C extends Collection<? super R>, R> C filterIsInstanceTo(Sequence<?> sequence, C c, Class<R> class_) {
        ...
        while (iterator2.hasNext()) {
            ...
            if (!class_.isInstance(sequence)) continue;
            c.add(sequence);
        }
        return c;
    }
