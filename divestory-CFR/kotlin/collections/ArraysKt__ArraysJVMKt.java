...
class ArraysKt__ArraysJVMKt {
    public static final <T> T[] arrayOfNulls(T[] object, int n) {
        Intrinsics.checkParameterIsNotNull(object, "reference");
    ...
    public static final <T> int contentDeepHashCode(T[] arrT) {
        Intrinsics.checkParameterIsNotNull(arrT, "$this$contentDeepHashCodeImpl");
    ...
    public static final /* synthetic */ <T> T[] orEmpty(T[] arrobject) {
        if (arrobject != null) {
            return arrobject;
        }
    ...
    public static final /* synthetic */ <T> T[] toTypedArray(Collection<? extends T> arrobject) {
        Intrinsics.checkParameterIsNotNull(arrobject, "$this$toTypedArray");
        Intrinsics.reifiedOperationMarker(0, "T?");
