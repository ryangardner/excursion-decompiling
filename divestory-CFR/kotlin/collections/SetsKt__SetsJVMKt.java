...
class SetsKt__SetsJVMKt {
    public static final <T> Set<T> setOf(T object) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(object, "java.util.Collections.singleton(element)");
        return object;
    }

    public static final <T> TreeSet<T> sortedSetOf(Comparator<? super T> comparator, T ... arrT) {
