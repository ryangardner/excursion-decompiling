...
extends CollectionsKt__ReversedViewsKt {
    public static final <R> List<R> filterIsInstance(Iterable<?> iterable, Class<R> class_) {
    ...
    public static final <C extends Collection<? super R>, R> C filterIsInstanceTo(Iterable<?> iterable, C c, Class<R> class_) {
        ...
        while (iterator2.hasNext()) {
            ...
            if (!class_.isInstance(iterable)) continue;
            c.add(iterable);
        }
        return c;
    }
