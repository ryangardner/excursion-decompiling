...
extends CollectionsKt__CollectionsKt {
    private static final <T> java.lang.Iterable<T> Iterable(Function0<? extends Iterator<? extends T>> function0) {
        return new java.lang.Iterable<T>(function0){
    ...
    public static final <T> int collectionSizeOrDefault(java.lang.Iterable<? extends T> iterable, int n) {
        Intrinsics.checkParameterIsNotNull(iterable, "$this$collectionSizeOrDefault");
        if (!(iterable instanceof Collection)) return n;
        return ((Collection)iterable).size();
    }

    public static final <T> Integer collectionSizeOrNull(java.lang.Iterable<? extends T> object) {
        Intrinsics.checkParameterIsNotNull(object, "$this$collectionSizeOrNull");
        if (!(object instanceof Collection)) return null;
        return ((Collection)object).size();
    }

    public static final <T> Collection<T> convertToSetForSetOperation(java.lang.Iterable<? extends T> collection) {
        Intrinsics.checkParameterIsNotNull(collection, "$this$convertToSetForSetOperation");
        if (collection instanceof Set) {
            return collection;
        }
        if (!(collection instanceof Collection)) {
            return CollectionsKt.toHashSet(collection);
        }
        Collection collection2 = collection;
        if (!CollectionsKt__IterablesKt.safeToConvertToSet$CollectionsKt__IterablesKt(collection2)) return collection2;
        return CollectionsKt.toHashSet(collection);
    }

    public static final <T> Collection<T> convertToSetForSetOperationWith(java.lang.Iterable<? extends T> collection, java.lang.Iterable<? extends T> collection2) {
        Intrinsics.checkParameterIsNotNull(collection, "$this$convertToSetForSetOperationWith");
        Intrinsics.checkParameterIsNotNull(collection2, "source");
        if (collection instanceof Set) {
            return collection;
        }
        if (!(collection instanceof Collection)) {
        ...
        if (collection2 instanceof Collection && ((Collection)collection2).size() < 2) {
            return collection;
        }
    ...
    public static final <T> List<T> flatten(java.lang.Iterable<? extends java.lang.Iterable<? extends T>> object) {
        Intrinsics.checkParameterIsNotNull(object, "$this$flatten");
    ...
    private static final <T> boolean safeToConvertToSet$CollectionsKt__IterablesKt(Collection<? extends T> collection) {
        ...
        if (!(collection instanceof ArrayList)) return false;
        return true;
    }

    public static final <T, R> Pair<List<T>, List<R>> unzip(java.lang.Iterable<? extends Pair<? extends T, ? extends R>> object) {
