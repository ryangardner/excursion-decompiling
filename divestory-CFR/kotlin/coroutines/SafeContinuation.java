...
CoroutineStackFrame {
    ...
    public SafeContinuation(Continuation<? super T> continuation2) {
        ...
        this(continuation2, (Object)CoroutineSingletons.UNDECIDED);
    }
    ...
    public CoroutineStackFrame getCallerFrame() {
        ...
        Continuation<T> continuation3 = continuation2 = this.delegate;
    ...
    public final Object getOrThrow() {
        ...
        if (object2 instanceof Result.Failure) throw ((Result.Failure)object2).exception;
        return object2;
    }
     ...
     */
    @Override
    public void resumeWith(Object var1_1) {
        do lbl-1000: // 3 sources:
        {
            block1 : {
                if ((var2_2 = this.result) != CoroutineSingletons.UNDECIDED) break block1;
