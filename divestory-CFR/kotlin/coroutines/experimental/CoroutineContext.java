 ...
 *  kotlin.coroutines.experimental.CoroutineContext$plus
 */
...
public interface CoroutineContext {
    ...
    public static final class DefaultImpls {
        public static CoroutineContext plus(CoroutineContext coroutineContext, CoroutineContext coroutineContext2) {
            ...
            if (coroutineContext2 != EmptyCoroutineContext.INSTANCE) return coroutineContext2.fold(coroutineContext, plus.1.INSTANCE);
        ...
        public static final class DefaultImpls {
            ...
            public static <E extends Element> E get(Element element, Key<E> key) {
                ...
                if (element.getKey() == key) {
                    if (element == null) throw new TypeCastException("null cannot be cast to non-null type E");
                    return (E)element;
                }
                element = null;
                return (E)element;
            ...
            public static CoroutineContext minusKey(Element element, Key<?> key) {
                ...
                if (element.getKey() != key) return coroutineContext;
            ...
            public static CoroutineContext plus(Element element, CoroutineContext coroutineContext) {
                ...
                return kotlin.coroutines.experimental.CoroutineContext$DefaultImpls.plus(element, coroutineContext);
            }
        }
