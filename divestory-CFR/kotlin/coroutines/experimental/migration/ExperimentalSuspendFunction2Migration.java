...
implements Function3<T1, T2, kotlin.coroutines.experimental.Continuation<? super R>, Object> {
    ...
    public ExperimentalSuspendFunction2Migration(Function3<? super T1, ? super T2, ? super Continuation<? super R>, ? extends Object> function3) {
    ...
    @Override
    public Object invoke(T1 T1, T2 T2, kotlin.coroutines.experimental.Continuation<? super R> continuation2) {
