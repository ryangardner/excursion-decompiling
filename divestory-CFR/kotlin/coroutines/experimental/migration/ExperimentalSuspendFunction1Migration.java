...
implements Function2<T1, kotlin.coroutines.experimental.Continuation<? super R>, Object> {
    ...
    public ExperimentalSuspendFunction1Migration(Function2<? super T1, ? super Continuation<? super R>, ? extends Object> function2) {
    ...
    @Override
    public Object invoke(T1 T1, kotlin.coroutines.experimental.Continuation<? super R> continuation2) {
