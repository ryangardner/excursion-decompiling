...
implements Continuation<Object> {
    ...
    public CoroutineImpl(int n, Continuation<Object> object) {
        super(n);
    ...
    public Continuation<Unit> create(Object object, Continuation<?> continuation2) {
    ...
    public Continuation<Unit> create(Continuation<?> continuation2) {
        Intrinsics.checkParameterIsNotNull(continuation2, "completion");
    ...
    public final Continuation<Object> getFacade() {
        ...
        if (this._facade == null) {
            ...
            this._facade = CoroutineIntrinsics.interceptContinuationIfNeeded((CoroutineContext)object, this);
        }
        if ((object = this._facade) != null) return object;
        Intrinsics.throwNpe();
        return object;
    }
    ...
    public void resume(Object object) {
        ...
        try {
            object = this.doResume(object, null);
    ...
    @Override
    public void resumeWithException(Throwable object) {
        Intrinsics.checkParameterIsNotNull(object, "exception");
        Continuation<Object> continuation2 = this.completion;
        if (continuation2 == null) {
            Intrinsics.throwNpe();
        }
        try {
            object = this.doResume(null, (Throwable)object);
            if (object == IntrinsicsKt.getCOROUTINE_SUSPENDED()) return;
            if (continuation2 != null) {
                continuation2.resume(object);
                return;
