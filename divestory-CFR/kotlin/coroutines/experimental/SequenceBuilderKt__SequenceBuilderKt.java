 ...
 *  kotlin.coroutines.experimental.SequenceBuilderKt__SequenceBuilderKt$buildSequence$
 *  kotlin.coroutines.experimental.SequenceBuilderKt__SequenceBuilderKt$buildSequence$$inlined
 *  kotlin.coroutines.experimental.SequenceBuilderKt__SequenceBuilderKt$buildSequence$$inlined$Sequence
 */
...
import kotlin.coroutines.experimental.SequenceBuilderKt__SequenceBuilderKt$buildSequence$;
    ...
    public static final <T> Sequence<T> buildSequence(Function2<? super SequenceBuilder<? super T>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        return new Sequence<T>(function2){
            ...
            public Iterator<T> iterator() {
                return kotlin.coroutines.experimental.SequenceBuilderKt.buildIterator(this.$builderAction$inlined);
            }
        };
    }
}
