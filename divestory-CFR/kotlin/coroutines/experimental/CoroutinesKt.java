...
public final class CoroutinesKt {
    ...
    public static final <T> Continuation<Unit> createCoroutine(Function1<? super Continuation<? super T>, ? extends Object> function1, Continuation<? super T> continuation2) {
    ...
    public static final <R, T> Continuation<Unit> createCoroutine(Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r, Continuation<? super T> continuation2) {
    ...
    private static final void processBareContinuationResume(Continuation<?> continuation2, Function0<? extends Object> object) {
        try {
            ...
            if (object == IntrinsicsKt.getCOROUTINE_SUSPENDED()) return;
            if (continuation2 != null) {
                continuation2.resume(object);
                return;
            }
            object = new TypeCastException("null cannot be cast to non-null type kotlin.coroutines.experimental.Continuation<kotlin.Any?>");
            throw object;
        }
    ...
    public static final <T> void startCoroutine(Function1<? super Continuation<? super T>, ? extends Object> function1, Continuation<? super T> continuation2) {
    ...
    public static final <R, T> void startCoroutine(Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r, Continuation<? super T> continuation2) {
    ...
    public static final <T> Object suspendCoroutine(Function1<? super Continuation<? super T>, Unit> function1, Continuation<? super T> continuation2) {
        ...
        return ((SafeContinuation)continuation2).getResult();
    }

    private static final Object suspendCoroutine$$forInline(Function1 object, Continuation safeContinuation) {
        InlineMarker.mark(0);
        safeContinuation = new SafeContinuation(CoroutineIntrinsics.normalizeContinuation(safeContinuation));
        object.invoke(safeContinuation);
        object = safeContinuation.getResult();
        InlineMarker.mark(1);
        return object;
    }
}
