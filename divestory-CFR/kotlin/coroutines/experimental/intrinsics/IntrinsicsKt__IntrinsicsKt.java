...
extends IntrinsicsKt__IntrinsicsJvmKt {
    private static final <T> Continuation<T> intercepted(Continuation<? super T> continuation2) {
        throw (Throwable)new NotImplementedError("Implementation of intercepted is intrinsic");
    }

    private static final <T> Object suspendCoroutineOrReturn(Function1<? super Continuation<? super T>, ? extends Object> object, Continuation<? super T> continuation2) {
        InlineMarker.mark(0);
        object = object.invoke(CoroutineIntrinsics.normalizeContinuation(continuation2));
        InlineMarker.mark(1);
        return object;
    }
