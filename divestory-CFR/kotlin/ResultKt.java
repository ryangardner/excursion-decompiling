...
public final class ResultKt {
    ...
    private static final <R, T> R fold(Object object, Function1<? super T, ? extends R> function1, Function1<? super Throwable, ? extends R> function12) {
        ...
        object = function12.invoke(throwable);
        return (R)object;
    }

    private static final <R, T extends R> R getOrDefault(Object object, R r) {
        if (!Result.isFailure-impl(object)) return (R)object;
        return r;
    }
    ...
    private static final <R, T extends R> R getOrElse(Object object, Function1<? super Throwable, ? extends R> function1) {
        ...
        object = function1.invoke(throwable);
        return (R)object;
    }
    ...
    private static final <R, T> Object map(Object object, Function1<? super T, ? extends R> function1) {
        if (!Result.isSuccess-impl(object)) return Result.constructor-impl(object);
        Result.Companion companion = Result.Companion;
        return Result.constructor-impl(function1.invoke(object));
    }

    private static final <R, T> Object mapCatching(Object object, Function1<? super T, ? extends R> object2) {
        if (!Result.isSuccess-impl(object)) {
            return Result.constructor-impl(object);
        }
        try {
            Result.Companion companion = Result.Companion;
            return Result.constructor-impl(object2.invoke(object));
        }
    ...
    private static final <T> Object onSuccess(Object object, Function1<? super T, Unit> function1) {
        if (!Result.isSuccess-impl(object)) return object;
    ...
    private static final <R, T extends R> Object recover(Object object, Function1<? super Throwable, ? extends R> function1) {
        ...
        return Result.constructor-impl(function1.invoke(throwable));
    }

    private static final <R, T extends R> Object recoverCatching(Object object, Function1<? super Throwable, ? extends R> object2) {
        Throwable throwable = Result.exceptionOrNull-impl(object);
        if (throwable == null) {
            return object;
        }
        try {
            object = Result.Companion;
            return Result.constructor-impl(object2.invoke((Throwable)throwable));
        }
        catch (Throwable throwable2) {
            object2 = Result.Companion;
            return Result.constructor-impl(ResultKt.createFailure(throwable2));
        }
    }
    ...
    private static final <R> Object runCatching(Function0<? extends R> object) {
        try {
            Result.Companion companion = Result.Companion;
            return Result.constructor-impl(object.invoke());
        }
        catch (Throwable throwable) {
            Result.Companion companion = Result.Companion;
            return Result.constructor-impl(ResultKt.createFailure(throwable));
