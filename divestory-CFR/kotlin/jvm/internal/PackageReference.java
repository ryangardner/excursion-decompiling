...
implements ClassBasedDeclarationContainer {
    ...
    public PackageReference(Class<?> class_, String string2) {
        Intrinsics.checkParameterIsNotNull(class_, "jClass");
        Intrinsics.checkParameterIsNotNull(string2, "moduleName");
        this.jClass = class_;
        this.moduleName = string2;
    }

    public boolean equals(Object object) {
        if (!(object instanceof PackageReference)) return false;
        if (!Intrinsics.areEqual(this.getJClass(), ((PackageReference)object).getJClass())) return false;
        return true;
    }
