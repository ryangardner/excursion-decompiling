...
implements ClosedRange<T> {
    ...
    public boolean equals(Object object) {
        T t;
        if (!(object instanceof ComparableRange)) return false;
        if (this.isEmpty()) {
            if (((ComparableRange)object).isEmpty()) return true;
        }
        if (!Intrinsics.areEqual(t = this.getStart(), ((ComparableRange)(object = (ComparableRange)object)).getStart())) return false;
        if (!Intrinsics.areEqual(this.getEndInclusive(), ((ComparableRange)object).getEndInclusive())) return false;
        return true;
    }
    ...
    public int hashCode() {
        if (!this.isEmpty()) return this.getStart().hashCode() * 31 + this.getEndInclusive().hashCode();
        return -1;
    }
