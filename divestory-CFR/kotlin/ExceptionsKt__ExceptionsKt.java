...
class ExceptionsKt__ExceptionsKt {
    public static final void addSuppressed(Throwable throwable, Throwable throwable2) {
        Intrinsics.checkParameterIsNotNull(throwable, "$this$addSuppressed");
    ...
    public static final StackTraceElement[] getStackTrace(Throwable arrstackTraceElement) {
        Intrinsics.checkParameterIsNotNull(arrstackTraceElement, "$this$stackTrace");
        arrstackTraceElement = arrstackTraceElement.getStackTrace();
        if (arrstackTraceElement != null) return arrstackTraceElement;
        Intrinsics.throwNpe();
        return arrstackTraceElement;
    }

    private static final void printStackTrace(Throwable throwable) {
        if (throwable == null) throw new TypeCastException("null cannot be cast to non-null type java.lang.Throwable");
