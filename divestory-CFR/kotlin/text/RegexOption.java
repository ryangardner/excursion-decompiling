...
implements FlagEnum {
    ...
    static {
        ...
        IGNORE_CASE = regexOption2 = new RegexOption("IGNORE_CASE", 0, 2, 0, 2, null);
        MULTILINE = regexOption4 = new RegexOption("MULTILINE", 1, 8, 0, 2, null);
        LITERAL = regexOption7 = new RegexOption("LITERAL", 2, 16, 0, 2, null);
        UNIX_LINES = regexOption3 = new RegexOption("UNIX_LINES", 3, 1, 0, 2, null);
        COMMENTS = regexOption = new RegexOption("COMMENTS", 4, 4, 0, 2, null);
        DOT_MATCHES_ALL = regexOption6 = new RegexOption("DOT_MATCHES_ALL", 5, 32, 0, 2, null);
        CANON_EQ = regexOption5 = new RegexOption("CANON_EQ", 6, 128, 0, 2, null);
        $VALUES = new RegexOption[]{regexOption2, regexOption4, regexOption7, regexOption3, regexOption, regexOption6, regexOption5};
    }
    ...
    /* synthetic */ RegexOption(String string2, int n, int n2, int n3, int n4, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n4 & 2) != 0) {
            n3 = n2;
        }
        this(n2, n3);
