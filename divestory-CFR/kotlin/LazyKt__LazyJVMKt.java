...
class LazyKt__LazyJVMKt {
    ...
    public static final <T> Lazy<T> lazy(LazyThreadSafetyMode object, Function0<? extends T> function0) {
        Intrinsics.checkParameterIsNotNull(object, "mode");
        Intrinsics.checkParameterIsNotNull(function0, "initializer");
        int n = LazyKt$WhenMappings.$EnumSwitchMapping$0[object.ordinal()];
        if (n == 1) {
            return new SynchronizedLazyImpl(function0, null, 2, null);
        }
        if (n == 2) return new SafePublicationLazyImpl<T>(function0);
