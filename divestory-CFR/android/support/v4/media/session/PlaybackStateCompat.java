...
implements Parcelable {
    ...
    public static PlaybackStateCompat fromPlaybackState(Object object) {
        ...
        list = PlaybackStateCompatApi21.getCustomActions(object);
        if (list != null) {
            object2 = new ArrayList<Object>(list.size());
            list = list.iterator();
            while (list.hasNext()) {
                object2.add((Object)CustomAction.fromCustomAction(list.next()));
            }
        } else {
            object2 = null;
        }
        if (Build.VERSION.SDK_INT >= 22) {
            bundle = PlaybackStateCompatApi22.getExtras(object);
        }
        object2 = new PlaybackStateCompat(PlaybackStateCompatApi21.getState(object), PlaybackStateCompatApi21.getPosition(object), PlaybackStateCompatApi21.getBufferedPosition(object), PlaybackStateCompatApi21.getPlaybackSpeed(object), PlaybackStateCompatApi21.getActions(object), 0, PlaybackStateCompatApi21.getErrorMessage(object), PlaybackStateCompatApi21.getLastPositionUpdateTime(object), (List<CustomAction>)object2, PlaybackStateCompatApi21.getActiveQueueItemId(object), bundle);
    ...
    public long getCurrentPosition(Long l) {
        ...
        if (l != null) {
            l2 = l;
            return Math.max(0L, l3 + (long)(f * (float)l2));
        }
    ...
    public Object getPlaybackState() {
        ...
        if (this.mCustomActions != null) {
            ...
            Iterator<CustomAction> iterator2 = this.mCustomActions.iterator();
            do {
                arrayList = arrayList2;
                if (!iterator2.hasNext()) break;
                arrayList2.add(iterator2.next().getCustomAction());
            } while (true);
        }
        if (Build.VERSION.SDK_INT >= 22) {
    ...
    implements Parcelable {
        ...
        public static final class Builder {
            ...
            public Builder(String string2, CharSequence charSequence, int n) {
                if (TextUtils.isEmpty((CharSequence)string2)) throw new IllegalArgumentException("You must specify an action to build a CustomAction.");
