...
public interface INotificationSideChannel extends IInterface {
   ...
   public abstract static class Stub extends Binder implements INotificationSideChannel {
      ...
      public static boolean setDefaultImpl(INotificationSideChannel var0) {
         if (INotificationSideChannel.Stub.Proxy.sDefaultImpl == null && var0 != null) {
            INotificationSideChannel.Stub.Proxy.sDefaultImpl = var0;
            return true;
         } else {
            return false;
         }
      ...
      private static class Proxy implements INotificationSideChannel {
         ...
         public void cancel(String var1, int var2, String var3) throws RemoteException {
            ...
            try {
               ...
               if (!this.mRemote.transact(2, var4, (Parcel)null, 1) && INotificationSideChannel.Stub.getDefaultImpl() != null) {
                  INotificationSideChannel.Stub.getDefaultImpl().cancel(var1, var2, var3);
                  return;
               }
            } finally {
               var4.recycle();
         ...
         public void cancelAll(String var1) throws RemoteException {
            ...
            try {
               ...
               if (!this.mRemote.transact(3, var2, (Parcel)null, 1) && INotificationSideChannel.Stub.getDefaultImpl() != null) {
                  INotificationSideChannel.Stub.getDefaultImpl().cancelAll(var1);
                  return;
               }
            } finally {
               var2.recycle();
         ...
         public void notify(String var1, int var2, String var3, Notification var4) throws RemoteException {
            ...
            label215: {
               ...
               label201: {
                  try {
                     if (!this.mRemote.transact(1, var5, (Parcel)null, 1) && INotificationSideChannel.Stub.getDefaultImpl() != null) {
                        INotificationSideChannel.Stub.getDefaultImpl().notify(var1, var2, var3, var4);
                        break label201;
                     }
