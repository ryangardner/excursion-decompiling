...
public class MediaSessionCompat {
   ...
   static PlaybackStateCompat getStateWithUpdatedPosition(PlaybackStateCompat var0, MediaMetadataCompat var1) {
      PlaybackStateCompat var2 = var0;
      if (var0 != null) {
         long var3 = var0.getPosition();
         long var5 = -1L;
         if (var3 == -1L) {
            var2 = var0;
         } else {
            ...
            var3 = var0.getLastPositionUpdateTime();
            var2 = var0;
            if (var3 > 0L) {
               long var7 = SystemClock.elapsedRealtime();
               long var9 = (long)(var0.getPlaybackSpeed() * (float)(var7 - var3)) + var0.getPosition();
               var3 = var5;
               if (var1 != null) {
                  var3 = var5;
                  if (var1.containsKey("android.media.metadata.DURATION")) {
                     var3 = var1.getLong("android.media.metadata.DURATION");
                  }
               }

               if (var3 < 0L || var9 <= var3) {
                  if (var9 < 0L) {
                     var3 = 0L;
                  } else {
                     var3 = var9;
               ...
               var2 = (new PlaybackStateCompat.Builder(var0)).setState(var0.getState(), var3, var0.getPlaybackSpeed(), var7).build();
            }
         }
      }
   ...
   public abstract static class Callback {
      ...
      void handleMediaPlayPauseKeySingleTapIfPending(MediaSessionManager.RemoteUserInfo var1) {
         if (this.mMediaPlayPauseKeyPending) {
            ...
            MediaSessionCompat.MediaSessionImpl var3 = (MediaSessionCompat.MediaSessionImpl)this.mSessionImpl.get();
            if (var3 != null) {
               ...
               if (var4 == null) {
                  ...
                  var5 = var4.getActions();
               }

               boolean var7;
               if (var4 != null && var4.getState() == 3) {
                  var7 = true;
               } else {
                  var7 = false;
               }
               ...
               var3.setCurrentControllerInfo(var1);
               if (var7 && var2) {
                  this.onPause();
               } else if (!var7 && var8) {
                  this.onPlay();
               ...
               var3.setCurrentControllerInfo((MediaSessionManager.RemoteUserInfo)null);
            }
         }
      }
      ...
      public boolean onMediaButtonEvent(Intent var1) {
         if (VERSION.SDK_INT >= 27) {
            ...
            if (var2 != null && this.mCallbackHandler != null) {
               ...
               if (var3 != null && var3.getAction() == 0) {
                  MediaSessionManager.RemoteUserInfo var7 = var2.getCurrentControllerInfo();
                  ...
                  if (var3.getRepeatCount() > 0) {
                     ...
                     this.mCallbackHandler.removeMessages(1);
                     this.mMediaPlayPauseKeyPending = false;
                     PlaybackStateCompat var8 = var2.getPlaybackState();
                     long var5;
                     if (var8 == null) {
                        var5 = 0L;
                     } else {
      ...
      private class StubApi21 implements MediaSessionCompatApi21.Callback {
         ...
         public void onCommand(String var1, Bundle var2, ResultReceiver var3) {
            label133: {
               ...
               MediaSessionCompat.Token var5 = null;
               Object var6 = null;
               if (var4) {
                  label136: {
                     MediaSessionCompat.MediaSessionImplApi21 var23;
                     try {
                        var23 = (MediaSessionCompat.MediaSessionImplApi21)Callback.this.mSessionImpl.get();
                     ...
                     try {
                        var2 = new Bundle();
                        var5 = var23.getSessionToken();
                        var24 = var5.getExtraBinder();
                     ...
                     try {
                        ...
                        var2.putBundle("android.support.v4.media.session.SESSION_TOKEN2_BUNDLE", var5.getSessionToken2Bundle());
                        var3.send(0, var2);
                        return;
                  ...
                  label129: {
                     try {
                        var4 = var1.equals("android.support.v4.media.session.command.ADD_QUEUE_ITEM");
                     ...
                     if (var4) {
                        ...
                        label125: {
                           try {
                              var4 = var1.equals("android.support.v4.media.session.command.ADD_QUEUE_ITEM_AT");
                           ...
                           if (var4) {
                              ...
                              label137: {
                                 ...
                                 MediaSessionCompat.MediaSessionImplApi21 var27;
                                 label117: {
                                    try {
                                       if (var1.equals("android.support.v4.media.session.command.REMOVE_QUEUE_ITEM_AT")) {
                                          var27 = (MediaSessionCompat.MediaSessionImplApi21)Callback.this.mSessionImpl.get();
                                          break label117;
                                       }
                                 ...
                                 MediaSessionCompat.QueueItem var26 = var5;
                                 if (var7 >= 0) {
                                    var26 = var5;

                                    try {
                                       if (var7 < var27.mQueue.size()) {
                                          var26 = (MediaSessionCompat.QueueItem)var27.mQueue.get(var7);
                                       }
                                 ...
                                 try {
                                    Callback.this.onRemoveQueueItem(var26.getDescription());
                                    return;
         ...
         public void onCustomAction(String var1, Bundle var2) {
            Bundle var3 = var2.getBundle("android.support.v4.media.session.action.ARGUMENT_EXTRAS");
            ...
            if (var1.equals("android.support.v4.media.session.action.PLAY_FROM_URI")) {
               ...
               Callback.this.onPlayFromUri(var6, var3);
               ...
               Callback.this.onPrepareFromMediaId(var1, var3);
               ...
               Callback.this.onPrepareFromSearch(var1, var3);
            } else if (var1.equals("android.support.v4.media.session.action.PREPARE_FROM_URI")) {
               var6 = (Uri)var2.getParcelable("android.support.v4.media.session.action.ARGUMENT_URI");
               Callback.this.onPrepareFromUri(var6, var3);
               ...
               if (var1.equals("android.support.v4.media.session.action.SET_REPEAT_MODE")) {
                  var5 = var2.getInt("android.support.v4.media.session.action.ARGUMENT_REPEAT_MODE");
                  Callback.this.onSetRepeatMode(var5);
               } else if (var1.equals("android.support.v4.media.session.action.SET_SHUFFLE_MODE")) {
                  var5 = var2.getInt("android.support.v4.media.session.action.ARGUMENT_SHUFFLE_MODE");
                  Callback.this.onSetShuffleMode(var5);
                  ...
                  Callback.this.onSetRating(var7, var3);
               } else {
   ...
   static class MediaSessionImplApi21 implements MediaSessionCompat.MediaSessionImpl {
      ...
      MediaSessionImplApi21(Context var1, String var2, Bundle var3) {
         ...
         this.mToken = new MediaSessionCompat.Token(MediaSessionCompatApi21.getSessionToken(this.mSessionObj), new MediaSessionCompat.MediaSessionImplApi21.ExtraSession(), var3);
      }
      ...
      class ExtraSession extends IMediaSession.Stub {
         ...
         public void registerCallbackListener(IMediaControllerCallback var1) {
            if (!MediaSessionImplApi21.this.mDestroyed) {
               String var2 = MediaSessionImplApi21.this.getCallingPackage();
               String var3 = var2;
               if (var2 == null) {
                  var3 = "android.media.session.MediaController";
               }

               MediaSessionManager.RemoteUserInfo var4 = new MediaSessionManager.RemoteUserInfo(var3, getCallingPid(), getCallingUid());
   ...
   static class MediaSessionImplBase implements MediaSessionCompat.MediaSessionImpl {
      ...
      public void setPlaybackToLocal(int var1) {
         ...
         int var3 = this.mLocalStream;
         this.sendVolumeInfoChanged(new ParcelableVolumeInfo(var1, var3, 2, this.mAudioManager.getStreamMaxVolume(var3), this.mAudioManager.getStreamVolume(this.mLocalStream)));
      }
   ...
   public static final class QueueItem implements Parcelable {
      ...
      public static List<MediaSessionCompat.QueueItem> fromQueueItemList(List<?> var0) {
   ...
   public static final class Token implements Parcelable {
      ...
      public static MediaSessionCompat.Token fromBundle(Bundle var0) {
         ...
         if (var0 == null) {
            ...
            IMediaSession var2 = IMediaSession.Stub.asInterface(BundleCompat.getBinder(var0, "android.support.v4.media.session.EXTRA_BINDER"));
            Bundle var3 = var0.getBundle("android.support.v4.media.session.SESSION_TOKEN2_BUNDLE");
            MediaSessionCompat.Token var4 = (MediaSessionCompat.Token)var0.getParcelable("android.support.v4.media.session.TOKEN");
            if (var4 == null) {
               var4 = (MediaSessionCompat.Token)var1;
            } else {
               var4 = new MediaSessionCompat.Token(var4.mInner, var2, var3);
            }
