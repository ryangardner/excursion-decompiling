...
public final class PlaybackStateCompat implements Parcelable {
   ...
   PlaybackStateCompat(int var1, long var2, long var4, float var6, long var7, int var9, CharSequence var10, long var11, List<PlaybackStateCompat.CustomAction> var13, long var14, Bundle var16) {
      this.mState = var1;
      this.mPosition = var2;
   ...
   public static PlaybackStateCompat fromPlaybackState(Object var0) {
      List var1 = null;
      Bundle var2 = null;
      PlaybackStateCompat var3 = var1;
      if (var0 != null) {
         var3 = var1;
         if (VERSION.SDK_INT >= 21) {
            var1 = PlaybackStateCompatApi21.getCustomActions(var0);
            ArrayList var5;
            if (var1 != null) {
               var5 = new ArrayList(var1.size());
               Iterator var4 = var1.iterator();

               while(var4.hasNext()) {
                  var5.add(PlaybackStateCompat.CustomAction.fromCustomAction(var4.next()));
               }
            } else {
               var5 = null;
            }
            ...
            if (VERSION.SDK_INT >= 22) {
               var2 = PlaybackStateCompatApi22.getExtras(var0);
            }

            var3 = new PlaybackStateCompat(PlaybackStateCompatApi21.getState(var0), PlaybackStateCompatApi21.getPosition(var0), PlaybackStateCompatApi21.getBufferedPosition(var0), PlaybackStateCompatApi21.getPlaybackSpeed(var0), PlaybackStateCompatApi21.getActions(var0), 0, PlaybackStateCompatApi21.getErrorMessage(var0), PlaybackStateCompatApi21.getLastPositionUpdateTime(var0), var5, PlaybackStateCompatApi21.getActiveQueueItemId(var0), var2);
            var3.mStateObj = var0;
         }
      }
   ...
   public long getCurrentPosition(Long var1) {
      long var2 = this.mPosition;
      float var4 = this.mSpeed;
      long var5;
      if (var1 != null) {
         var5 = var1;
      } else {
         var5 = SystemClock.elapsedRealtime() - this.mUpdateTime;
      }

      return Math.max(0L, var2 + (long)(var4 * (float)var5));
   }
