...
public final class MediaControllerCompat {
   ...
   public MediaControllerCompat(Context var1, MediaSessionCompat var2) {
      if (var2 != null) {
         ...
         Object var5;
         label34: {
            MediaControllerCompat.MediaControllerImplApi24 var3;
            try {
               if (VERSION.SDK_INT < 24) {
                  if (VERSION.SDK_INT >= 23) {
                     var5 = new MediaControllerCompat.MediaControllerImplApi23(var1, this.mToken);
                  } else if (VERSION.SDK_INT >= 21) {
                     var5 = new MediaControllerCompat.MediaControllerImplApi21(var1, this.mToken);
                  } else {
                     var5 = new MediaControllerCompat.MediaControllerImplBase(this.mToken);
                  }
                  break label34;
               }

               var3 = new MediaControllerCompat.MediaControllerImplApi24(var1, this.mToken);
            } catch (RemoteException var4) {
               Log.w("MediaControllerCompat", "Failed to create MediaControllerImpl.", var4);
               var5 = var2;
               break label34;
            }
         ...
         this.mImpl = (MediaControllerCompat.MediaControllerImpl)var5;
      } else {
   ...
   static void validateCustomAction(String var0, Bundle var1) {
      if (var0 != null) {
         ...
         if ((var2 == 0 || var2 == 1) && (var1 == null || !var1.containsKey("android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE"))) {
