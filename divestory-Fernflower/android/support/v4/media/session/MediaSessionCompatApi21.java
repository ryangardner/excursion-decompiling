...
class MediaSessionCompatApi21 {
   ...
   static class CallbackProxy<T extends MediaSessionCompatApi21.Callback> extends android.media.session.MediaSession.Callback {
      ...
      public boolean onMediaButtonEvent(Intent var1) {
         boolean var2;
         if (!this.mCallback.onMediaButtonEvent(var1) && !super.onMediaButtonEvent(var1)) {
            var2 = false;
         } else {
            var2 = true;
         }
