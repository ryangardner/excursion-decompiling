...
public final class MediaDescriptionCompat implements Parcelable {
   ...
   public static MediaDescriptionCompat fromMediaDescription(Object var0) {
      Bundle var1 = null;
      Bundle var2 = null;
      MediaDescriptionCompat var3 = var1;
      if (var0 != null) {
         var3 = var1;
         if (VERSION.SDK_INT >= 21) {
            ...
            var1 = MediaDescriptionCompatApi21.getExtras(var0);
            Uri var5;
            if (var1 != null) {
               MediaSessionCompat.ensureClassLoader(var1);
               var5 = (Uri)var1.getParcelable("android.support.v4.media.description.MEDIA_URI");
            } else {
               var5 = null;
            }
            ...
            label30: {
               if (var5 != null) {
                  if (var1.containsKey("android.support.v4.media.description.NULL_BUNDLE_FLAG") && var1.size() == 2) {
                     break label30;
                  }

                  var1.remove("android.support.v4.media.description.MEDIA_URI");
                  var1.remove("android.support.v4.media.description.NULL_BUNDLE_FLAG");
               }
   ...
   public Object getMediaDescription() {
      if (this.mDescriptionObj == null && VERSION.SDK_INT >= 21) {
         ...
         Object var4 = MediaDescriptionCompatApi21.Builder.build(var1);
