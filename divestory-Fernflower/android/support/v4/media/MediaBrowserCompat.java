...
public final class MediaBrowserCompat {
   ...
   private static class CallbackHandler extends Handler {
      ...
      public void handleMessage(Message var1) {
         WeakReference var2 = this.mCallbacksMessengerRef;
         if (var2 != null && var2.get() != null && this.mCallbackImplRef.get() != null) {
            Bundle var3 = var1.getData();
            MediaSessionCompat.ensureClassLoader(var3);
            MediaBrowserCompat.MediaBrowserServiceCallbackImpl var13 = (MediaBrowserCompat.MediaBrowserServiceCallbackImpl)this.mCallbackImplRef.get();
            ...
            label50: {
               ...
               if (var5 != 1) {
                  if (var5 != 2) {
                     if (var5 != 3) {
                        try {
                           ...
                           var14.append("Unhandled message: ");
                           var14.append(var1);
                           var14.append("\n  Client version: ");
                           var14.append(1);
                           var14.append("\n  Service version: ");
                           var14.append(var1.arg1);
                           Log.w("MediaBrowserCompat", var14.toString());
                           return;
                        ...
                        try {
                           Bundle var6 = var3.getBundle("data_options");
                           MediaSessionCompat.ensureClassLoader(var6);
                           var7 = var3.getBundle("data_notify_children_changed_options");
                           MediaSessionCompat.ensureClassLoader(var7);
                           var13.onLoadChildren(var4, var3.getString("data_media_item_id"), var3.getParcelableArrayList("data_media_item_list"), var6, var7);
                           return;
                  ...
                  try {
                     var7 = var3.getBundle("data_root_hints");
                     MediaSessionCompat.ensureClassLoader(var7);
                     var13.onServiceConnected(var4, var3.getString("data_media_item_id"), (MediaSessionCompat.Token)var3.getParcelable("data_media_session_token"), var7);
                     return;
   ...
   static class MediaBrowserImplApi21 implements MediaBrowserCompat.MediaBrowserImpl, MediaBrowserCompat.MediaBrowserServiceCallbackImpl, MediaBrowserCompat.ConnectionCallback.ConnectionCallbackInternal {
      ...
      public void unsubscribe(String var1, MediaBrowserCompat.SubscriptionCallback var2) {
         ...
         if (var3 != null) {
            MediaBrowserCompat.ServiceBinderWrapper var4 = this.mServiceBinderWrapper;
            List var5;
            int var6;
            List var10;
            if (var4 == null) {
               if (var2 == null) {
                  ...
                  var10 = var3.getCallbacks();
                  var5 = var3.getOptionsList();

                  for(var6 = var10.size() - 1; var6 >= 0; --var6) {
                     if (var10.get(var6) == var2) {
                        var10.remove(var6);
                        var5.remove(var6);
                     }
                  }
               ...
               label68: {
                  ...
                  if (var2 == null) {
                     try {
                        var4.removeSubscription(var1, (IBinder)null, this.mCallbacksMessenger);
                        break label68;
               ...
               public void run() {
                  if (MediaBrowserImplBase.this.mState != 0) {
                     ...
                     if (MediaBrowserCompat.DEBUG && MediaBrowserImplBase.this.mServiceConnection != null) {
                        ...
                        var1.append("mServiceConnection should be null. Instead it is ");
                        var1.append(MediaBrowserImplBase.this.mServiceConnection);
                        throw new RuntimeException(var1.toString());
                     } else if (MediaBrowserImplBase.this.mServiceBinderWrapper != null) {
                        var1 = new StringBuilder();
                        var1.append("mServiceBinderWrapper should be null. Instead it is ");
                        var1.append(MediaBrowserImplBase.this.mServiceBinderWrapper);
                        throw new RuntimeException(var1.toString());
                     } else if (MediaBrowserImplBase.this.mCallbacksMessenger == null) {
                        Intent var5 = new Intent("android.media.browse.MediaBrowserService");
                        var5.setComponent(MediaBrowserImplBase.this.mServiceComponent);
                        ...
                        label34: {
                           boolean var3;
                           try {
                              var3 = MediaBrowserImplBase.this.mContext.bindService(var5, MediaBrowserImplBase.this.mServiceConnection, 1);
                           } catch (Exception var4) {
                              var1 = new StringBuilder();
                              var1.append("Failed binding to service ");
                              var1.append(MediaBrowserImplBase.this.mServiceComponent);
                              Log.e("MediaBrowserCompat", var1.toString());
                              break label34;
                           }
                        ...
                        var1 = new StringBuilder();
                        var1.append("mCallbacksMessenger should be null. Instead it is ");
                        var1.append(MediaBrowserImplBase.this.mCallbacksMessenger);
                        throw new RuntimeException(var1.toString());
                     }
                  }
               }
         ...
         if (this.isCurrent(var1, "onConnect")) {
            if (this.mState != 2) {
               ...
               label43: {
                  ...
                  boolean var10001;
                  try {
                     var11 = this.mSubscriptions.entrySet().iterator();
                  } catch (RemoteException var8) {
                     var10001 = false;
                     break label43;
                  }
                  ...
                  while(true) {
                     ...
                     try {
                        ...
                        var9 = (String)var12.getKey();
                        MediaBrowserCompat.Subscription var14 = (MediaBrowserCompat.Subscription)var12.getValue();
                        var13 = var14.getCallbacks();
                        var15 = var14.getOptionsList();
                     } catch (RemoteException var7) {
                        var10001 = false;
                        break;
                     }
                     ...
                     while(true) {
                        try {
                           ...
                           this.mServiceBinderWrapper.addSubscription(var9, ((MediaBrowserCompat.SubscriptionCallback)var13.get(var5)).mToken, (Bundle)var15.get(var5), this.mCallbacksMessenger);
                        } catch (RemoteException var6) {
                           var10001 = false;
                           break label40;
                        }
   ...
   public static class MediaItem implements Parcelable {
      ...
      public static List<MediaBrowserCompat.MediaItem> fromMediaItemList(List<?> var0) {
         if (var0 != null && VERSION.SDK_INT >= 21) {
   ...
   public abstract static class SearchCallback {
      ...
      public void onSearchResult(String var1, Bundle var2, List<MediaBrowserCompat.MediaItem> var3) {
      }
   }
   ...
   public abstract static class SubscriptionCallback {
      ...
      public void onChildrenLoaded(String var1, List<MediaBrowserCompat.MediaItem> var2) {
      }

      public void onChildrenLoaded(String var1, List<MediaBrowserCompat.MediaItem> var2, Bundle var3) {
      }
      ...
      private class StubApi21 implements MediaBrowserCompatApi21.SubscriptionCallback {
         ...
         List<MediaBrowserCompat.MediaItem> applyOptions(List<MediaBrowserCompat.MediaItem> var1, Bundle var2) {
            if (var1 == null) {
               return null;
            } else {
