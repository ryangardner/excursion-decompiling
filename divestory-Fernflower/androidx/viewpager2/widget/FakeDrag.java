...
final class FakeDrag {
   ...
   boolean endFakeDrag() {
      if (!this.mScrollEventAdapter.isFakeDragging()) {
         ...
         int var2 = (int)var1.getXVelocity();
         int var3 = (int)var1.getYVelocity();
         if (!this.mRecyclerView.fling(var2, var3)) {
   ...
   boolean fakeDragBy(float var1) {
      boolean var2 = this.mScrollEventAdapter.isFakeDragging();
      byte var3 = 0;
      if (!var2) {
         return false;
      } else {
         ...
         int var4 = Math.round(var1 - (float)this.mActualDraggedDistance);
         this.mActualDraggedDistance += var4;
         ...
         if (var7) {
            ...
            var9 = this.mRequestedDragDistance;
         }

         this.mRecyclerView.scrollBy(var8, var4);
         this.addFakeMotionEvent(var5, 2, var1, var9);
         return true;
      }
   }
