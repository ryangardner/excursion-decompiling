...
public class ArcMotion extends PathMotion {
   ...
   public Path getPath(float var1, float var2, float var3, float var4) {
      ...
      if (Math.abs(var6) < Math.abs(var7)) {
         ...
         var8 = this.mMinimumVerticalTangent;
      } else {
         var7 = var8 / (var6 * 2.0F);
         if (var12) {
            var6 = var2;
         ...
         var8 = this.mMinimumHorizontalTangent;
      }

      var8 = var11 * var8 * var8;
      float var13 = var9 - var7;
      float var14 = var10 - var6;
      var13 = var13 * var13 + var14 * var14;
      var14 = this.mMaximumTangent;
      var11 = var11 * var14 * var14;
      if (var13 >= var8) {
         if (var13 > var11) {
            var8 = var11;
         } else {
      ...
      var11 = var7;
      if (var8 != 0.0F) {
         var8 = (float)Math.sqrt((double)(var8 / var13));
         var11 = (var7 - var9) * var8 + var9;
         var14 = var10 + var8 * (var6 - var10);
      }

      var5.cubicTo((var1 + var11) / 2.0F, (var2 + var14) / 2.0F, (var11 + var3) / 2.0F, (var14 + var4) / 2.0F, var3, var4);
      return var5;
   }
