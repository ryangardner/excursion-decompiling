      ...
      if (var10 > 0) {
         ...
         if (var11 > 0) {
            ...
            if (HAS_PICTURE_BITMAP) {
               Picture var14 = new Picture();
               Canvas var16 = var14.beginRecording(var10, var11);
               var16.concat(var1);
               var0.draw(var16);
               var14.endRecording();
               var12 = Bitmap.createBitmap(var14);
            } else {
               var12 = Bitmap.createBitmap(var10, var11, Config.ARGB_8888);
               Canvas var15 = new Canvas(var12);
               var15.concat(var1);
               var0.draw(var15);
            }
         }
   ...
   static class MatrixEvaluator implements TypeEvaluator<Matrix> {
      ...
      public Matrix evaluate(float var1, Matrix var2, Matrix var3) {
         ...
         for(int var4 = 0; var4 < 9; ++var4) {
            ...
            float var6 = var8[var4];
            var7[var4] = var8[var4] + (var5 - var6) * var1;
         }
