...
public abstract class VisibilityPropagation extends TransitionPropagation {
   ...
   public void captureValues(TransitionValues var1) {
      ...
      Integer var4 = var3;
      if (var3 == null) {
         var4 = var2.getVisibility();
      }

      var1.values.put("android:visibilityPropagation:visibility", var4);
      int[] var5 = new int[2];
      var2.getLocationOnScreen(var5);
      var5[0] += Math.round(var2.getTranslationX());
      var5[0] += var2.getWidth() / 2;
      var5[1] += Math.round(var2.getTranslationY());
      var5[1] += var2.getHeight() / 2;
