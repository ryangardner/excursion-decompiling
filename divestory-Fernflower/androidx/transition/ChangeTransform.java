...
public class ChangeTransform extends Transition {
   private static final Property<ChangeTransform.PathAnimatorMatrix, float[]> NON_TRANSLATIONS_PROPERTY = new Property<ChangeTransform.PathAnimatorMatrix, float[]>(float[].class, "nonTranslations") {
   ...
   private static final Property<ChangeTransform.PathAnimatorMatrix, PointF> TRANSLATIONS_PROPERTY = new Property<ChangeTransform.PathAnimatorMatrix, PointF>(PointF.class, "translations") {
   ...
   private void captureValues(TransitionValues var1) {
      ...
      if (var2.getVisibility() != 8) {
         var1.values.put("android:changeTransform:parent", var2.getParent());
         ChangeTransform.Transforms var3 = new ChangeTransform.Transforms(var2);
         var1.values.put("android:changeTransform:transforms", var3);
         ...
         if (this.mReparent) {
            ...
            var1.values.put("android:changeTransform:intermediateMatrix", var2.getTag(R.id.transition_transform));
            var1.values.put("android:changeTransform:intermediateParentMatrix", var2.getTag(R.id.parent_matrix));
         }
   ...
   private ObjectAnimator createTransformAnimator(TransitionValues var1, TransitionValues var2, final boolean var3) {
      ...
      Matrix var4 = (Matrix)var2.values.get("android:changeTransform:matrix");
      Matrix var5 = var9;
      if (var9 == null) {
         var5 = MatrixUtils.IDENTITY_MATRIX;
      }
      ...
      if (var5.equals(var9)) {
         ...
         final ChangeTransform.Transforms var12 = (ChangeTransform.Transforms)var2.values.get("android:changeTransform:transforms");
         ...
         var9.getValues(var7);
         final ChangeTransform.PathAnimatorMatrix var13 = new ChangeTransform.PathAnimatorMatrix(var10, var6);
         PropertyValuesHolder var8 = PropertyValuesHolder.ofObject(NON_TRANSLATIONS_PROPERTY, new FloatArrayEvaluator(new float[9]), new float[][]{var6, var7});
         Path var14 = this.getPathMotion().getPath(var6[2], var6[5], var7[2], var7[5]);
         ObjectAnimator var15 = ObjectAnimator.ofPropertyValuesHolder(var13, new PropertyValuesHolder[]{var8, PropertyValuesHolderUtils.ofPointF(TRANSLATIONS_PROPERTY, var14)});
         AnimatorListenerAdapter var11 = new AnimatorListenerAdapter() {
            ...
            private void setCurrentMatrix(Matrix var1) {
               ...
               var10.setTag(R.id.transition_transform, this.mTempMatrix);
               var12.restore(var10);
            }
            ...
            public void onAnimationEnd(Animator var1) {
               if (!this.mIsCanceled) {
                  if (var3 && ChangeTransform.this.mUseOverlay) {
                     ...
                     var10.setTag(R.id.transition_transform, (Object)null);
                     var10.setTag(R.id.parent_matrix, (Object)null);
                  }
               }
            ...
            public void onAnimationPause(Animator var1) {
               this.setCurrentMatrix(var13.getMatrix());
            }
   ...
   private boolean parentsMatch(ViewGroup var1, ViewGroup var2) {
      boolean var3 = this.isValidTarget(var1);
      boolean var4 = true;
      boolean var5 = false;
      if (var3 && this.isValidTarget(var2)) {
   ...
   public Animator createAnimator(ViewGroup var1, TransitionValues var2, TransitionValues var3) {
      if (var2 != null && var3 != null && var2.values.containsKey("android:changeTransform:parent") && var3.values.containsKey("android:changeTransform:parent")) {
         ViewGroup var4 = (ViewGroup)var2.values.get("android:changeTransform:parent");
         ViewGroup var5 = (ViewGroup)var3.values.get("android:changeTransform:parent");
         boolean var6;
         if (this.mReparent && !this.parentsMatch(var4, var5)) {
            var6 = true;
         } else {
            var6 = false;
         }
         ...
         ObjectAnimator var8 = this.createTransformAnimator(var2, var3, var6);
         if (var6 && var8 != null && this.mUseOverlay) {
            this.createGhostView(var1, var2, var3);
         } else if (!SUPPORTS_VIEW_REMOVAL_SUPPRESSION) {
            var4.endViewTransition(var2.view);
         }
   ...
   private static class Transforms {
      ...
      public int hashCode() {
         ...
         return ((((((var3 * 31 + var4) * 31 + var5) * 31 + var6) * 31 + var7) * 31 + var8) * 31 + var9) * 31 + var2;
      }
