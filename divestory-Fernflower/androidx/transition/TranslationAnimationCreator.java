...
class TranslationAnimationCreator {
   ...
   static Animator createAnimation(View var0, TransitionValues var1, int var2, int var3, float var4, float var5, float var6, float var7, TimeInterpolator var8, Transition var9) {
      ...
      int[] var12 = (int[])var1.view.getTag(R.id.transition_position);
      if (var12 != null) {
         var4 = (float)(var12[0] - var2) + var10;
         var5 = (float)(var12[1] - var3) + var11;
      }

      int var13 = Math.round(var4 - var10);
      int var14 = Math.round(var5 - var11);
      ...
      if (var4 == var6 && var5 == var7) {
         ...
         TranslationAnimationCreator.TransitionPositionListener var15 = new TranslationAnimationCreator.TransitionPositionListener(var0, var1.view, var2 + var13, var3 + var14, var10, var11);
   ...
   private static class TransitionPositionListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
      ...
      TransitionPositionListener(View var1, View var2, int var3, int var4, float var5, float var6) {
         ...
         int[] var7 = (int[])this.mViewInHierarchy.getTag(R.id.transition_position);
