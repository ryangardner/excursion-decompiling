...
public class ChangeBounds extends Transition {
   ...
   private static final Property<ChangeBounds.ViewBounds, PointF> BOTTOM_RIGHT_PROPERTY = new Property<ChangeBounds.ViewBounds, PointF>(PointF.class, "bottomRight") {
   ...
   private static final Property<ChangeBounds.ViewBounds, PointF> TOP_LEFT_PROPERTY = new Property<ChangeBounds.ViewBounds, PointF>(PointF.class, "topLeft") {
      public PointF get(ChangeBounds.ViewBounds var1) {
         return null;
      }
   ...
   public Animator createAnimator(final ViewGroup var1, TransitionValues var2, TransitionValues var3) {
      if (var2 != null && var3 != null) {
         ...
         ViewGroup var34 = (ViewGroup)var4.get("android:changeBounds:parent");
         ViewGroup var6 = (ViewGroup)var5.get("android:changeBounds:parent");
         if (var34 != null && var6 != null) {
            ...
            if (this.parentMatches(var34, var6)) {
               Rect var22 = (Rect)var2.values.get("android:changeBounds:bounds");
               final Rect var37 = (Rect)var3.values.get("android:changeBounds:bounds");
               var7 = var22.left;
               final int var8 = var37.left;
               int var9 = var22.top;
               final int var10 = var37.top;
               var11 = var22.right;
               final int var12 = var37.right;
               int var13 = var22.bottom;
               final int var14 = var37.bottom;
               ...
               var37 = (Rect)var3.values.get("android:changeBounds:clip");
               ...
               label149: {
                  if (var27 == null || var27.equals(var37)) {
                     var19 = var20;
                     if (var27 != null) {
                        break label149;
                     }
                  ...
                  if (!this.mResizeClip) {
                     ...
                     if (var19 == 2) {
                        if (var15 == var17 && var16 == var18) {
                           ...
                           ObjectAnimator var40 = ObjectAnimatorUtils.ofPointF(var29, BOTTOM_RIGHT_PROPERTY, var23);
                           var25 = new AnimatorSet();
                           ((AnimatorSet)var25).playTogether(new Animator[]{var32, var40});
                        ...
                        var31 = this.getPathMotion().getPath((float)var7, (float)var9, (float)var8, (float)var10);
                        var25 = ObjectAnimatorUtils.ofPointF(var38, TOP_LEFT_ONLY_PROPERTY, var31);
                     }
                  } else {
                     ViewUtils.setLeftTopRightBottom(var38, var7, var9, Math.max(var15, var17) + var7, Math.max(var16, var18) + var9);
                     ...
                     Rect var36;
                     if (var37 == null) {
                        var36 = new Rect(0, 0, var17, var18);
                     } else {
                        var36 = var37;
                     }

                     ObjectAnimator var39;
                     if (!var27.equals(var36)) {
                        ViewCompat.setClipBounds(var38, var27);
                        var39 = ObjectAnimator.ofObject(var38, "clipBounds", sRectEvaluator, new Object[]{var27, var36});
                        var39.addListener(new AnimatorListenerAdapter() {
                           ...
                           public void onAnimationEnd(Animator var1) {
                              if (!this.mIsCanceled) {
                                 ViewCompat.setClipBounds(var38, var37);
                     ...
                     var25 = TransitionUtils.mergeAnimators(var33, var39);
                  }

                  if (var38.getParent() instanceof ViewGroup) {
                     final ViewGroup var41 = (ViewGroup)var38.getParent();
                     ViewGroupUtils.suppressLayout(var41, true);
                     this.addListener(new TransitionListenerAdapter() {
                        boolean mCanceled = false;

                        public void onTransitionCancel(Transition var1) {
                           ViewGroupUtils.suppressLayout(var41, false);
                           this.mCanceled = true;
                        }
               ...
               var20 = (Integer)var2.values.get("android:changeBounds:windowX");
               var19 = (Integer)var2.values.get("android:changeBounds:windowY");
               var7 = (Integer)var3.values.get("android:changeBounds:windowX");
               var11 = (Integer)var3.values.get("android:changeBounds:windowY");
               if (var20 != var7 || var19 != var11) {
                  ...
                  final float var21 = ViewUtils.getTransitionAlpha(var38);
                  ViewUtils.setTransitionAlpha(var38, 0.0F);
                  ViewUtils.getOverlay(var1).add(var26);
                  PathMotion var28 = this.getPathMotion();
                  int[] var35 = this.mTempLocation;
                  Path var30 = var28.getPath((float)(var20 - var35[0]), (float)(var19 - var35[1]), (float)(var7 - var35[0]), (float)(var11 - var35[1]));
                  ...
                  var32.addListener(new AnimatorListenerAdapter() {
                     public void onAnimationEnd(Animator var1x) {
                        ...
                        ViewUtils.setTransitionAlpha(var38, var21);
                     }
                  });
                  return var32;
               }
