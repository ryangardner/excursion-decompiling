...
class GhostViewPort extends ViewGroup implements GhostView {
   ...
   static GhostViewPort addGhost(View var0, ViewGroup var1, Matrix var2) {
      if (var0.getParent() instanceof ViewGroup) {
         GhostViewHolder var3 = GhostViewHolder.getHolder(var1);
         GhostViewPort var4 = getGhostView(var0);
         byte var5 = 0;
         GhostViewPort var6 = var4;
         int var7 = var5;
         if (var4 != null) {
            GhostViewHolder var8 = (GhostViewHolder)var4.getParent();
            var6 = var4;
            var7 = var5;
            if (var8 != var3) {
               var7 = var4.mReferences;
               var8.removeView(var4);
               var6 = null;
            }
         }
   ...
   static GhostViewPort getGhostView(View var0) {
      return (GhostViewPort)var0.getTag(R.id.ghost_view);
   }
