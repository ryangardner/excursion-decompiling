...
public final class AsyncLayoutInflater {
   ...
   private static class InflateThread extends Thread {
      ...
      public AsyncLayoutInflater.InflateRequest obtainRequest() {
         AsyncLayoutInflater.InflateRequest var1 = (AsyncLayoutInflater.InflateRequest)this.mRequestPool.acquire();
         AsyncLayoutInflater.InflateRequest var2 = var1;
         if (var1 == null) {
            var2 = new AsyncLayoutInflater.InflateRequest();
         }
