...
public class PagerTabStrip extends PagerTitleStrip {
   ...
   public PagerTabStrip(Context var1, AttributeSet var2) {
      ...
      int var3 = this.mTextColor;
      this.mIndicatorColor = var3;
      this.mTabPaint.setColor(var3);
      float var4 = var1.getResources().getDisplayMetrics().density;
      this.mIndicatorHeight = (int)(3.0F * var4 + 0.5F);
      this.mMinPaddingBottom = (int)(6.0F * var4 + 0.5F);
      this.mMinTextSpacing = (int)(64.0F * var4);
      this.mTabPadding = (int)(16.0F * var4 + 0.5F);
      this.mFullUnderlineHeight = (int)(1.0F * var4 + 0.5F);
      this.mMinStripHeight = (int)(var4 * 32.0F + 0.5F);
   ...
   public boolean onTouchEvent(MotionEvent var1) {
      ...
      if (var2 != 0 && this.mIgnoreTap) {
         ...
         if (var2 != 0) {
            if (var2 != 1) {
               if (var2 == 2 && (Math.abs(var3 - this.mInitialMotionX) > (float)this.mTouchSlop || Math.abs(var4 - this.mInitialMotionY) > (float)this.mTouchSlop)) {
   ...
   public void setPadding(int var1, int var2, int var3, int var4) {
      int var5 = this.mMinPaddingBottom;
      int var6 = var4;
      if (var4 < var5) {
         var6 = var5;
      }

      super.setPadding(var1, var2, var3, var6);
   }
   ...
   public void setTextSpacing(int var1) {
      int var2 = this.mMinTextSpacing;
      int var3 = var1;
      if (var1 < var2) {
         var3 = var2;
      }

      super.setTextSpacing(var3);
   }
