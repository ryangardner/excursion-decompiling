...
public class ViewModelProvider {
   ...
   public <T extends ViewModel> T get(Class<T> var1) {
   ...
   public <T extends ViewModel> T get(String var1, Class<T> var2) {
      ...
      if (var2.isInstance(var3)) {
         ...
         if (var6 instanceof ViewModelProvider.KeyedFactory) {
            var5 = ((ViewModelProvider.KeyedFactory)var6).create(var1, var2);
         } else {
      ...
      public <T extends ViewModel> T create(Class<T> var1) {
         if (AndroidViewModel.class.isAssignableFrom(var1)) {
            ...
            try {
               ...
               var2.append("Cannot create an instance of ");
               var2.append(var1);
               throw new RuntimeException(var2.toString(), var7);
            }
         } else {
   ...
   public interface Factory {
      <T extends ViewModel> T create(Class<T> var1);
   }
