...
public abstract class LiveData<T> {
   ...
   private void considerNotify(LiveData<T>.ObserverWrapper var1) {
      if (var1.mActive) {
   ...
   void dispatchingValue(LiveData<T>.ObserverWrapper var1) {
   ...
   public void observe(LifecycleOwner var1, Observer<? super T> var2) {
   ...
   public void observeForever(Observer<? super T> var1) {
   ...
   protected void postValue(T var1) {
   ...
   private class AlwaysActiveObserver extends LiveData<T>.ObserverWrapper {
      AlwaysActiveObserver(Observer<? super T> var2) {
         super(var2);
      }
   ...
   class LifecycleBoundObserver extends LiveData<T>.ObserverWrapper implements LifecycleEventObserver {
      ...
      LifecycleBoundObserver(LifecycleOwner var2, Observer<? super T> var3) {
         super(var3);
         this.mOwner = var2;
      }
   ...
   private abstract class ObserverWrapper {
      ...
      ObserverWrapper(Observer<? super T> var2) {
         this.mObserver = var2;
      }
