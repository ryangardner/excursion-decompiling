...
public class ActivityOptionsCompat {
   ...
   public static ActivityOptionsCompat makeSceneTransitionAnimation(Activity var0, Pair<View, String>... var1) {
      if (VERSION.SDK_INT < 21) {
         return new ActivityOptionsCompat();
      } else {
         android.util.Pair[] var2 = null;
         if (var1 != null) {
            android.util.Pair[] var3 = new android.util.Pair[var1.length];
            int var4 = 0;
            ...
            while(true) {
               ...
               var3[var4] = android.util.Pair.create(var1[var4].first, var1[var4].second);
               ++var4;
            }
         }

         return new ActivityOptionsCompat.ActivityOptionsCompatImpl(ActivityOptions.makeSceneTransitionAnimation(var0, var2));
      }
   }
