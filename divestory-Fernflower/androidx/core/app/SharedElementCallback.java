...
public abstract class SharedElementCallback {
   ...
   private static Bitmap createDrawableBitmap(Drawable var0) {
      ...
      if (var1 > 0 && var2 > 0) {
         float var3 = Math.min(1.0F, 1048576.0F / (float)(var1 * var2));
         if (var0 instanceof BitmapDrawable && var3 == 1.0F) {
            ...
            var0.draw(var6);
            var0.setBounds(var8, var2, var9, var10);
            return var5;
         }
      } else {
         return null;
   ...
   public Parcelable onCaptureSharedElementSnapshot(View var1, Matrix var2, RectF var3) {
      ...
      if (var7 > 0) {
         var14 = var5;
         if (var8 > 0) {
            float var9 = Math.min(1.0F, 1048576.0F / (float)(var7 * var8));
   ...
   public void onSharedElementsArrived(List<String> var1, List<View> var2, SharedElementCallback.OnSharedElementsReadyListener var3) {
