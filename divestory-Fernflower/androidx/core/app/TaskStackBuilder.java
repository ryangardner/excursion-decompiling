...
public final class TaskStackBuilder implements Iterable<Intent> {
   ...
   public TaskStackBuilder addNextIntentWithParentStack(Intent var1) {
      ...
      if (var2 == null) {
         var3 = var1.resolveActivity(this.mSourceContext.getPackageManager());
      }

      if (var3 != null) {
         this.addParentStack(var3);
      }
   ...
   public Intent[] getIntents() {
      ...
      if (var1 == 0) {
         ...
         for(int var3 = 1; var3 < var1; ++var3) {
            var2[var3] = new Intent((Intent)this.mIntents.get(var3));
         }
