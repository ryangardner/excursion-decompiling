...
public abstract class JobIntentService extends Service {
   ...
   static JobIntentService.WorkEnqueuer getWorkEnqueuer(Context var0, ComponentName var1, boolean var2, int var3) {
      JobIntentService.WorkEnqueuer var4 = (JobIntentService.WorkEnqueuer)sClassWorkEnqueuer.get(var1);
      Object var5 = var4;
      if (var4 == null) {
         Object var6;
         if (VERSION.SDK_INT >= 26) {
   ...
   public int onStartCommand(Intent var1, int var2, int var3) {
      if (this.mCompatQueue != null) {
         ...
         label197: {
            ArrayList var5;
            JobIntentService.CompatWorkItem var6;
            try {
               var5 = this.mCompatQueue;
               var6 = new JobIntentService.CompatWorkItem;
   ...
   static final class JobServiceEngineImpl extends JobServiceEngine implements JobIntentService.CompatJobEngine {
      ...
      public JobIntentService.GenericWorkItem dequeueWork() {
         ...
         label153: {
            ...
            JobWorkItem var15;
            try {
               var15 = this.mParams.dequeueWork();
            } catch (Throwable var13) {
               var10000 = var13;
               var10001 = false;
               break label153;
            ...
            if (var15 != null) {
               var15.getIntent().setExtrasClassLoader(this.mService.getClassLoader());
               return new JobIntentService.JobServiceEngineImpl.WrapperWorkItem(var15);
            }
