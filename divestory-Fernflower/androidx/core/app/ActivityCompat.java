...
public class ActivityCompat extends ContextCompat {
   ...
   public static Uri getReferrer(Activity var0) {
      if (VERSION.SDK_INT >= 22) {
         ...
         Uri var2 = (Uri)var1.getParcelableExtra("android.intent.extra.REFERRER");
         if (var2 != null) {
            return var2;
         } else {
            String var3 = var1.getStringExtra("android.intent.extra.REFERRER_NAME");
   ...
   public static <T extends View> T requireViewById(Activity var0, int var1) {
      if (VERSION.SDK_INT >= 28) {
   ...
   private static class SharedElementCallback21Impl extends android.app.SharedElementCallback {
      ...
      public void onSharedElementsArrived(List<String> var1, List<View> var2, final OnSharedElementsReadyListener var3) {
