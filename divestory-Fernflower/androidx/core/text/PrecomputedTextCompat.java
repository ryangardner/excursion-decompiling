...
public class PrecomputedTextCompat implements Spannable {
      ...
      label962: {
         ...
         label954: {
            try {
               ...
               var96 = new PrecomputedTextCompat(PrecomputedText.create(var0, var1.mWrapped), var1);
         ...
         try {
            var96 = new PrecomputedTextCompat(var0, var1, var5);
   ...
   public static Future<PrecomputedTextCompat> getTextFuture(CharSequence var0, PrecomputedTextCompat.Params var1, Executor var2) {
   ...
   public int getParagraphStart(int var1) {
      int var2 = this.getParagraphCount();
      byte var3 = 0;
      Preconditions.checkArgumentInRange(var1, 0, var2, "paraIndex");
      if (VERSION.SDK_INT >= 29) {
