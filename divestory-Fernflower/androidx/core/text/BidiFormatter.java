   ...
   private static class DirectionalityEstimator {
      ...
      private byte skipEntityBackward() {
         ...
         do {
            ...
            --var2;
            this.charIndex = var2;
            var4 = var3.charAt(var2);
            this.lastChar = (char)var4;
            if (var4 == '&') {
               return 12;
            }
         } while(var4 != ';');
      ...
      byte dirTypeBackward() {
         char var1 = this.text.charAt(this.charIndex - 1);
         this.lastChar = var1;
         if (Character.isLowSurrogate(var1)) {
            int var6 = Character.codePointBefore(this.text, this.charIndex);
            this.charIndex -= Character.charCount(var6);
            return Character.getDirectionality(var6);
         } else {
            --this.charIndex;
            byte var3 = getCachedDirectionality(this.lastChar);
            byte var4 = var3;
            if (this.isHtml) {
               char var2 = this.lastChar;
               byte var5;
               if (var2 == '>') {
                  var5 = this.skipTagBackward();
                  var4 = var5;
               } else {
                  var4 = var3;
                  if (var2 == ';') {
                     var5 = this.skipEntityBackward();
                     var4 = var5;
                  }
               }
            }
      ...
      byte dirTypeForward() {
         char var1 = this.text.charAt(this.charIndex);
         this.lastChar = var1;
         if (Character.isHighSurrogate(var1)) {
            ...
            if (this.isHtml) {
               ...
               if (var4 == '<') {
                  var2 = this.skipTagForward();
                  var3 = var2;
               } else {
                  var3 = var2;
                  if (var4 == '&') {
                     var2 = this.skipEntityForward();
                     var3 = var2;
                  }
               }
            }
