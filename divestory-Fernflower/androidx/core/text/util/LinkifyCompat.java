...
public final class LinkifyCompat {
   private static final Comparator<LinkifyCompat.LinkSpec> COMPARATOR = new Comparator<LinkifyCompat.LinkSpec>() {
      public int compare(LinkifyCompat.LinkSpec var1, LinkifyCompat.LinkSpec var2) {
   ...
   public static void addLinks(TextView var0, Pattern var1, String var2, MatchFilter var3, TransformFilter var4) {
      if (shouldAddLinksFallbackToFramework()) {
   ...
   public static void addLinks(TextView var0, Pattern var1, String var2, String[] var3, MatchFilter var4, TransformFilter var5) {
      if (shouldAddLinksFallbackToFramework()) {
   ...
   public static boolean addLinks(Spannable var0, Pattern var1, String var2) {
      return shouldAddLinksFallbackToFramework() ? Linkify.addLinks(var0, var1, var2) : addLinks((Spannable)var0, var1, var2, (String[])null, (MatchFilter)null, (TransformFilter)null);
   }

   public static boolean addLinks(Spannable var0, Pattern var1, String var2, MatchFilter var3, TransformFilter var4) {
   ...
   public static boolean addLinks(Spannable var0, Pattern var1, String var2, String[] var3, MatchFilter var4, TransformFilter var5) {
      if (shouldAddLinksFallbackToFramework()) {
         ...
         while(var12.find()) {
            ...
            boolean var11;
            if (var4 != null) {
               var11 = var4.acceptMatch(var0, var8, var10);
            } else {
               var11 = true;
            }

            if (var11) {
               applyLink(makeUrl(var12.group(0), var7, var12, var5), var8, var10, var0);
               var9 = true;
            }
         }
   ...
   private static void gatherLinks(ArrayList<LinkifyCompat.LinkSpec> var0, Spannable var1, Pattern var2, String[] var3, MatchFilter var4, TransformFilter var5) {
   ...
   private static void gatherMapLinks(ArrayList<LinkifyCompat.LinkSpec> param0, Spannable param1) {
      // $FF: Couldn't be decompiled
   }

   private static String makeUrl(String var0, String[] var1, Matcher var2, TransformFilter var3) {
      String var4 = var0;
      if (var3 != null) {
   ...
   private static void pruneOverlaps(ArrayList<LinkifyCompat.LinkSpec> var0, Spannable var1) {
