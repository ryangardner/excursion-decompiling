      ...
      public boolean onTouchEvent(MotionEvent var1) {
         ...
         if (var3 != 0) {
            if (var3 != 1) {
                  ...
                  if (var3 != 3) {
                     if (var3 != 5) {
                        if (var3 != 6) {
                           ...
                           var8 = this.mVelocityTracker.getXVelocity(var2);
                           var9 = this.mVelocityTracker.getYVelocity(var2);
                           var2 = 0;
                           ...
                           while(true) {
                              ...
                              if (var2 != var5) {
                                 ...
                                 if (this.mVelocityTracker.getXVelocity(var7) * var8 + this.mVelocityTracker.getYVelocity(var7) * var9 < 0.0F) {
               ...
               var5 = (int)(var8 - this.mDownFocusX);
               var2 = (int)(var11 - this.mDownFocusY);
               var2 = var5 * var5 + var2 * var2;
                  ...
                  label180: {
                     if (this.mInLongPress) {
                        ...
                        if (Math.abs(var8) > (float)this.mMinimumFlingVelocity || Math.abs(var9) > (float)this.mMinimumFlingVelocity) {
                           var12 = this.mListener.onFling(this.mCurrentDownEvent, var1, var9, var8);
                           break label180;
                        }
                     }
