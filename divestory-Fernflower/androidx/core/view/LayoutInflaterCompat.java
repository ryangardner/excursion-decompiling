...
public final class LayoutInflaterCompat {
   ...
   public static void setFactory(LayoutInflater var0, LayoutInflaterFactory var1) {
      ...
      Object var3 = null;
      LayoutInflaterCompat.Factory2Wrapper var4 = null;
      if (var2 >= 21) {
         if (var1 != null) {
            var4 = new LayoutInflaterCompat.Factory2Wrapper(var1);
         }

         var0.setFactory2(var4);
      } else {
         var4 = (LayoutInflaterCompat.Factory2Wrapper)var3;
         if (var1 != null) {
            var4 = new LayoutInflaterCompat.Factory2Wrapper(var1);
         }
