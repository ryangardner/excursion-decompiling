...
public final class EditorInfoCompat {
   ...
   public static String[] getContentMimeTypes(EditorInfo var0) {
      if (VERSION.SDK_INT >= 25) {
         ...
         String[] var1 = var0.extras.getStringArray("androidx.core.view.inputmethod.EditorInfoCompat.CONTENT_MIME_TYPES");
         String[] var2 = var1;
         if (var1 == null) {
            var2 = var0.extras.getStringArray("android.support.v13.view.inputmethod.EditorInfoCompat.CONTENT_MIME_TYPES");
         }

         if (var2 == null) {
            var2 = EMPTY_STRING_ARRAY;
         }
