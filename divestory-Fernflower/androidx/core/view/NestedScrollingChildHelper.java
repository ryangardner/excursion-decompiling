...
public class NestedScrollingChildHelper {
   ...
   private boolean dispatchNestedScrollInternal(int var1, int var2, int var3, int var4, int[] var5, int var6, int[] var7) {
      if (this.isNestedScrollingEnabled()) {
         ViewParent var8 = this.getNestedScrollingParentForType(var6);
         if (var8 == null) {
            return false;
         }
         ...
         if (var1 != 0 || var2 != 0 || var3 != 0 || var4 != 0) {
            ...
            ViewParentCompat.onNestedScroll(var8, this.mView, var1, var2, var3, var4, var6, var7);
            if (var5 != null) {
               this.mView.getLocationInWindow(var5);
               var5[0] -= var9;
               var5[1] -= var10;
   ...
   public boolean dispatchNestedPreScroll(int var1, int var2, int[] var3, int[] var4, int var5) {
      boolean var6 = this.isNestedScrollingEnabled();
      boolean var7 = false;
      boolean var8 = var7;
      if (var6) {
         ...
         if (var1 == 0 && var2 == 0) {
            ...
            int[] var12 = var3;
            if (var3 == null) {
               var12 = this.getTempNestedScrollConsumed();
            }

            var12[0] = 0;
            var12[1] = 0;
            ViewParentCompat.onNestedPreScroll(var9, this.mView, var1, var2, var12, var5);
            if (var4 != null) {
               this.mView.getLocationInWindow(var4);
               var4[0] -= var10;
               var4[1] -= var11;
