...
public class FileProvider extends ContentProvider {
   ...
   public Cursor query(Uri var1, String[] var2, String var3, String[] var4, String var5) {
      File var14 = this.mStrategy.getFileForUri(var1);
      String[] var10 = var2;
      if (var2 == null) {
         var10 = COLUMNS;
      }
      ...
      String[] var15 = copyOf(var4, var8);
      Object[] var12 = copyOf(var11, var8);
      ...
      void addRoot(String var1, File var2) {
         if (!TextUtils.isEmpty(var1)) {
            ...
            try {
               ...
               var5.append("Failed to resolve canonical path for ");
               var5.append(var2);
