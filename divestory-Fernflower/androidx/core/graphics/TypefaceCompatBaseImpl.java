...
class TypefaceCompatBaseImpl {
   ...
   private FontResourcesParserCompat.FontFileResourceEntry findBestEntry(FontResourcesParserCompat.FontFamilyFilesResourceEntry var1, int var2) {
      return (FontResourcesParserCompat.FontFileResourceEntry)findBestFont(var1.getEntries(), var2, new TypefaceCompatBaseImpl.StyleExtractor<FontResourcesParserCompat.FontFileResourceEntry>() {
   ...
   private static <T> T findBestFont(T[] var0, int var1, TypefaceCompatBaseImpl.StyleExtractor<T> var2) {
      short var3;
      if ((var1 & 1) == 0) {
         var3 = 400;
      } else {
      ...
      int var11;
      for(var1 = 0; var1 < var7; var6 = var11) {
   ...
   protected FontsContractCompat.FontInfo findBestInfo(FontsContractCompat.FontInfo[] var1, int var2) {
      return (FontsContractCompat.FontInfo)findBestFont(var1, var2, new TypefaceCompatBaseImpl.StyleExtractor<FontsContractCompat.FontInfo>() {
