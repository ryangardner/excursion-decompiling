...
public final class DrawableCompat {
      ...
      if (VERSION.SDK_INT >= 23) {
         ...
         if (VERSION.SDK_INT >= 17) {
            ...
            if (!sGetLayoutDirectionMethodFetched) {
               try {
                  var1 = Drawable.class.getDeclaredMethod("getLayoutDirection");
                  sGetLayoutDirectionMethod = var1;
            ...
            var1 = sGetLayoutDirectionMethod;
            if (var1 != null) {
               try {
   ...
   public static <T extends Drawable> T unwrap(Drawable var0) {
      Drawable var1 = var0;
      if (var0 instanceof WrappedDrawable) {
         var1 = ((WrappedDrawable)var0).getWrappedDrawable();
      }
