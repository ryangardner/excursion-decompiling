   ...
   public void draw(Canvas var1) {
      ...
      if (var2 != null) {
         ...
         if (this.mPaint.getShader() == null) {
            ...
            var1.drawRoundRect(var4, var3, var3, this.mPaint);
         }
   ...
   void updateDstRect() {
      if (this.mApplyGravity) {
         if (this.mIsCircular) {
            ...
            int var2 = Math.min(this.mDstRect.width(), this.mDstRect.height());
            int var3 = Math.max(0, (this.mDstRect.width() - var2) / 2);
            var1 = Math.max(0, (this.mDstRect.height() - var2) / 2);
            this.mDstRect.inset(var3, var1);
            this.mCornerRadius = (float)var2 * 0.5F;
         } else {
