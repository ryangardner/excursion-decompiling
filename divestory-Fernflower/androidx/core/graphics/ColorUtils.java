...
public final class ColorUtils {
   ...
   public static void LABToXYZ(double var0, double var2, double var4, double[] var6) {
      ...
      if (var4 <= 0.008856D) {
         var4 = (var11 * 116.0D - 16.0D) / 903.3D;
      }
   ...
   public static void RGBToHSL(int var0, int var1, int var2, float[] var3) {
      ...
      if (var7 == var8) {
         ...
         if (var7 == var4) {
            ...
            var8 = 4.0F + (var4 - var5) / var9;
         }

         var4 = var9 / (1.0F - Math.abs(2.0F * var10 - 1.0F));
         var9 = var8;
         var8 = var4;
      }

      var4 = var9 * 60.0F % 360.0F;
      var9 = var4;
      if (var4 < 0.0F) {
         var9 = var4 + 360.0F;
      }

      var3[0] = constrain(var9, 0.0F, 360.0F);
      var3[1] = constrain(var8, 0.0F, 1.0F);
   ...
   public static Color compositeColors(Color var0, Color var1) {
      if (!Objects.equals(var0.getModel(), var1.getModel())) {
         ...
         float[] var2 = var0.getComponents();
         float[] var3 = var1.getComponents();
         float var4 = var0.alpha();
         float var5 = var1.alpha() * (1.0F - var4);
         int var6 = var1.getComponentCount() - 1;
         var3[var6] = var4 + var5;
         float var7 = var5;
         float var8 = var4;
         if (var3[var6] > 0.0F) {
         ...
         for(int var9 = 0; var9 < var6; ++var9) {
            var3[var9] = var2[var9] * var8 + var3[var9] * var7;
         }

         return Color.valueOf(var3, var1.getColorSpace());
      }
   }
