   ...
   public CardView(Context var1, AttributeSet var2, int var3) {
      ...
      this.mCardViewDelegate = new CardViewDelegate() {
         ...
         public void setShadowPadding(int var1, int var2, int var3, int var4) {
            ...
            var5.setPadding(var1 + var5.mContentPadding.left, var2 + CardView.this.mContentPadding.top, var3 + CardView.this.mContentPadding.right, var4 + CardView.this.mContentPadding.bottom);
         }
      };
