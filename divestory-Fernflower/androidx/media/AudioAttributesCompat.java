   ...
   public static class Builder {
      ...
      public AudioAttributesCompat build() {
         ...
         if (!AudioAttributesCompat.sForceLegacyBehavior && VERSION.SDK_INT >= 21) {
            ...
            if (var2 != -1) {
               var3.setLegacyStreamType(var2);
            }

            var1 = new AudioAttributesImplApi21(var3.build(), this.mLegacyStream);
         } else {
            var1 = new AudioAttributesImplBase(this.mContentType, this.mFlags, this.mUsage, this.mLegacyStream);
         }

         return new AudioAttributesCompat((AudioAttributesImpl)var1);
      }
