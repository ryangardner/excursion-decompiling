...
public abstract class MediaBrowserServiceCompat extends Service {
   ...
   public void onCustomAction(String var1, Bundle var2, MediaBrowserServiceCompat.Result<Bundle> var3) {
   ...
   public abstract void onLoadChildren(String var1, MediaBrowserServiceCompat.Result<List<MediaBrowserCompat.MediaItem>> var2);

   public void onLoadChildren(String var1, MediaBrowserServiceCompat.Result<List<MediaBrowserCompat.MediaItem>> var2, Bundle var3) {
      var2.setFlags(1);
   ...
   public void onSearch(String var1, Bundle var2, MediaBrowserServiceCompat.Result<List<MediaBrowserCompat.MediaItem>> var3) {
      var3.setFlags(4);
   ...
   void performCustomAction(String var1, Bundle var2, MediaBrowserServiceCompat.ConnectionRecord var3, final ResultReceiver var4) {
      MediaBrowserServiceCompat.Result var6 = new MediaBrowserServiceCompat.Result<Bundle>(var1) {
   ...
   void performLoadChildren(final String var1, final MediaBrowserServiceCompat.ConnectionRecord var2, final Bundle var3, final Bundle var4) {
      MediaBrowserServiceCompat.Result var6 = new MediaBrowserServiceCompat.Result<List<MediaBrowserCompat.MediaItem>>(var1) {
         void onResultSent(List<MediaBrowserCompat.MediaItem> var1x) {
            StringBuilder var4x;
            if (MediaBrowserServiceCompat.this.mConnections.get(var2.callbacks.asBinder()) != var2) {
               if (MediaBrowserServiceCompat.DEBUG) {
                  var4x = new StringBuilder();
                  var4x.append("Not sending onLoadChildren result for connection that has been disconnected. pkg=");
                  var4x.append(var2.pkg);
                  var4x.append(" id=");
                  var4x.append(var1);
                  Log.d("MBServiceCompat", var4x.toString());
               }
               ...
               try {
                  var2.callbacks.onLoadChildren(var1, var2x, var3, var4);
               } catch (RemoteException var3x) {
                  var4x = new StringBuilder();
                  var4x.append("Calling onLoadChildren() failed for id=");
                  var4x.append(var1);
                  var4x.append(" package=");
                  var4x.append(var2.pkg);
                  Log.w("MBServiceCompat", var4x.toString());
               }
   ...
   void performLoadItem(String var1, MediaBrowserServiceCompat.ConnectionRecord var2, final ResultReceiver var3) {
      MediaBrowserServiceCompat.Result var5 = new MediaBrowserServiceCompat.Result<MediaBrowserCompat.MediaItem>(var1) {
   ...
   void performSearch(String var1, Bundle var2, MediaBrowserServiceCompat.ConnectionRecord var3, final ResultReceiver var4) {
      MediaBrowserServiceCompat.Result var6 = new MediaBrowserServiceCompat.Result<List<MediaBrowserCompat.MediaItem>>(var1) {
         void onResultSent(List<MediaBrowserCompat.MediaItem> var1) {
   ...
   boolean removeSubscription(String var1, MediaBrowserServiceCompat.ConnectionRecord var2, IBinder var3) {
      ...
      if (var3 == null) {
         ...
         label377: {
            List var7;
            try {
               var7 = (List)var2.subscriptions.get(var1);
               ...
               label378: {
                  ...
                  while(true) {
                     try {
                        ...
                        } while(var3 != ((Pair)var8.next()).first);
   ...
   class MediaBrowserServiceImplApi21 implements MediaBrowserServiceCompat.MediaBrowserServiceImpl, MediaBrowserServiceCompatApi21.ServiceCompatProxy {
         ...
         if (var4 != null) {
            ...
            while(var5.hasNext()) {
               ...
               if (MediaBrowserCompatUtils.hasDuplicatedItems(var3, (Bundle)var6.second)) {
                  MediaBrowserServiceCompat.this.performLoadChildren(var2, var1, (Bundle)var6.second, var3);
               }
            }
         }
      ...
      public MediaBrowserServiceCompatApi21.BrowserRoot onGetRoot(String var1, int var2, Bundle var3) {
         ...
         MediaBrowserServiceCompat.this.mCurConnection = MediaBrowserServiceCompat.this.new ConnectionRecord(var1, -1, var2, var3, (MediaBrowserServiceCompat.ServiceCallbacks)null);
      ...
      public void onLoadChildren(String var1, final MediaBrowserServiceCompatApi21.ResultWrapper<List<Parcel>> var2) {
         MediaBrowserServiceCompat.Result var3 = new MediaBrowserServiceCompat.Result<List<MediaBrowserCompat.MediaItem>>(var1) {
            public void detach() {
               var2.detach();
            }
   ...
   class MediaBrowserServiceImplApi23 extends MediaBrowserServiceCompat.MediaBrowserServiceImplApi21 implements MediaBrowserServiceCompatApi23.ServiceCompatProxy {
      ...
      public void onLoadItem(String var1, final MediaBrowserServiceCompatApi21.ResultWrapper<Parcel> var2) {
         MediaBrowserServiceCompat.Result var3 = new MediaBrowserServiceCompat.Result<MediaBrowserCompat.MediaItem>(var1) {
            public void detach() {
               var2.detach();
            }
   ...
   class MediaBrowserServiceImplApi26 extends MediaBrowserServiceCompat.MediaBrowserServiceImplApi23 implements MediaBrowserServiceCompatApi26.ServiceCompatProxy {
      ...
      public void onLoadChildren(String var1, final MediaBrowserServiceCompatApi26.ResultWrapper var2, Bundle var3) {
         MediaBrowserServiceCompat.Result var4 = new MediaBrowserServiceCompat.Result<List<MediaBrowserCompat.MediaItem>>(var1) {
            public void detach() {
               var2.detach();
            }
   ...
   private interface ServiceCallbacks {
      ...
      void onLoadChildren(String var1, List<MediaBrowserCompat.MediaItem> var2, Bundle var3, Bundle var4) throws RemoteException;
   }
