...
public abstract class WakefulBroadcastReceiver extends BroadcastReceiver {
   ...
   public static ComponentName startWakefulService(Context var0, Intent var1) {
      ...
      label324: {
         ...
         ComponentName var51;
         try {
            var1.putExtra("androidx.contentpager.content.wakelockid", var3);
         ...
         if (var51 == null) {
            ...
            try {
               ...
               var49.append("androidx.core:wake:");
               var49.append(var51.flattenToShortString());
               WakeLock var50 = var5.newWakeLock(1, var49.toString());
               var50.setReferenceCounted(false);
               var50.acquire(60000L);
               sActiveWakeLocks.put(var3, var50);
               return var51;
