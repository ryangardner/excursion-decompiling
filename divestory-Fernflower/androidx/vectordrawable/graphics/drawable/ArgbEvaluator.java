...
public class ArgbEvaluator implements TypeEvaluator {
   ...
   public Object evaluate(float var1, Object var2, Object var3) {
      ...
      var12 = (float)Math.pow((double)(var8 + var1 * (var12 - var8)), 0.45454545454545453D);
      var4 = Math.round((var5 + (var9 - var5) * var1) * 255.0F);
      return Math.round(var6 * 255.0F) << 16 | var4 << 24 | Math.round(var7 * 255.0F) << 8 | Math.round(var12 * 255.0F);
   }
}
