...
public class AnimationUtilsCompat {
   ...
   private static Interpolator createInterpolatorFromXml(Context var0, Resources var1, Theme var2, XmlPullParser var3) throws XmlPullParserException, IOException {
      ...
      while(true) {
         ...
         if (var5 == 2) {
            AttributeSet var9 = Xml.asAttributeSet(var3);
            ...
            if (var8.equals("linearInterpolator")) {
               ...
               var7 = new AccelerateInterpolator(var0, var9);
            } else if (var8.equals("decelerateInterpolator")) {
               var7 = new DecelerateInterpolator(var0, var9);
               ...
               var7 = new CycleInterpolator(var0, var9);
            } else if (var8.equals("anticipateInterpolator")) {
               var7 = new AnticipateInterpolator(var0, var9);
            } else if (var8.equals("overshootInterpolator")) {
               var7 = new OvershootInterpolator(var0, var9);
            } else if (var8.equals("anticipateOvershootInterpolator")) {
               var7 = new AnticipateOvershootInterpolator(var0, var9);
               ...
               var7 = new PathInterpolatorCompat(var0, var9, var3);
            }
         }
      }
   }
