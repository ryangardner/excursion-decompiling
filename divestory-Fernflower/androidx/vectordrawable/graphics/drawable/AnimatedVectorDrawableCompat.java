...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
         ...
         for(int var6 = var2.getDepth(); var5 != 1 && (var2.getDepth() >= var6 + 1 || var5 != 3); var5 = var2.next()) {
            if (var5 == 2) {
               ...
               if ("animated-vector".equals(var7)) {
                  ...
                  TypedArray var11 = var1.obtainAttributes(var3, AndroidResources.STYLEABLE_ANIMATED_VECTOR_DRAWABLE_TARGET);
                  String var9 = var11.getString(0);
                  var5 = var11.getResourceId(1, 0);
                  if (var5 != 0) {
                     ...
                     this.setupAnimatorsForTarget(var9, AnimatorInflaterCompat.loadAnimator(var12, var5));
                  }
   ...
   public boolean unregisterAnimationCallback(Animatable2Compat.AnimationCallback var1) {
      ...
      ArrayList var2 = this.mAnimationCallbacks;
