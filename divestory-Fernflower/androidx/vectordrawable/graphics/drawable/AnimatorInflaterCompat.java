...
public class AnimatorInflaterCompat {
      ...
      while(true) {
         ...
         if (var11 == 3 && var3.getDepth() <= var8 || var11 == 1) {
            if (var5 != null && var10 != null) {
               ...
               for(int var21 = var12; var18.hasNext(); ++var21) {
                  var17[var21] = (Animator)var18.next();
               }
         ...
         if (var11 == 2) {
            ...
            if (var14.equals("objectAnimator")) {
               var22 = loadObjectAnimator(var0, var1, var2, var4, var7, var3);
            } else if (var14.equals("animator")) {
               var22 = loadAnimator(var0, var1, var2, var4, (ValueAnimator)null, var7, var3);
            } else if (var14.equals("set")) {
               var22 = new AnimatorSet();
               TypedArray var19 = TypedArrayUtils.obtainAttributes(var1, var2, var4, AndroidResources.STYLEABLE_ANIMATOR_SET);
               int var20 = TypedArrayUtils.getNamedInt(var19, var3, "ordering", 0, 0);
               createAnimatorFromXml(var0, var1, var2, var3, var4, (AnimatorSet)var22, var20, var7);
               var19.recycle();
            } else {
               ...
               PropertyValuesHolder[] var23 = loadValues(var0, var1, var2, var3, Xml.asAttributeSet(var3));
               if (var23 != null && var9 instanceof ValueAnimator) {
                  ((ValueAnimator)var9).setValues(var23);
               }
   ...
   private static void dumpKeyframes(Object[] var0, String var1) {
      if (var0 != null && var0.length != 0) {
         ...
         for(int var3 = 0; var3 < var2; ++var3) {
            ...
            float var6 = var4.getFraction();
            String var7 = "null";
            Object var8;
            if (var6 < 0.0F) {
               var8 = "null";
            } else {
               var8 = var4.getFraction();
            }
   ...
   private static void setupObjectAnimator(ValueAnimator var0, TypedArray var1, int var2, float var3, XmlPullParser var4) {
      ...
      if (var7 != null) {
         ...
         setupPathMotion(PathParser.createPathFromPathData(var7), var5, var3 * 0.5F, var6, var9);
      } else {
   ...
   private static void setupPathMotion(Path var0, ObjectAnimator var1, float var2, String var3, String var4) {
      ...
      float var9;
      do {
         var9 = var8 + var5.getLength();
         var6.add(var9);
         var8 = var9;
      } while(var5.nextContour());

      PathMeasure var18 = new PathMeasure(var0, false);
      int var10 = Math.min(100, (int)(var9 / var2) + 1);
      float[] var11 = new float[var10];
      float[] var12 = new float[var10];
      float[] var13 = new float[2];
      var8 = var9 / (float)(var10 - 1);
      int var14 = 0;
      int var15 = 0;
      var2 = var7;
      ...
      while(true) {
         ...
         if (var14 >= var10) {
            ...
            if (var3 != null) {
               var19 = PropertyValuesHolder.ofFloat(var3, var11);
            } else {
               var19 = null;
            }

            PropertyValuesHolder var20 = var5;
            if (var4 != null) {
               var20 = PropertyValuesHolder.ofFloat(var4, var12);
            }
         ...
         var18.getPosTan(var2 - (Float)var6.get(var15), var13, (float[])null);
         var11[var14] = var13[0];
         var12[var14] = var13[1];
         var2 += var8;
         int var16 = var15 + 1;
