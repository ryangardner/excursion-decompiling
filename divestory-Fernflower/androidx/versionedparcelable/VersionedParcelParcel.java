...
class VersionedParcelParcel extends VersionedParcel {
   ...
   private VersionedParcelParcel(Parcel var1, int var2, int var3, String var4, ArrayMap<String, Method> var5, ArrayMap<String, Method> var6, ArrayMap<String, Class> var7) {
   ...
   public void closeField() {
      ...
      if (var1 >= 0) {
         int var2 = this.mPositionLookup.get(var1);
         var1 = this.mParcel.dataPosition();
         this.mParcel.setDataPosition(var2);
         this.mParcel.writeInt(var1 - var2);
   ...
   protected VersionedParcel createSubParcel() {
      ...
      var5.append("  ");
      return new VersionedParcelParcel(var1, var2, var4, var5.toString(), this.mReadCache, this.mWriteCache, this.mParcelizerCache);
   }
