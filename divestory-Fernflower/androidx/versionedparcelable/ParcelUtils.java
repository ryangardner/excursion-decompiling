...
public class ParcelUtils {
   ...
   public static <T extends VersionedParcelable> T fromInputStream(InputStream var0) {
      return (new VersionedParcelStream(var0, (OutputStream)null)).readVersionedParcelable();
   }

   public static <T extends VersionedParcelable> T fromParcelable(Parcelable var0) {
   ...
   public static <T extends VersionedParcelable> T getVersionedParcelable(Bundle param0, String param1) {
      // $FF: Couldn't be decompiled
   }

   public static <T extends VersionedParcelable> List<T> getVersionedParcelableList(Bundle var0, String var1) {
   ...
   public static void putVersionedParcelableList(Bundle var0, String var1, List<? extends VersionedParcelable> var2) {
      Bundle var3 = new Bundle();
