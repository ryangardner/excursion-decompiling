   ...
   public void runPendingAnimations() {
      ...
      if (var1 || var2 || var4 || var3) {
         ...
         if (var2) {
            ...
            if (var1) {
               ViewCompat.postOnAnimationDelayed(((DefaultItemAnimator.MoveInfo)var13.get(0)).holder.itemView, var6, this.getRemoveDuration());
            } else {
               var6.run();
            }
         }
         ...
         if (var3) {
            ...
            if (var1) {
               ViewCompat.postOnAnimationDelayed(((DefaultItemAnimator.ChangeInfo)var13.get(0)).oldHolder.itemView, var6, this.getRemoveDuration());
            } else {
               var6.run();
            }
         }
         ...
         if (var4) {
            ...
            if (!var1 && !var2 && !var3) {
               ...
               ViewCompat.postOnAnimationDelayed(((RecyclerView.ViewHolder)var13.get(0)).itemView, var6, var9 + var11);
            }
         }
