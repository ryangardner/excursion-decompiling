...
final class GapWorker implements Runnable {
   ...
   private void buildTaskList() {
      ...
      int var7;
      for(var2 = 0; var3 < var1; var2 = var7) {
         RecyclerView var6 = (RecyclerView)this.mRecyclerViews.get(var3);
         if (var6.getWindowVisibility() != 0) {
            var7 = var2;
         } else {
            GapWorker.LayoutPrefetchRegistryImpl var8 = var6.mPrefetchRegistry;
            int var9 = Math.abs(var8.mPrefetchDx) + Math.abs(var8.mPrefetchDy);
            var5 = 0;

            while(true) {
               var7 = var2;
               if (var5 >= var8.mCount * 2) {
                  break;
               }
               ...
               var7 = var8.mPrefetchArray[var5 + 1];
               boolean var10;
               if (var7 <= var9) {
                  var10 = true;
               } else {
               ...
               var11.viewVelocity = var9;
               var11.distanceToItem = var7;
               var11.view = var6;
               var11.position = var8.mPrefetchArray[var5];
               ++var2;
               var5 += 2;
            }
         }
