...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
   ...
   public RecyclerView(Context var1, AttributeSet var2, int var3) {
      ...
      if (VERSION.SDK_INT >= 29) {
         this.saveAttributeDataForStyleable(var1, R.styleable.RecyclerView, var2, var9, var3, 0);
      }
      ...
      var6 = var9.getBoolean(R.styleable.RecyclerView_fastScrollEnabled, false);
      this.mEnableFastScroller = var6;
      if (var6) {
      ...
      var6 = var4;
      if (VERSION.SDK_INT >= 21) {
         var9 = var1.obtainStyledAttributes(var2, NESTED_SCROLLING_ATTRS, var3, 0);
         if (VERSION.SDK_INT >= 29) {
            this.saveAttributeDataForStyleable(var1, NESTED_SCROLLING_ATTRS, var2, var9, var3, 0);
         }

         var6 = var9.getBoolean(0, true);
         var9.recycle();
      }
   ...
   private void dispatchLayoutStep1() {
      ...
      if (this.mState.mRunSimpleAnimations) {
         ...
         for(var4 = 0; var4 < var3; ++var4) {
            ...
            if (!var9.shouldIgnore() && (!var9.isInvalid() || this.mAdapter.hasStableIds())) {
               RecyclerView.ItemAnimator.ItemHolderInfo var5 = this.mItemAnimator.recordPreLayoutInformation(this.mState, var9, RecyclerView.ItemAnimator.buildAdapterChangeFlagsForAnimations(var9), var9.getUnmodifiedPayloads());
               this.mViewInfoStore.addToPreLayout(var9, var5);
               if (this.mState.mTrackOldChangeHolders && var9.isUpdated() && !var9.isRemoved() && !var9.shouldIgnore() && !var9.isInvalid()) {
                  long var6 = this.getChangedHolderKey(var9);
                  this.mViewInfoStore.addToOldChangeHolders(var6, var9);
               }
            }
         }
      }
      ...
      if (this.mState.mRunPredictiveAnimations) {
         ...
         for(var4 = 0; var4 < this.mChildHelper.getChildCount(); ++var4) {
            RecyclerView.ViewHolder var11 = getChildViewHolderInt(this.mChildHelper.getChildAt(var4));
            if (!var11.shouldIgnore() && !this.mViewInfoStore.isInPreLayout(var11)) {
               int var8 = RecyclerView.ItemAnimator.buildAdapterChangeFlagsForAnimations(var11);
               var2 = var11.hasAnyOfTheFlags(8192);
               var3 = var8;
               if (!var2) {
                  var3 = var8 | 4096;
               }

               RecyclerView.ItemAnimator.ItemHolderInfo var10 = this.mItemAnimator.recordPreLayoutInformation(this.mState, var11, var3, var11.getUnmodifiedPayloads());
               if (var2) {
                  this.recordAnimationInfoIfBouncedHiddenView(var11, var10);
               } else {
                  this.mViewInfoStore.addToAppearedInPreLayoutHolders(var11, var10);
               }
            }
         }
      ...
      if (this.mPreserveFocusAfterLayout && this.mAdapter != null && this.hasFocus() && this.getDescendantFocusability() != 393216 && (this.getDescendantFocusability() != 131072 || !this.isFocused())) {
         ...
         if (var1 != null) {
            ...
            if ((long)this.mState.mFocusedSubChildId != -1L) {
               View var5 = var1.findViewById(this.mState.mFocusedSubChildId);
               var4 = var1;
               if (var5 != null) {
                  var4 = var1;
                  if (var5.isFocusable()) {
   ...
   public void draw(Canvas var1) {
      ...
      if (var5 != null) {
         ...
         if (!var5.isFinished()) {
            ...
            var1.rotate(90.0F);
            var1.translate((float)(-var2), (float)(-var8));
            var5 = this.mRightGlow;
            if (var5 != null && var5.draw(var1)) {
               var9 = true;
            } else {
   ...
   public View focusSearch(View var1, int var2) {
      ...
      if (var3 != null) {
         ...
         boolean var4 = true;
         boolean var5;
         if (var8 != null && this.mLayout != null && !this.isComputingLayout() && !this.mLayoutSuppressed) {
            var5 = true;
         } else {
            var5 = false;
         }
         ...
         if (var5 && (var2 == 2 || var2 == 1)) {
            ...
            if (this.mLayout.canScrollVertically()) {
               ...
               if (var9.findNextFocus(this, var1, var6) == null) {
                  var7 = true;
               } else {
                  var7 = false;
               }
            ...
            if (!var5) {
               ...
               if (this.mLayout.canScrollHorizontally()) {
                  ...
                  if (var9.findNextFocus(this, var1, var12) == null) {
                     var11 = var4;
                  } else {
                     var11 = false;
                  }
            ...
            var3 = var9.findNextFocus(this, var1, var10);
            var2 = var10;
         } else {
            var3 = var9.findNextFocus(this, var1, var2);
            if (var3 == null && var5) {
               this.consumePendingUpdateOperations();
               if (this.findContainingItemView(var1) == null) {
                  return null;
   ...
   void offsetPositionRecordsForMove(int var1, int var2) {
      ...
      for(int var7 = 0; var7 < var3; ++var7) {
         ...
         if (var8 != null && var8.mPosition >= var5 && var8.mPosition <= var6) {
      ...
      if (ALLOW_THREAD_GAP_WORK) {
         ...
         if (var6 == null) {
            ...
            if (!this.isInEditMode()) {
               var4 = var3;
               if (var7 != null) {
                  float var5 = var7.getRefreshRate();
                  var4 = var3;
                  if (var5 >= 30.0F) {
                     var4 = var5;
                  }
                  ...
                  if (var6 != 1) {
                     if (var6 != 2) {
                        ...
                        if (this.mScrollState != 1) {
                           ...
                           boolean var13;
                           if (var2 && Math.abs(var7 - var6) > this.mTouchSlop) {
               ...
               if (var6 != 0) {
                  if (var6 != 1) {
                     if (var6 != 2) {
                        ...
                        int var10 = (int)(var1.getX(var7) + 0.5F);
                        int var11 = (int)(var1.getY(var7) + 0.5F);
                        var7 = this.mLastTouchX - var10;
                        int var22 = this.mLastTouchY - var11;
                        int var12 = var7;
                        var6 = var22;
                        int var13;
                        if (this.mScrollState != 1) {
                           ...
                           label140: {
                              ...
                              if (var5) {
                                 if (var7 > 0) {
                                    ...
                                    var7 = Math.min(0, var7 + this.mTouchSlop);
                                 }
                           ...
                           if (var2) {
                              if (var22 > 0) {
                                 var12 = Math.max(0, var22 - this.mTouchSlop);
                              } else {
                                 var12 = Math.min(0, var22 + this.mTouchSlop);
                              }
                        ...
                        if (this.mScrollState == 1) {
                           ...
                           var6 = var12;
                           var7 = var13;
                           if (this.dispatchNestedPreScroll(var22, var24, this.mReusableIntPair, this.mScrollOffset, 0)) {
                              var8 = this.mReusableIntPair;
                              var6 = var12 - var8[0];
                              var7 = var13 - var8[1];
                              var8 = this.mNestedOffsets;
                              var13 = var8[0];
                              int[] var15 = this.mScrollOffset;
                              var8[0] = var13 + var15[0];
                              var8[1] += var15[1];
                              this.getParent().requestDisallowInterceptTouchEvent(true);
                           }

                           var8 = this.mScrollOffset;
                           this.mLastTouchX = var10 - var8[0];
                           this.mLastTouchY = var11 - var8[1];
                           if (var5) {
                              var13 = var6;
                           } else {
                              var13 = 0;
                           ...
                           if (this.scrollByInternal(var13, var12, var1)) {
                              this.getParent().requestDisallowInterceptTouchEvent(true);
                           }
                           ...
                           if (this.mGapWorker != null) {
                              label127: {
                                 ...
                                 this.mGapWorker.postFromTraversal(this, var6, var7);
                                 var9 = var3;
                              }
                           }
                        }
   ...
   boolean scrollByInternal(int var1, int var2, MotionEvent var3) {
      ...
      var16[0] = 0;
      var16[1] = 0;
      this.dispatchNestedScroll(var9, var8, var6, var7, this.mScrollOffset, 0, var16);
      var16 = this.mReusableIntPair;
      int var10 = var16[0];
      int var11 = var16[1];
      boolean var12;
      ...
      int var13 = this.mLastTouchX;
      var16 = this.mScrollOffset;
      this.mLastTouchX = var13 - var16[0];
   ...
   boolean shouldDeferAccessibilityEvent(AccessibilityEvent var1) {
      boolean var2 = this.isComputingLayout();
      byte var3 = 0;
      if (var2) {
         int var4;
         if (var1 != null) {
            var4 = AccessibilityEventCompat.getContentChangeTypes(var1);
         } else {
            var4 = 0;
         }
         ...
         this.mEatenAccessibilityChangeFlags |= var4;
         return true;
      } else {
         return false;
      }
   ...
   void smoothScrollBy(int var1, int var2, Interpolator var3, int var4, boolean var5) {
      ...
      if (var6 == null) {
         ...
         boolean var7 = var6.canScrollHorizontally();
         byte var8 = 0;
         int var9 = var1;
         if (!var7) {
            var9 = 0;
         ...
         if (var9 != 0 || var2 != 0) {
            ...
            if (var10) {
               if (var5) {
                  ...
                  this.startNestedScroll(var12, 1);
               }

               this.mViewFlinger.smoothScrollBy(var9, var2, var4, var3);
            } else {
               this.scrollBy(var9, var2);
            }
         }
   ...
   public abstract static class LayoutManager {
      ...
      private int[] getChildRectangleOnScreenScrollAmount(View var1, Rect var2) {
         ...
         var11 = var11 + var9 - (var5 - var6);
         var6 = Math.max(0, var11);
         var12 = Math.max(0, var12 + var10 - (var7 - var8));
         if (this.getLayoutDirection() == 1) {
            ...
            var3 = Math.min(var13, var6);
         }

         if (var4 == 0) {
            var4 = Math.min(var14, var12);
         }
      ...
      private boolean isFocusedChildVisibleAfterScrolling(RecyclerView var1, int var2, int var3) {
         ...
         if (var11 == null) {
            ...
            return var10.left - var2 < var6 - var7 && var10.right - var2 > var4 && var10.top - var3 < var8 - var9 && var10.bottom - var3 > var5;
         }
      }
      ...
      void setMeasuredDimensionFromChildren(int var1, int var2) {
         ...
         if (var3 == 0) {
            ...
            int var8;
            int var12;
            for(var8 = Integer.MAX_VALUE; var4 < var3; var8 = var12) {
            ...
            this.mRecyclerView.mTempRect.set(var7, var8, var5, var6);
   ...
   public static class RecycledViewPool {
      ...
      int size() {
         ...
         int var2;
         int var4;
         for(var2 = 0; var1 < this.mScrap.size(); var2 = var4) {
   ...
   public final class Recycler {
      ...
      private void attachAccessibilityDelegateOnBind(RecyclerView.ViewHolder var1) {
         if (RecyclerView.this.isAccessibilityEnabled()) {
            ...
            AccessibilityDelegateCompat var3 = RecyclerView.this.mAccessibilityDelegate.getItemDelegate();
            if (var3 instanceof RecyclerViewAccessibilityDelegate.ItemDelegate) {
               ((RecyclerViewAccessibilityDelegate.ItemDelegate)var3).saveOriginalDelegate(var2);
            }

            ViewCompat.setAccessibilityDelegate(var2, var3);
         }
      ...
      void addViewHolderToRecycledViewPool(RecyclerView.ViewHolder var1, boolean var2) {
         ...
         View var3 = var1.itemView;
         if (RecyclerView.this.mAccessibilityDelegate != null) {
            AccessibilityDelegateCompat var4 = RecyclerView.this.mAccessibilityDelegate.getItemDelegate();
            if (var4 instanceof RecyclerViewAccessibilityDelegate.ItemDelegate) {
               var4 = ((RecyclerViewAccessibilityDelegate.ItemDelegate)var4).getAndRemoveOriginalDelegateForItem(var3);
            } else {
               var4 = null;
            }

            ViewCompat.setAccessibilityDelegate(var3, var4);
         }
      ...
      public void bindViewToPosition(View var1, int var2) {
         ...
         if (var3 != null) {
            ...
            if (var4 >= 0 && var4 < RecyclerView.this.mAdapter.getItemCount()) {
               this.tryBindViewHolderByDeadline(var3, var4, var2, Long.MAX_VALUE);
               android.view.ViewGroup.LayoutParams var7 = var3.itemView.getLayoutParams();
               RecyclerView.LayoutParams var8;
               if (var7 == null) {
                  var8 = (RecyclerView.LayoutParams)RecyclerView.this.generateDefaultLayoutParams();
                  var3.itemView.setLayoutParams(var8);
               ...
               var8.mViewHolder = var3;
               if (var3.itemView.getParent() != null) {
                  var5 = false;
               }

               var8.mPendingInvalidate = var5;
            } else {
         ...
         for(int var7 = 0; var7 < var6; ++var7) {
            ...
            if (var8 != null && var8.mPosition >= var4 && var8.mPosition <= var5) {
               if (var8.mPosition == var1) {
                  ...
                  var8.offsetPosition(var3, false);
               }
            }
         }
                  ...
                  label80: {
                     label102: {
                        ...
                        if (this.mViewCacheMax > 0 && !var1.hasAnyOfTheFlags(526)) {
                           ...
                           this.mCachedViews.add(var9, var1);
                           var6 = true;
                        } else {
                           var6 = false;
                        }
         ...
         if (var1 >= 0 && var1 < RecyclerView.this.mState.getItemCount()) {
            ...
            label136: {
               ...
               if (var18 == null) {
                  ...
                  if (var18 == null) {
                     ...
                     var8 = var18;
                     if (var13 != null) {
                        View var25 = var13.getViewForPositionAndType(this, var1, var12);
                        var8 = var18;
                        if (var25 != null) {
                           var8 = RecyclerView.this.getChildViewHolder(var25);
                           if (var8 == null) {
                              var7 = new StringBuilder();
                  ...
                  var18 = var8;
                  if (var8 == null) {
                     var18 = this.getRecycledViewPool().getRecycledView(var12);
                     if (var18 != null) {
                        var18.resetInternal();
                        if (RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST) {
                           this.invalidateDisplayListInt(var18);
                        }
                     }
                  }
                  ...
                  if (var18 == null) {
                     ...
                     if (RecyclerView.ALLOW_THREAD_GAP_WORK) {
                        RecyclerView var20 = RecyclerView.findNestedRecyclerView(var8.itemView);
                        if (var20 != null) {
                           var8.mNestedRecyclerView = new WeakReference(var20);
                        }
                     }
            ...
            if (var9 && !RecyclerView.this.mState.isPreLayout() && var8.hasAnyOfTheFlags(8192)) {
               ...
               if (RecyclerView.this.mState.mRunSimpleAnimations) {
                  int var21 = RecyclerView.ItemAnimator.buildAdapterChangeFlagsForAnimations(var8);
                  RecyclerView.ItemAnimator.ItemHolderInfo var22 = RecyclerView.this.mItemAnimator.recordPreLayoutInformation(RecyclerView.this.mState, var8, var21 | 4096, var8.getUnmodifiedPayloads());
   ...
   class ViewFlinger implements Runnable {
      ...
      private int computeScrollDuration(int var1, int var2, int var3, int var4) {
         ...
         RecyclerView var8 = RecyclerView.this;
         if (var7) {
            var1 = var8.getWidth();
         } else {
            var1 = var8.getHeight();
         ...
         if (var3 > 0) {
            var1 = Math.round(Math.abs((var9 + var11 * var9) / (float)var3) * 1000.0F) * 4;
         } else {
            if (var7) {
               var1 = var5;
            } else {
            ...
            var1 = (int)(((float)var1 / var10 + 1.0F) * 300.0F);
         }
      ...
      public void run() {
         if (RecyclerView.this.mLayout == null) {
            ...
            RecyclerView.this.consumePendingUpdateOperations();
            OverScroller var1 = this.mOverScroller;
            if (var1.computeScrollOffset()) {
               int var2 = var1.getCurrX();
               int var3 = var1.getCurrY();
               ...
               var3 = var4;
               var2 = var5;
               if (var6.dispatchNestedPreScroll(var4, var5, var6.mReusableIntPair, (int[])null, 1)) {
                  var3 = var4 - RecyclerView.this.mReusableIntPair[0];
                  var2 = var5 - RecyclerView.this.mReusableIntPair[1];
               }
               ...
               int var7;
               int var8;
               RecyclerView.SmoothScroller var13;
               if (RecyclerView.this.mAdapter != null) {
                  RecyclerView.this.mReusableIntPair[0] = 0;
                  RecyclerView.this.mReusableIntPair[1] = 0;
                  var6 = RecyclerView.this;
                  var6.scrollStep(var3, var2, var6.mReusableIntPair);
                  var7 = RecyclerView.this.mReusableIntPair[0];
                  var8 = RecyclerView.this.mReusableIntPair[1];
                  int var9 = var3 - var7;
                  int var10 = var2 - var8;
                  var13 = RecyclerView.this.mLayout.mSmoothScroller;
                  var3 = var7;
                  var4 = var9;
                  var2 = var8;
                  var5 = var10;
                  if (var13 != null) {
                     ...
                     if (!var13.isPendingInitialRun()) {
                        ...
                        var5 = var10;
                        if (var13.isRunning()) {
                           var2 = RecyclerView.this.mState.getItemCount();
                           if (var2 == 0) {
                              var13.stop();
                              var3 = var7;
                              var4 = var9;
                              var2 = var8;
                              var5 = var10;
                           } else if (var13.getTargetPosition() >= var2) {
                              var13.setTargetPosition(var2 - 1);
                              var13.onAnimation(var7, var8);
                              var3 = var7;
                              var4 = var9;
                              var2 = var8;
                              var5 = var10;
               ...
               RecyclerView.this.mReusableIntPair[1] = 0;
               var6 = RecyclerView.this;
               var6.dispatchNestedScroll(var3, var2, var4, var5, (int[])null, 1, var6.mReusableIntPair);
               var7 = var4 - RecyclerView.this.mReusableIntPair[0];
               var8 = var5 - RecyclerView.this.mReusableIntPair[1];
               if (var3 != 0 || var2 != 0) {
                  RecyclerView.this.dispatchOnScrolled(var3, var2);
               }
               ...
               boolean var15;
               if (var1.getCurrX() == var1.getFinalX()) {
                  var15 = true;
               } else {
                  var15 = false;
               }
               ...
               boolean var14;
               if (var1.getCurrY() == var1.getFinalY()) {
                  var14 = true;
               } else {
                  var14 = false;
               }

               if (var1.isFinished() || (var15 || var7 != 0) && (var14 || var8 != 0)) {
                  var15 = true;
               } else {
                  var15 = false;
               }
               ...
               if (!var14 && var15) {
                  if (RecyclerView.this.getOverScrollMode() != 2) {
                     ...
                     RecyclerView.this.absorbGlows(var2, var3);
                  }
                  ...
                  if (RecyclerView.this.mGapWorker != null) {
                     RecyclerView.this.mGapWorker.postFromTraversal(RecyclerView.this, var3, var2);
                  }
               }
            }

            RecyclerView.SmoothScroller var11 = RecyclerView.this.mLayout.mSmoothScroller;
            if (var11 != null && var11.isPendingInitialRun()) {
               var11.onAnimation(0, 0);
            }
