...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
   ...
   private void applyPendingSavedState(StaggeredGridLayoutManager.AnchorInfo var1) {
      if (this.mPendingSavedState.mSpanOffsetsSize > 0) {
         if (this.mPendingSavedState.mSpanOffsetsSize == this.mSpanCount) {
            ...
            StaggeredGridLayoutManager.SavedState var5 = this.mPendingSavedState;
   ...
   private int fill(RecyclerView.Recycler var1, LayoutState var2, RecyclerView.State var3) {
      ...
      for(var6 = false; var2.hasMore(var3) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty()); var6 = true) {
         ...
         if (var10) {
            ...
            this.mLazySpanLookup.setSpan(var9, var11);
         } else {
            var11 = this.mSpans[var16];
         }
         ...
         this.measureChildWithDecorationsAndMargin(var7, var8, false);
         int var12;
         ...
         if (var2.mLayoutDirection == 1) {
            if (var8.mFullSpan) {
               ...
               var16 = var11.getEndLine(var5);
            }

            var12 = this.mPrimaryOrientation.getDecoratedMeasurement(var7);
            if (var10 && var8.mFullSpan) {
               var13 = this.createFullSpanItemFromEnd(var16);
               var13.mGapDir = -1;
               var13.mPosition = var9;
            ...
            if (var8.mFullSpan) {
               var16 = this.getMinStart(var5);
            } else {
               var16 = var11.getStartLine(var5);
            }

            var14 = var16 - this.mPrimaryOrientation.getDecoratedMeasurement(var7);
            if (var10 && var8.mFullSpan) {
               var13 = this.createFullSpanItemFromStart(var16);
               var13.mGapDir = 1;
               var13.mPosition = var9;
               this.mLazySpanLookup.addFullSpanItem(var13);
            }
         ...
         if (var8.mFullSpan && var2.mItemDirection == -1) {
            if (var10) {
               ...
               if (var15 ^ true) {
                  var13 = this.mLazySpanLookup.getFullSpanItem(var9);
                  if (var13 != null) {
         ...
         this.attachViewToSpans(var7, var8, var2);
         if (this.isLayoutRTL() && this.mOrientation == 1) {
            if (var8.mFullSpan) {
               var16 = this.mSecondaryOrientation.getEndAfterPadding();
            } else {
               var16 = this.mSecondaryOrientation.getEndAfterPadding() - (this.mSpanCount - 1 - var11.mIndex) * this.mSizePerSpan;
            }

            var9 = this.mSecondaryOrientation.getDecoratedMeasurement(var7);
            int var17 = var16;
            var16 -= var9;
            var9 = var17;
         } else {
            if (var8.mFullSpan) {
               ...
               var16 = var11.mIndex * this.mSizePerSpan + this.mSecondaryOrientation.getStartAfterPadding();
            }
         ...
         if (this.mOrientation == 1) {
            this.layoutDecoratedWithMargins(var7, var16, var14, var9, var12);
         } else {
            this.layoutDecoratedWithMargins(var7, var14, var16, var12, var9);
         }
         ...
         if (this.mLayoutState.mStopInFocusable && var7.hasFocusable()) {
            if (var8.mFullSpan) {
   ...
   private StaggeredGridLayoutManager.Span getNextSpan(LayoutState var1) {
      ...
      if (var6 == 1) {
         ...
         for(var9 = var4; var9 != var3; var6 = var4) {
            var7 = this.mSpans[var9];
            var10 = var7.getEndLine(var8);
            var4 = var6;
            if (var10 < var6) {
               var11 = var7;
               var4 = var10;
         ...
         var8 = this.mPrimaryOrientation.getEndAfterPadding();

         for(var11 = var7; var4 != var3; var6 = var9) {
            var7 = this.mSpans[var4];
            var10 = var7.getStartLine(var8);
            var9 = var6;
            if (var10 > var6) {
               var11 = var7;
               var9 = var10;
   ...
   private void onLayoutChildren(RecyclerView.Recycler var1, RecyclerView.State var2, boolean var3) {
      ...
      if ((this.mPendingSavedState != null || this.mPendingScrollPosition != -1) && var2.getItemCount() == 0) {
         ...
         if (this.getChildCount() > 0) {
            StaggeredGridLayoutManager.SavedState var8 = this.mPendingSavedState;
            if (var8 == null || var8.mSpanOffsetsSize < 1) {
               ...
               if (var4.mInvalidateOffsets) {
                  ...
                  for(var9 = 0; var9 < this.mSpanCount; ++var9) {
                     StaggeredGridLayoutManager.Span var10 = this.mSpans[var9];
                     var10.clear();
   ...
   private void repositionToWrapContentIfNecessary() {
      if (this.mSecondaryOrientation.getMode() != 1073741824) {
         ...
         for(var4 = 0; var4 < var2; ++var4) {
            ...
            if (var6 >= var1) {
               ...
               if (((StaggeredGridLayoutManager.LayoutParams)var5.getLayoutParams()).isFullSpan()) {
                  var7 = var6 * 1.0F / (float)this.mSpanCount;
               }
         ...
         int var9 = Math.round(var1 * (float)this.mSpanCount);
         var4 = var9;
   ...
   private void updateLayoutState(int var1, RecyclerView.State var2) {
      ...
      if (this.getClipToPadding()) {
         this.mLayoutState.mStartLine = this.mPrimaryOrientation.getStartAfterPadding() - var5;
         ...
         this.mLayoutState.mStartLine = -var5;
      }
   ...
   public void collectAdjacentPrefetchPositions(int var1, int var2, RecyclerView.State var3, RecyclerView.LayoutManager.LayoutPrefetchRegistry var4) {
      ...
      if (this.getChildCount() != 0 && var1 != 0) {
         ...
         int[] var5 = this.mPrefetchDistances;
         if (var5 == null || var5.length < this.mSpanCount) {
         ...
         int var8;
         for(var1 = 0; var2 < this.mSpanCount; var1 = var8) {
            int var7;
            if (this.mLayoutState.mItemDirection == -1) {
               var7 = this.mLayoutState.mStartLine;
               var8 = this.mSpans[var2].getStartLine(this.mLayoutState.mStartLine);
            } else {
               var7 = this.mSpans[var2].getEndLine(this.mLayoutState.mEndLine);
               var8 = this.mLayoutState.mEndLine;
            }

            var7 -= var8;
            var8 = var1;
            if (var7 >= 0) {
               this.mPrefetchDistances[var1] = var7;
               var8 = var1 + 1;
            }
         ...
         for(var2 = var6; var2 < var1 && this.mLayoutState.hasMore(var3); ++var2) {
            ...
            if (var1 != var5) {
               ...
               label71: {
                  label70: {
                     ...
                     int var10;
                     if (this.mShouldReverseLayout) {
                        var1 = this.mPrimaryOrientation.getDecoratedEnd(var7);
                        var10 = this.mPrimaryOrientation.getDecoratedEnd(var9);
                        if (var1 < var10) {
                           return var7;
                        }
      ...
      if (this.getChildCount() == 0) {
         ...
         if (var1 == null) {
            ...
            if (var5 == Integer.MIN_VALUE) {
               ...
               LayoutState var8 = this.mLayoutState;
               var8.mCurrentPosition = var8.mItemDirection + var2;
   ...
   public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler var1, RecyclerView.State var2, View var3, AccessibilityNodeInfoCompat var4) {
      ...
      if (!(var7 instanceof StaggeredGridLayoutManager.LayoutParams)) {
         ...
         int var6;
         if (this.mOrientation == 0) {
            var5 = var8.getSpanIndex();
            if (var8.mFullSpan) {
               var6 = this.mSpanCount;
            } else {
               var6 = 1;
            }

            var4.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(var5, var6, -1, -1, false, false));
         } else {
            var5 = var8.getSpanIndex();
            if (var8.mFullSpan) {
               var6 = this.mSpanCount;
            ...
            var4.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(-1, -1, var5, var6, false, false));
         }
            ...
            if (var5 >= 0 && var5 < var1.getItemCount()) {
               ...
               if (var6 != null && var6.mAnchorPosition != -1 && this.mPendingSavedState.mSpanOffsetsSize >= 1) {
                  ...
                  if (var7 != null) {
                     ...
                     var5 = this.mPrimaryOrientation.getDecoratedStart(var7) - this.mPrimaryOrientation.getStartAfterPadding();
                     if (var5 < 0) {
                        var2.mOffset = -var5;
                        return true;
                     }

                     var5 = this.mPrimaryOrientation.getEndAfterPadding() - this.mPrimaryOrientation.getDecoratedEnd(var7);
                     if (var5 < 0) {
                        var2.mOffset = var5;
                        return true;
                     }
                     ...
                     var2.mPosition = this.mPendingScrollPosition;
                     var5 = this.mPendingScrollPositionOffset;
                     if (var5 == Integer.MIN_VALUE) {
                        ...
                        var2.assignCoordinateFromPadding(var5);
                     }
   ...
   class AnchorInfo {
      ...
      void saveSpanReferenceLines(StaggeredGridLayoutManager.Span[] var1) {
         ...
         int[] var3 = this.mSpanReferenceLines;
         if (var3 == null || var3.length < var2) {
            this.mSpanReferenceLines = new int[StaggeredGridLayoutManager.this.mSpans.length];
         }

         for(int var4 = 0; var4 < var2; ++var4) {
            this.mSpanReferenceLines[var4] = var1[var4].getStartLine(Integer.MIN_VALUE);
         }
   ...
   static class LazySpanLookup {
      ...
      private void offsetFullSpansForAddition(int var1, int var2) {
         ...
         if (var3 != null) {
            for(int var4 = var3.size() - 1; var4 >= 0; --var4) {
               StaggeredGridLayoutManager.LazySpanLookup.FullSpanItem var5 = (StaggeredGridLayoutManager.LazySpanLookup.FullSpanItem)this.mFullSpanItems.get(var4);
      ...
      int forceInvalidateAfter(int var1) {
         List var2 = this.mFullSpanItems;
         if (var2 != null) {
            for(int var3 = var2.size() - 1; var3 >= 0; --var3) {
               if (((StaggeredGridLayoutManager.LazySpanLookup.FullSpanItem)this.mFullSpanItems.get(var3)).mPosition >= var1) {
                  this.mFullSpanItems.remove(var3);
               }
            }
         }
      ...
      public StaggeredGridLayoutManager.LazySpanLookup.FullSpanItem getFirstFullSpanItemInRange(int var1, int var2, int var3, boolean var4) {
         ...
         if (var5 == null) {
            ...
            for(int var7 = 0; var7 < var6; ++var7) {
               StaggeredGridLayoutManager.LazySpanLookup.FullSpanItem var8 = (StaggeredGridLayoutManager.LazySpanLookup.FullSpanItem)this.mFullSpanItems.get(var7);
      ...
      int invalidateAfter(int var1) {
         ...
         if (var2 == null) {
            ...
            int var3 = this.invalidateFullSpansAfter(var1);
            if (var3 == -1) {
               var2 = this.mData;
               Arrays.fill(var2, var1, var2.length, -1);
               return this.mData.length;
            } else {
               var2 = this.mData;
               ++var3;
               Arrays.fill(var2, var1, var3, -1);
               return var3;
            }
         }
      }
      ...
      void offsetForAddition(int var1, int var2) {
         ...
         if (var3 != null && var1 < var3.length) {
            int var4 = var1 + var2;
            this.ensureSize(var4);
            var3 = this.mData;
            System.arraycopy(var3, var1, var3, var4, var3.length - var1 - var2);
            Arrays.fill(this.mData, var1, var4, -1);
      ...
      void offsetForRemoval(int var1, int var2) {
         ...
         if (var3 != null && var1 < var3.length) {
            ...
            this.ensureSize(var4);
            var3 = this.mData;
            System.arraycopy(var3, var4, var3, var1, var3.length - var1 - var2);
            var3 = this.mData;
   ...
   public static class SavedState implements Parcelable {
      ...
      SavedState(Parcel var1) {
         ...
         this.mAnchorLayoutFromEnd = var5;
         var5 = var4;
         if (var1.readInt() == 1) {
            var5 = true;
         }

         this.mLastLayoutRTL = var5;
