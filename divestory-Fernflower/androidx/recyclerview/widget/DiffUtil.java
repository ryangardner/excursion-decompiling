...
public class DiffUtil {
   ...
   public static DiffUtil.DiffResult calculateDiff(DiffUtil.Callback var0, boolean var1) {
      ...
      var3 = var2 + var3 + Math.abs(var2 - var3);
      var2 = var3 * 2;
      ...
      while(!var5.isEmpty()) {
         ...
         DiffUtil.Snake var10 = diffPartial(var0, var9.oldListStart, var9.oldListEnd, var9.newListStart, var9.newListEnd, var6, var7, var3);
         if (var10 != null) {
            if (var10.size > 0) {
               var4.add(var10);
            }
   ...
   private static DiffUtil.Snake diffPartial(DiffUtil.Callback var0, int var1, int var2, int var3, int var4, int[] var5, int[] var6, int var7) {
      ...
      if (var2 >= 1 && var8 >= 1) {
         int var9 = var2 - var8;
         int var10 = (var2 + var8 + 1) / 2;
         int var11 = var7 - var10 - 1;
         var4 = var7 + var10 + 1;
         Arrays.fill(var5, var11, var4, 0);
         Arrays.fill(var6, var11 + var9, var4 + var9, var2);
         boolean var19;
         if (var9 % 2 != 0) {
            var19 = true;
         } else {
               ...
               label132: {
                  if (var14 != var13) {
                     label131: {
                        if (var14 != var12) {
                           var4 = var7 + var14;
                           if (var5[var4 - 1] < var5[var4 + 1]) {
                              break label131;
                           }
                        }

                        var4 = var5[var7 + var14 - 1] + 1;
                        var15 = true;
                        break label132;
                     }
                  }

                  var4 = var5[var7 + var14 + 1];
                  var15 = false;
               }

               for(var16 = var4 - var14; var4 < var2 && var16 < var8 && var0.areItemsTheSame(var1 + var4, var3 + var16); ++var16) {
                  ++var4;
               }
               ...
               label103: {
                  label102: {
                     ...
                     if (var17 != var12 + var9) {
                        ...
                        var4 = var7 + var17;
                        if (var6[var4 - 1] >= var6[var4 + 1]) {
                           break label102;
                        }
                     }

                     var4 = var6[var7 + var17 - 1];
                     var15 = false;
                     break label103;
                  }

                  var4 = var6[var7 + var17 + 1] - 1;
                  var15 = true;
               }

               for(var16 = var4 - var17; var4 > 0 && var16 > 0 && var0.areItemsTheSame(var1 + var4 - 1, var3 + var16 - 1); --var16) {
                  --var4;
               }
   ...
   public static class DiffResult {
            ...
            if (var4) {
               ...
               while(var2 >= var9 + var10) {
                  if (this.mCallback.areItemsTheSame(var2, var6)) {
                     ...
                     this.mOldItemStatuses[var2] = var6 << 5 | var7;
                     return true;
                  }
               ...
               for(var2 = var5 - 1; var2 >= var11 + var12; --var2) {
                  if (this.mCallback.areItemsTheSame(var6, var2)) {
                     ...
                     int[] var13 = this.mOldItemStatuses;
                     --var1;
                     var13[var1] = var2 << 5 | 16;
                     this.mNewItemStatuses[var2] = var1 << 5 | var7;
                     return true;
                  }
               }
            }
      ...
      private void findMatchingItems() {
         ...
         for(int var3 = this.mSnakes.size() - 1; var3 >= 0; --var3) {
            ...
            for(var2 = 0; var2 < var4.size; ++var2) {
               ...
               var9 = var4.y + var2;
               byte var10;
               if (this.mCallback.areContentsTheSame(var8, var9)) {
                  var10 = 1;
               } else {
                  var10 = 2;
               }

               this.mOldItemStatuses[var8] = var9 << 5 | var10;
               this.mNewItemStatuses[var9] = var8 << 5 | var10;
            }
      ...
      public void dispatchUpdatesTo(ListUpdateCallback var1) {
         ...
         while(var5 >= 0) {
            ...
            for(var3 = var7 - 1; var3 >= 0; --var3) {
               if ((this.mOldItemStatuses[var6.x + var3] & 31) == 2) {
                  var10.onChanged(var6.x + var3, 1, this.mCallback.getChangePayload(var6.x + var3, var6.y + var3));
               }
            }
   ...
   public abstract static class ItemCallback<T> {
      ...
      public Object getChangePayload(T var1, T var2) {
         return null;
      }
   }
