...
public class SparseArrayCompat<E> implements Cloneable {
   ...
   public void append(int var1, E var2) {
      ...
      if (var3 != 0 && var1 <= this.mKeys[var3 - 1]) {
         ...
         if (var4 >= this.mKeys.length) {
            var3 = ContainerHelpers.idealIntArraySize(var4 + 1);
   ...
   public void put(int var1, E var2) {
      ...
      if (var3 >= 0) {
         ...
         if (var8 - var3 != 0) {
            ...
            var5 = this.mValues;
            System.arraycopy(var5, var3, var5, var4, this.mSize - var3);
         }
   ...
   public void putAll(SparseArrayCompat<? extends E> var1) {
      int var2 = var1.size();
   ...
   public E putIfAbsent(int var1, E var2) {
   ...
   public boolean replace(int var1, E var2, E var3) {
      var1 = this.indexOfKey(var1);
      if (var1 >= 0) {
