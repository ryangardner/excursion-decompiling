...
public final class ArraySet<E> implements Collection<E>, Set<E> {
   ...
   public ArraySet(ArraySet<E> var1) {
      this();
      if (var1 != null) {
         this.addAll(var1);
      }
   ...
   public void addAll(ArraySet<? extends E> var1) {
      int var2 = var1.mSize;
   ...
   public boolean removeAll(ArraySet<? extends E> var1) {
      int var2 = var1.mSize;
      int var3 = this.mSize;
      boolean var4 = false;
   ...
   public E removeAt(int var1) {
      ...
      if (var4 <= 1) {
         ...
         if (var5 > 8 && var4 < var8.length / 3) {
            ...
            if (var1 < var4) {
               var6 = var1 + 1;
               System.arraycopy(var8, var6, this.mHashes, var1, var4 - var1);
               System.arraycopy(var7, var6, this.mArray, var1, this.mSize - var1);
            }
         } else {
            var6 = this.mSize - 1;
            this.mSize = var6;
