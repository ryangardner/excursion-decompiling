...
public final class AppCompatResources {
   ...
   private static void addColorStateListToCache(Context var0, int var1, ColorStateList var2) {
      ...
      label176: {
         ...
         if (var4 == null) {
            try {
               ...
               sColorStateCaches.put(var0, var5);
         ...
         label165:
         try {
            AppCompatResources.ColorStateListCacheEntry var27 = new AppCompatResources.ColorStateListCacheEntry(var2, var0.getResources().getConfiguration());
            var5.append(var1, var27);
            return;
   ...
   private static ColorStateList getCachedColorStateList(Context var0, int var1) {
   ...
   private static ColorStateList inflateColorStateList(Context var0, int var1) {
      if (isColorInt(var0, var1)) {
         ...
         try {
            ColorStateList var5 = ColorStateListInflaterCompat.createFromXml(var2, var3, var0.getTheme());
            return var5;
   ...
   private static boolean isColorInt(Context var0, int var1) {
      Resources var2 = var0.getResources();
      TypedValue var4 = getTypedValue();
      boolean var3 = true;
      var2.getValue(var1, var4, true);
