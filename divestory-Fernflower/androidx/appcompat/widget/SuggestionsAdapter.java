...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
   ...
   private Drawable getDefaultIcon1() {
      ...
      return var1 != null ? var1 : this.mContext.getPackageManager().getDefaultActivityIcon();
   }
   ...
   Drawable getDrawableFromResourceUri(Uri var1) throws FileNotFoundException {
      ...
      if (!TextUtils.isEmpty(var2)) {
         Resources var8;
         try {
            var8 = this.mContext.getPackageManager().getResourcesForApplication(var2);
         } catch (NameNotFoundException var7) {
            var3 = new StringBuilder();
            var3.append("No package found for authority: ");
            var3.append(var1);
         ...
         if (var4 != null) {
            ...
            if (var5 == 1) {
               try {
                  ...
                  var3 = new StringBuilder();
                  var3.append("Single path segment is not a resource ID: ");
                  var3.append(var1);
                  throw new FileNotFoundException(var3.toString());
               }
            } else {
               if (var5 != 2) {
                  var3 = new StringBuilder();
                  var3.append("More than two path segments: ");
                  var3.append(var1);
                  throw new FileNotFoundException(var3.toString());
               }

               var5 = var8.getIdentifier((String)var4.get(1), (String)var4.get(0), var2);
            }

            if (var5 != 0) {
               return var8.getDrawable(var5);
            } else {
               var3 = new StringBuilder();
               var3.append("No resource found for: ");
               var3.append(var1);
               throw new FileNotFoundException(var3.toString());
            }
         } else {
