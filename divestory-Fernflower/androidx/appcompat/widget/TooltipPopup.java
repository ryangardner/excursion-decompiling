...
class TooltipPopup {
   ...
   TooltipPopup(Context var1) {
      this.mContext = var1;
      View var2 = LayoutInflater.from(var1).inflate(R.layout.abc_tooltip, (ViewGroup)null);
      this.mContentView = var2;
      this.mMessageView = (TextView)var2.findViewById(R.id.message);
   ...
   private void computePosition(View var1, int var2, int var3, boolean var4, LayoutParams var5) {
      ...
      if (var12 == null) {
         ...
         var14[0] = var7 - var11[0];
         var14[1] -= var11[1];
         var5.x = var14[0] + var2 - var12.getWidth() / 2;
