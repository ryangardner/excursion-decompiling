...
public class AppCompatTextView extends TextView implements TintableBackgroundView, TintableCompoundDrawablesView, AutoSizeableTextView {
   ...
   public void setCompoundDrawablesRelativeWithIntrinsicBounds(int var1, int var2, int var3, int var4) {
      ...
      Drawable var7;
      if (var1 != 0) {
         var7 = AppCompatResources.getDrawable(var5, var1);
      } else {
         var7 = null;
      }
      ...
      Drawable var8;
      if (var2 != 0) {
         var8 = AppCompatResources.getDrawable(var5, var2);
      } else {
         var8 = null;
      }
      ...
      Drawable var9;
      if (var3 != 0) {
         var9 = AppCompatResources.getDrawable(var5, var3);
      } else {
         var9 = null;
      }

      if (var4 != 0) {
         var6 = AppCompatResources.getDrawable(var5, var4);
      }

      this.setCompoundDrawablesRelativeWithIntrinsicBounds(var7, var8, var9, var6);
   ...
   public void setCompoundDrawablesWithIntrinsicBounds(int var1, int var2, int var3, int var4) {
      ...
      this.setCompoundDrawablesWithIntrinsicBounds(var7, var8, var9, var6);
      AppCompatTextHelper var10 = this.mTextHelper;
      if (var10 != null) {
         var10.onSetCompoundDrawables();
      }
   ...
   public void setTextFuture(Future<PrecomputedTextCompat> var1) {
