...
public class AlertDialogLayout extends LinearLayoutCompat {
   ...
   private boolean tryOnMeasure(int var1, int var2) {
      ...
      if (var5 != null) {
         var5.measure(var1, 0);
         var7 = resolveMinimumHeight(var5);
         var14 = var5.getMeasuredHeight() - var7;
         var13 += var7;
         var9 = View.combineMeasuredStates(var9, var5.getMeasuredState());
      } else {
         var7 = 0;
         var14 = 0;
      }
      ...
      if (var5 != null) {
         ...
         var5.measure(var1, MeasureSpec.makeMeasureSpec(var15, 1073741824));
         var15 = var13 - var7 + var5.getMeasuredHeight();
         var7 = View.combineMeasuredStates(var9, var5.getMeasuredState());
         var18 = var11;
         var11 = var7;
      }
      ...
      for(var11 = 0; var15 < var3; var11 = var13) {
         var8 = this.getChildAt(var15);
         var13 = var11;
         if (var8.getVisibility() != 8) {
            var13 = Math.max(var11, var8.getMeasuredWidth());
         }

         ++var15;
      }

      this.setMeasuredDimension(View.resolveSizeAndState(var11 + this.getPaddingLeft() + this.getPaddingRight(), var1, var9), View.resolveSizeAndState(var7, var2, 0));
      if (var12 != 1073741824) {
            ...
            if (var13.getVisibility() != 8) {
               ...
               label48: {
                  ...
                  if (var5 != 1) {
                     ...
                     var16 = var7 - var8 - var14;
                     var5 = var17.rightMargin;
                  } else {
                     var16 = (var7 - var6 - var9 - var14) / 2 + var6 + var17.leftMargin;
                     var5 = var17.rightMargin;
                  }
