...
public class ToolbarWidgetWrapper implements DecorToolbar {
   ...
   public int getDropdownSelectedPosition() {
      ...
      int var2;
      if (var1 != null) {
         var2 = var1.getSelectedItemPosition();
      } else {
         var2 = 0;
      }
         ...
         if (var2 != 1) {
            if (var2 == 2) {
               ...
               if (var3 != null) {
                  ...
                  Toolbar var5 = this.mToolbar;
                  if (var4 == var5) {
                     var5.removeView(this.mTabView);
                  }
               }
            }
         } else {
            ...
            if (var6 != null) {
               ViewParent var7 = var6.getParent();
               Toolbar var8 = this.mToolbar;
               if (var7 == var8) {
                  var8.removeView(this.mSpinner);
               }
            }
         }
         ...
         if (var1 != 0) {
            if (var1 != 1) {
               if (var1 != 2) {
                  ...
                  var10.append("Invalid navigation mode ");
                  var10.append(var1);
