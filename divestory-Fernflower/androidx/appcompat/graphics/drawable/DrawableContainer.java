...
class DrawableContainer extends Drawable implements Callback {
   ...
   private boolean needsMirroring() {
      ...
      boolean var2 = true;
      if (!var1 || DrawableCompat.getLayoutDirection(this) != 1) {
         var2 = false;
      }
   ...
   void animate(boolean var1) {
      ...
      label33: {
         ...
         if (var5 != null) {
            ...
            if (var6 != 0L) {
               if (var6 > var3) {
                  var8 = (int)((var6 - var3) * 255L) / this.mDrawableContainerState.mEnterFadeDuration;
                  this.mCurrDrawable.setAlpha((255 - var8) * this.mAlpha / 255);
                  var9 = true;
                  break label33;
               }
      ...
      if (var5 != null) {
         ...
         if (var6 != 0L) {
            if (var6 <= var3) {
               ...
               var8 = (int)((var6 - var3) * 255L) / this.mDrawableContainerState.mExitFadeDuration;
               this.mLastDrawable.setAlpha(var8 * this.mAlpha / 255);
               var9 = var2;
            }
         }
      } else {
   ...
   abstract static class DrawableContainerState extends ConstantState {
      ...
      DrawableContainerState(DrawableContainer.DrawableContainerState var1, DrawableContainer var2, Resources var3) {
         ...
         var5 = DrawableContainer.resolveDensity(var3, var5);
         this.mDensity = var5;
         if (var1 != null) {
      ...
      public final Rect getConstantPadding() {
         boolean var1 = this.mVariablePadding;
         Rect var2 = null;
         if (var1) {
            return null;
            ...
            Rect var7;
            for(int var6 = 0; var6 < var4; var2 = var7) {
               var7 = var2;
               if (var5[var6].getPadding(var3)) {
                  Rect var8 = var2;
                  if (var2 == null) {
                     var8 = new Rect(0, 0, 0, 0);
                  }

                  if (var3.left > var8.left) {
                     var8.left = var3.left;
                  }

                  if (var3.top > var8.top) {
                     var8.top = var3.top;
                  }

                  if (var3.right > var8.right) {
                     var8.right = var3.right;
                  }

                  var7 = var8;
                  if (var3.bottom > var8.bottom) {
                     var8.bottom = var3.bottom;
                     var7 = var8;
                  }
               }
