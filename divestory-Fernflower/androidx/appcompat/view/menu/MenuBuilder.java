...
public class MenuBuilder implements SupportMenu {
   ...
   public boolean collapseItemActionView(MenuItemImpl var1) {
      ...
      if (!var2) {
         if (this.mExpandedItem != var1) {
            ...
            this.stopDispatchingItemsChanged();
            Iterator var6 = this.mPresenters.iterator();
            var5 = var4;
            ...
            while(true) {
               ...
               MenuPresenter var8 = (MenuPresenter)var7.get();
               if (var8 == null) {
                  this.mPresenters.remove(var7);
               } else {
                  var4 = var8.collapseItemActionView(this, var1);
                  var5 = var4;
                  if (var4) {
                     break;
                  }
   ...
   boolean dispatchMenuItemSelected(MenuBuilder var1, MenuItem var2) {
      ...
      boolean var4;
      if (var3 != null && var3.onMenuItemSelected(var1, var2)) {
         var4 = true;
      } else {
         var4 = false;
      }
