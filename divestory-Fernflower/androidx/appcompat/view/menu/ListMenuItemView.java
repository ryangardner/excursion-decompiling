...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, SelectionBoundsAdjuster {
   ...
   private void insertCheckBox() {
      CheckBox var1 = (CheckBox)this.getInflater().inflate(R.layout.abc_list_menu_item_checkbox, this, false);
      this.mCheckBox = var1;
      this.addContentView(var1);
   }

   private void insertIconView() {
      ImageView var1 = (ImageView)this.getInflater().inflate(R.layout.abc_list_menu_item_icon, this, false);
      this.mIconView = var1;
      this.addContentView(var1, 0);
   }

   private void insertRadioButton() {
      RadioButton var1 = (RadioButton)this.getInflater().inflate(R.layout.abc_list_menu_item_radio, this, false);
   ...
   protected void onFinishInflate() {
      ...
      TextView var1 = (TextView)this.findViewById(R.id.title);
      this.mTitleView = var1;
      int var2 = this.mTextAppearance;
      if (var2 != -1) {
         var1.setTextAppearance(this.mTextAppearanceContext, var2);
      }

      this.mShortcutView = (TextView)this.findViewById(R.id.shortcut);
      ImageView var3 = (ImageView)this.findViewById(R.id.submenuarrow);
