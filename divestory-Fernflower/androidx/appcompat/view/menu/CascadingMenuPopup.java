...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
   ...
   private void showMenu(MenuBuilder var1) {
      ...
      if (var14 == null && this.mShowTitle && var1.getHeaderTitle() != null) {
         FrameLayout var12 = (FrameLayout)var2.inflate(R.layout.abc_popup_menu_header_item_layout, var17, false);
         TextView var15 = (TextView)var12.findViewById(16908310);
         var12.setEnabled(false);
         var15.setText(var1.getHeaderTitle());
         var17.addHeaderView(var12, (Object)null, false);
         var5.show();
      }
   ...
   public void show() {
      if (!this.isShowing()) {
         ...
         if (var3 != null) {
            ...
            ViewTreeObserver var4 = this.mShownAnchorView.getViewTreeObserver();
