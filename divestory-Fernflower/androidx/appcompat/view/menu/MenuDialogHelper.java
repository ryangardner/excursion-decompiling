...
class MenuDialogHelper implements OnKeyListener, OnClickListener, OnDismissListener, MenuPresenter.Callback {
   ...
   public void show(IBinder var1) {
      ...
      ListMenuPresenter var4 = new ListMenuPresenter(var3.getContext(), R.layout.abc_list_menu_item_layout);
      this.mPresenter = var4;
      var4.setCallback(this);
      this.mMenu.addMenuPresenter(this.mPresenter);
      var3.setAdapter(this.mPresenter.getAdapter(), this);
      View var7 = var2.getHeaderView();
      if (var7 != null) {
         var3.setCustomTitle(var7);
      } else {
      ...
      LayoutParams var6 = this.mDialog.getWindow().getAttributes();
      var6.type = 1003;
      if (var1 != null) {
         var6.token = var1;
      }
