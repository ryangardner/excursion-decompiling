...
public class SupportActionModeWrapper extends android.view.ActionMode {
   ...
   public static class CallbackWrapper implements ActionMode.Callback {
      ...
      private Menu getMenuWrapper(Menu var1) {
         Menu var2 = (Menu)this.mMenus.get(var1);
         Object var3 = var2;
         if (var2 == null) {
            var3 = new MenuWrapperICS(this.mContext, (SupportMenu)var1);
            this.mMenus.put(var1, var3);
         }
      ...
      public android.view.ActionMode getActionModeWrapper(ActionMode var1) {
         int var2 = this.mActionModes.size();

         for(int var3 = 0; var3 < var2; ++var3) {
            SupportActionModeWrapper var4 = (SupportActionModeWrapper)this.mActionModes.get(var3);
