...
public class AppCompatViewInflater {
   ...
   private View createViewByPrefix(Context var1, String var2, String var3) throws ClassNotFoundException, InflateException {
      ...
      if (var4 == null) {
         ...
         try {
            var5 = Class.forName(var3, false, var1.getClassLoader()).asSubclass(View.class).getConstructor(sConstructorSignature);
      ...
      try {
         ...
         View var9 = (View)var5.newInstance(this.mConstructorArgs);
         return var9;
   ...
   final View createView(View var1, String var2, Context var3, AttributeSet var4, boolean var5, boolean var6, boolean var7, boolean var8) {
      ...
      case 12:
         ...
         break;
      case 13:
         var13 = this.createToggleButton(var9, var4);
         this.verifyNotNull((View)var13, var2);
         break;
      default:
   ...
   private static class DeclaredOnClickListener implements OnClickListener {
      ...
      private void resolveMethod(Context var1) {
         while(var1 != null) {
            label44: {
               ...
               try {
                  ...
                  var2 = var1.getClass().getMethod(this.mMethodName, View.class);
         ...
         var8.append(this.mMethodName);
         var8.append("(View) in a parent or ancestor Context for android:onClick attribute defined on view ");
         var8.append(this.mHostView.getClass());
         var8.append(var6);
