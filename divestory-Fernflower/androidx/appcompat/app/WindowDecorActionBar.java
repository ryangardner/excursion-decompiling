...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
   ...
   private void init(View var1) {
      ActionBarOverlayLayout var2 = (ActionBarOverlayLayout)var1.findViewById(R.id.decor_content_parent);
      this.mOverlayLayout = var2;
      if (var2 != null) {
         var2.setActionBarVisibilityCallback(this);
      }
      ...
      ActionBarContainer var8 = (ActionBarContainer)var1.findViewById(R.id.action_bar_container);
      this.mContainerView = var8;
      DecorToolbar var5 = this.mDecorToolbar;
      if (var5 != null && this.mContextView != null && var8 != null) {
         this.mContext = var5.getContext();
         boolean var3;
         ...
         boolean var4;
         if (!var7.enableHomeButtonByDefault() && !var3) {
            var4 = false;
         } else {
            var4 = true;
         }
         ...
         TypedArray var9 = this.mContext.obtainStyledAttributes((AttributeSet)null, R.styleable.ActionBar, R.attr.actionBarStyle, 0);
         if (var9.getBoolean(R.styleable.ActionBar_hideOnContentScroll, false)) {
            this.setHideOnContentScrollEnabled(true);
         }

         int var10 = var9.getDimensionPixelSize(R.styleable.ActionBar_elevation, 0);
         if (var10 != 0) {
            this.setElevation((float)var10);
         }
   ...
   public void doHide(boolean var1) {
      ...
      if (this.mCurWindowVisibility != 0 || !this.mShowHideAnimationEnabled && !var1) {
         ...
         var2 = new ViewPropertyAnimatorCompatSet();
         ...
         if (this.mContentAnimations) {
            ...
            if (var7 != null) {
               var2.play(ViewCompat.animate(var7).translationY(var4));
            }
         }
   ...
   public void doShow(boolean var1) {
      ...
      if (this.mCurWindowVisibility == 0 && (this.mShowHideAnimationEnabled || var1)) {
         ...
         if (var1) {
            ...
            var4 = var3 - (float)var7[1];
         }

         this.mContainerView.setTranslationY(var4);
         var2 = new ViewPropertyAnimatorCompatSet();
         ...
         if (this.mContentAnimations) {
            ...
            if (var9 != null) {
               var9.setTranslationY(var4);
               var2.play(ViewCompat.animate(this.mContentView).translationY(0.0F));
            }
         }

         var2.setInterpolator(sShowInterpolator);
         var2.setDuration(250L);
         var2.setListener(this.mShowListener);
         this.mCurrentShowAnim = var2;
         var2.start();
      } else {
         this.mContainerView.setAlpha(1.0F);
   ...
   public boolean isTitleTruncated() {
      DecorToolbar var1 = this.mDecorToolbar;
      boolean var2;
      if (var1 != null && var1.isTitleTruncated()) {
         var2 = true;
      } else {
         var2 = false;
      }
   ...
   public boolean onKeyShortcut(int var1, KeyEvent var2) {
      WindowDecorActionBar.ActionModeImpl var3 = this.mActionMode;
      if (var3 == null) {
         return false;
      } else {
         Menu var6 = var3.getMenu();
         if (var6 != null) {
            int var4;
            if (var2 != null) {
   ...
   public void removeTabAt(int var1) {
      if (this.mTabScrollView != null) {
         WindowDecorActionBar.TabImpl var2 = this.mSelectedTab;
         int var3;
         if (var2 != null) {
            var3 = var2.getPosition();
         } else {
            var3 = this.mSavedTabPosition;
         }

         this.mTabScrollView.removeTabAt(var1);
         var2 = (WindowDecorActionBar.TabImpl)this.mTabs.remove(var1);
         if (var2 != null) {
            var2.setPosition(-1);
         }
         ...
         if (var3 == var1) {
            if (this.mTabs.isEmpty()) {
               ...
               var2 = (WindowDecorActionBar.TabImpl)this.mTabs.get(Math.max(0, var1 - 1));
            }
   ...
   public void setNavigationMode(int var1) {
      ...
      ActionBarOverlayLayout var3;
      if (var2 != var1 && !this.mHasEmbeddedTabs) {
         var3 = this.mOverlayLayout;
         if (var3 != null) {
            ViewCompat.requestApplyInsets(var3);
         }
      }
      ...
      var3.setHasNonEmbeddedTabs(var5);
   }
