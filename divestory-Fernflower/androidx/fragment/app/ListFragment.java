...
public class ListFragment extends Fragment {
      ...
      if (this.mList == null) {
         ...
         if (var1 != null) {
            if (var1 instanceof ListView) {
               ...
               TextView var2 = (TextView)var1.findViewById(16711681);
               this.mStandardEmptyView = var2;
               if (var2 == null) {
               ...
               View var3 = var1.findViewById(16908298);
   ...
   public final ListAdapter requireListAdapter() {
      ...
      if (var1 != null) {
         ...
         var2.append("ListFragment ");
         var2.append(this);
         var2.append(" does not have a ListAdapter.");
