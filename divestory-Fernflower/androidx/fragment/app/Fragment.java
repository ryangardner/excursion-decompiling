...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner {
   ...
   void callStartTransitionListener() {
      ...
      Fragment.OnStartEnterTransitionListener var2 = null;
      if (var1 != null) {
   ...
   public boolean getAllowEnterTransitionOverlap() {
      Fragment.AnimationInfo var1 = this.mAnimationInfo;
      boolean var2;
      if (var1 != null && var1.mAllowEnterTransitionOverlap != null) {
         var2 = this.mAnimationInfo.mAllowEnterTransitionOverlap;
      } else {
         var2 = true;
      }
   ...
   public boolean getAllowReturnTransitionOverlap() {
      Fragment.AnimationInfo var1 = this.mAnimationInfo;
      boolean var2;
      if (var1 != null && var1.mAllowReturnTransitionOverlap != null) {
         var2 = this.mAnimationInfo.mAllowReturnTransitionOverlap;
      } else {
         var2 = true;
      }
   ...
   public final LayoutInflater getLayoutInflater() {
      ...
      if (var1 == null) {
         var2 = this.performGetLayoutInflater((Bundle)null);
      }
   ...
   final boolean isRemovingParent() {
      ...
      boolean var2;
      if (var1 == null || !var1.isRemoving() && !var1.isRemovingParent()) {
         var2 = false;
      } else {
         var2 = true;
      }
   ...
   boolean performCreateOptionsMenu(Menu var1, MenuInflater var2) {
      ...
      if (!var3) {
         ...
         var4 = var6 | this.mChildFragmentManager.dispatchCreateOptionsMenu(var1, var2);
      }
   ...
   boolean performPrepareOptionsMenu(Menu var1) {
      ...
      if (!var2) {
         ...
         var3 = var5 | this.mChildFragmentManager.dispatchPrepareOptionsMenu(var1);
      }
   ...
   public static class SavedState implements Parcelable {
      public static final Creator<Fragment.SavedState> CREATOR = new ClassLoaderCreator<Fragment.SavedState>() {
