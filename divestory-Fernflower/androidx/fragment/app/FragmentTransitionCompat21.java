...
class FragmentTransitionCompat21 extends FragmentTransitionImpl {
   ...
   public void scheduleRemoveTargets(Object var1, final Object var2, final ArrayList<View> var3, final Object var4, final ArrayList<View> var5, final Object var6, final ArrayList<View> var7) {
      ((Transition)var1).addListener(new TransitionListener() {
         ...
         public void onTransitionStart(Transition var1) {
            Object var2x = var2;
            if (var2x != null) {
               FragmentTransitionCompat21.this.replaceTargets(var2x, var3, (ArrayList)null);
            }

            var2x = var4;
            if (var2x != null) {
               FragmentTransitionCompat21.this.replaceTargets(var2x, var5, (ArrayList)null);
            }

            var2x = var6;
            if (var2x != null) {
               FragmentTransitionCompat21.this.replaceTargets(var2x, var7, (ArrayList)null);
            }
   ...
   public void setListenerForTransitionEnd(Fragment var1, Object var2, CancellationSignal var3, final Runnable var4) {
      ((Transition)var2).addListener(new TransitionListener() {
         public void onTransitionCancel(Transition var1) {
         }
   ...
   public void setSharedElementTargets(Object var1, View var2, ArrayList<View> var3) {
      ...
      List var4 = var7.getTargets();
      var4.clear();
      int var5 = var3.size();

      for(int var6 = 0; var6 < var5; ++var6) {
         bfsAddViewChildren(var4, (View)var3.get(var6));
      }
