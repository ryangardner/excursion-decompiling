...
public class FragmentFactory {
   ...
   private static Class<?> loadClass(ClassLoader var0, String var1) throws ClassNotFoundException {
      Class var2 = (Class)sClassMap.get(var1);
      Class var3 = var2;
      if (var2 == null) {
         var3 = Class.forName(var1, false, var0);
   ...
   public static Class<? extends Fragment> loadFragmentClass(ClassLoader var0, String var1) {
      StringBuilder var2;
      try {
   ...
   public Fragment instantiate(ClassLoader var1, String var2) {
      StringBuilder var3;
      try {
         Fragment var9 = (Fragment)loadFragmentClass(var1, var2).getConstructor().newInstance();
         return var9;
         ...
         var8.append("Unable to instantiate fragment ");
         var8.append(var2);
         var8.append(": calling Fragment constructor caused an exception");
         throw new Fragment.InstantiationException(var8.toString(), var7);
      }
   }
}
