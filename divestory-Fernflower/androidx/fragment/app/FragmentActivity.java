...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
      ...
      while(var5.hasNext()) {
         ...
         if (var3 != null) {
            ...
            if (var3.getHost() != null) {
               var4 = var2 | markState(var3.getChildFragmentManager(), var1);
            }

            var2 = var4;
            if (var3.getLifecycle().getCurrentState().isAtLeast(Lifecycle.State.STARTED)) {
               var3.mLifecycleRegistry.setCurrentState(var1);
               var2 = true;
            }
         }
      }
   ...
   protected void onCreate(Bundle var1) {
      ...
      if (var1 != null) {
         ...
         this.mFragments.restoreSaveState(var2);
         if (var1.containsKey("android:support:next_request_index")) {
            ...
            int[] var3 = var1.getIntArray("android:support:request_indicies");
            String[] var5 = var1.getStringArray("android:support:request_fragment_who");
            if (var3 != null && var5 != null && var3.length == var5.length) {
               this.mPendingFragmentActivityResults = new SparseArrayCompat(var3.length);

               for(int var4 = 0; var4 < var3.length; ++var4) {
                  this.mPendingFragmentActivityResults.put(var3[var4], var5[var4]);
               }
            } else {
   ...
   protected void onSaveInstanceState(Bundle var1) {
      ...
      if (this.mPendingFragmentActivityResults.size() > 0) {
         ...
         for(int var4 = 0; var4 < this.mPendingFragmentActivityResults.size(); ++var4) {
            var3[var4] = this.mPendingFragmentActivityResults.keyAt(var4);
            var5[var4] = (String)this.mPendingFragmentActivityResults.valueAt(var4);
         }
