...
public abstract class FragmentTransaction {
   ...
   private Fragment createFragment(Class<? extends Fragment> var1, Bundle var2) {
   ...
   public final FragmentTransaction add(int var1, Class<? extends Fragment> var2, Bundle var3) {
      return this.add(var1, this.createFragment(var2, var3));
   }

   public final FragmentTransaction add(int var1, Class<? extends Fragment> var2, Bundle var3, String var4) {
   ...
   public final FragmentTransaction add(Class<? extends Fragment> var1, Bundle var2, String var3) {
      return this.add(this.createFragment(var1, var2), var3);
   }

   void addOp(FragmentTransaction.Op var1) {
      this.mOps.add(var1);
   ...
   public FragmentTransaction attach(Fragment var1) {
      this.addOp(new FragmentTransaction.Op(7, var1));
      return this;
   }
   ...
   public FragmentTransaction detach(Fragment var1) {
      this.addOp(new FragmentTransaction.Op(6, var1));
      return this;
   }
   ...
   void doAddOp(int var1, Fragment var2, String var3, int var4) {
      ...
      if (var5.isAnonymousClass() || !Modifier.isPublic(var6) || var5.isMemberClass() && !Modifier.isStatic(var6)) {
         ...
         this.addOp(new FragmentTransaction.Op(var4, var2));
      }
   }

   public FragmentTransaction hide(Fragment var1) {
      this.addOp(new FragmentTransaction.Op(4, var1));
      return this;
   }
   ...
   public FragmentTransaction remove(Fragment var1) {
      this.addOp(new FragmentTransaction.Op(3, var1));
      return this;
   }
   ...
   public final FragmentTransaction replace(int var1, Class<? extends Fragment> var2, Bundle var3) {
      return this.replace(var1, var2, var3, (String)null);
   }

   public final FragmentTransaction replace(int var1, Class<? extends Fragment> var2, Bundle var3, String var4) {
   ...
   public FragmentTransaction setMaxLifecycle(Fragment var1, Lifecycle.State var2) {
      this.addOp(new FragmentTransaction.Op(10, var1, var2));
      return this;
   }

   public FragmentTransaction setPrimaryNavigationFragment(Fragment var1) {
      this.addOp(new FragmentTransaction.Op(8, var1));
      return this;
   }
   ...
   public FragmentTransaction show(Fragment var1) {
      this.addOp(new FragmentTransaction.Op(5, var1));
      return this;
   }
