...
public class FragmentTabHost extends TabHost implements OnTabChangeListener {
   ...
   private FragmentTabHost.TabInfo getTabInfoForTag(String var1) {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         FragmentTabHost.TabInfo var4 = (FragmentTabHost.TabInfo)this.mTabs.get(var3);
   ...
   protected void onAttachedToWindow() {
      ...
      for(int var4 = 0; var4 < var2; var3 = var6) {
         FragmentTabHost.TabInfo var5 = (FragmentTabHost.TabInfo)this.mTabs.get(var4);
      ...
      this.mAttached = true;
      var3 = this.doTabChanged(var1, var3);
      if (var3 != null) {
         var3.commit();
