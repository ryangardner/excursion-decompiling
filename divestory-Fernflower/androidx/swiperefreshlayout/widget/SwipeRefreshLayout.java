...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
   ...
   public SwipeRefreshLayout(Context var1, AttributeSet var2) {
      ...
      int var4 = (int)(var3.density * 64.0F);
      this.mSpinnerOffsetEnd = var4;
      this.mTotalDragDistance = (float)var4;
      this.mNestedScrollingParentHelper = new NestedScrollingParentHelper(this);
      this.mNestedScrollingChildHelper = new NestedScrollingChildHelper(this);
      this.setNestedScrollingEnabled(true);
      var4 = -this.mCircleDiameter;
   ...
   private void moveSpinner(float var1) {
      ...
      int var6 = this.mCustomSlingshotDistance;
      if (var6 <= 0) {
      ...
      var4 = (float)(var8 - Math.pow(var8, 2.0D)) * 2.0F;
      var6 = this.mOriginalOffsetTop;
      int var10 = (int)(var7 * var2 + var7 * var4 * 2.0F);
      ...
      this.mProgress.setProgressRotation((var3 * 0.4F - 0.25F + var4 * 2.0F) * 0.5F);
      this.setTargetOffsetTopAndBottom(var6 + var10 - this.mCurrentTargetOffsetTop);
   }
   ...
   protected void onLayout(boolean var1, int var2, int var3, int var4, int var5) {
      ...
      if (this.getChildCount() != 0) {
         ...
         if (var6 != null) {
            ...
            var6.layout(var2, var5, var3 - this.getPaddingLeft() - this.getPaddingRight() + var2, var4 - this.getPaddingTop() - this.getPaddingBottom() + var5);
         ...
         if (var2 != 0) {
            ...
            if (var2 == 1) {
               ...
               if (this.mIsBeingDragged) {
                  var3 = var1.getY(var2);
                  float var4 = this.mInitialMotionY;
                  this.mIsBeingDragged = false;
                  this.finishSpinner((var3 - var4) * 0.5F);
               }
