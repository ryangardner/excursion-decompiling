...
class SetsKt__SetsJVMKt {
   ...
   public static final <T> Set<T> setOf(T var0) {
      ...
      Intrinsics.checkExpressionValueIsNotNull(var1, "java.util.Collections.singleton(element)");
      return var1;
   }

   public static final <T> TreeSet<T> sortedSetOf(Comparator<? super T> var0, T... var1) {
   ...
   public static final <T> TreeSet<T> sortedSetOf(T... var0) {
