...
class CollectionsKt__IteratorsKt extends CollectionsKt__IteratorsJVMKt {
   ...
   public static final <T> void forEach(Iterator<? extends T> var0, Function1<? super T, Unit> var1) {
   ...
   private static final <T> Iterator<T> iterator(Iterator<? extends T> var0) {
      Intrinsics.checkParameterIsNotNull(var0, "$this$iterator");
      return var0;
   }

   public static final <T> Iterator<IndexedValue<T>> withIndex(Iterator<? extends T> var0) {
