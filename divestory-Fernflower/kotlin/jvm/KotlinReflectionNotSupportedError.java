...
public class KotlinReflectionNotSupportedError extends Error {
   ...
   public KotlinReflectionNotSupportedError(String var1) {
      super(var1);
   }

   public KotlinReflectionNotSupportedError(String var1, Throwable var2) {
      super(var1, var2);
   }

   public KotlinReflectionNotSupportedError(Throwable var1) {
      super(var1);
   }
}
