...
public class NoWhenBranchMatchedException extends RuntimeException {
   ...
   public NoWhenBranchMatchedException(String var1) {
      super(var1);
   }

   public NoWhenBranchMatchedException(String var1, Throwable var2) {
      super(var1, var2);
   }

   public NoWhenBranchMatchedException(Throwable var1) {
      super(var1);
   }
}
