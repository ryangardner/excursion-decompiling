...
class StringsKt__RegexExtensionsKt extends StringsKt__RegexExtensionsJVMKt {
   ...
   private static final Regex toRegex(String var0) {
      return new Regex(var0);
   }

   private static final Regex toRegex(String var0, Set<? extends RegexOption> var1) {
      return new Regex(var0, var1);
   }

   private static final Regex toRegex(String var0, RegexOption var1) {
      return new Regex(var0, var1);
   }
}
