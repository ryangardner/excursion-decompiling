...
public final class RegexKt {
   ...
   // $FF: synthetic method
   public static final Set access$fromInt(int var0) {
      return fromInt(var0);
   }
   ...
   // $FF: synthetic method
   private static final <T extends Enum<T> & FlagEnum> Set<T> fromInt(final int var0) {
      Intrinsics.reifiedOperationMarker(4, "T");
      EnumSet var1 = EnumSet.allOf(Enum.class);
      CollectionsKt.retainAll((Iterable)var1, (Function1)(new Function1<T, Boolean>() {
         public final boolean invoke(T var1) {
            int var2 = var0;
      ...
      Set var2 = Collections.unmodifiableSet((Set)var1);
      Intrinsics.checkExpressionValueIsNotNull(var2, "Collections.unmodifiable…mask == it.value }\n    })");
      return var2;
   }
   ...
   private static final int toInt(Iterable<? extends FlagEnum> var0) {
