...
public abstract class AbstractCoroutineContextKey<B extends CoroutineContext.Element, E extends B> implements CoroutineContext.Key<E> {
   ...
   public AbstractCoroutineContextKey(CoroutineContext.Key<B> var1, Function1<? super CoroutineContext.Element, ? extends E> var2) {
      Intrinsics.checkParameterIsNotNull(var1, "baseKey");
      Intrinsics.checkParameterIsNotNull(var2, "safeCast");
      super();
      this.safeCast = var2;
   ...
   public final boolean isSubKey$kotlin_stdlib(CoroutineContext.Key<?> var1) {
      ...
      boolean var2;
      if (var1 != (AbstractCoroutineContextKey)this && this.topmostKey != var1) {
         var2 = false;
      } else {
         var2 = true;
      }
   ...
   public final E tryCast$kotlin_stdlib(CoroutineContext.Element var1) {
