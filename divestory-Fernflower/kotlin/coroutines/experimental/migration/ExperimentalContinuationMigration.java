...
final class ExperimentalContinuationMigration<T> implements Continuation<T> {
   ...
   public ExperimentalContinuationMigration(kotlin.coroutines.Continuation<? super T> var1) {
      Intrinsics.checkParameterIsNotNull(var1, "continuation");
      super();
      this.continuation = var1;
      this.context = CoroutinesMigrationKt.toExperimentalCoroutineContext(var1.getContext());
   }
