...
final class ExperimentalSuspendFunction2Migration<T1, T2, R> implements Function3<T1, T2, Continuation<? super R>, Object> {
   ...
   public ExperimentalSuspendFunction2Migration(Function3<? super T1, ? super T2, ? super kotlin.coroutines.Continuation<? super R>, ? extends Object> var1) {
   ...
   public Object invoke(T1 var1, T2 var2, Continuation<? super R> var3) {
      Intrinsics.checkParameterIsNotNull(var3, "continuation");
