...
final class ExperimentalSuspendFunction1Migration<T1, R> implements Function2<T1, Continuation<? super R>, Object> {
   ...
   public ExperimentalSuspendFunction1Migration(Function2<? super T1, ? super kotlin.coroutines.Continuation<? super R>, ? extends Object> var1) {
   ...
   public Object invoke(T1 var1, Continuation<? super R> var2) {
