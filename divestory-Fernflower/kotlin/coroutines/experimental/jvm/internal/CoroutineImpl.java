...
public abstract class CoroutineImpl extends Lambda<Object> implements Continuation<Object> {
   ...
   public CoroutineImpl(int var1, Continuation<Object> var2) {
      super(var1);
   ...
   public void resume(Object var1) {
      ...
      var2.resumeWithException(var15);
   }
   ...
   public void resumeWithException(Throwable var1) {
      ...
      label121: {
         ...
         Object var15;
         try {
            var15 = this.doResume((Object)null, var1);
            if (var15 == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
               return;
            }
         } catch (Throwable var14) {
            var10000 = var14;
