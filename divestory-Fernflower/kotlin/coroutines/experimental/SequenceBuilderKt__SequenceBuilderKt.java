...
class SequenceBuilderKt__SequenceBuilderKt {
   ...
   public static final <T> Iterator<T> buildIterator(Function2<? super SequenceBuilder<? super T>, ? super Continuation<? super Unit>, ? extends Object> var0) {
      Intrinsics.checkParameterIsNotNull(var0, "builderAction");
      SequenceBuilderIterator var1 = new SequenceBuilderIterator();
      var1.setNextStep(IntrinsicsKt.createCoroutineUnchecked(var0, var1, (Continuation)var1));
      return (Iterator)var1;
   }

   public static final <T> Sequence<T> buildSequence(final Function2<? super SequenceBuilder<? super T>, ? super Continuation<? super Unit>, ? extends Object> var0) {
      Intrinsics.checkParameterIsNotNull(var0, "builderAction");
      return (Sequence)(new Sequence<T>() {
         public Iterator<T> iterator() {
            return SequenceBuilderKt.buildIterator(var0);
         }
      });
   }
}
