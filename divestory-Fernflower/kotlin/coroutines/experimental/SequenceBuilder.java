...
public abstract class SequenceBuilder<T> {
   ...
   public final Object yieldAll(Iterable<? extends T> var1, Continuation<? super Unit> var2) {
      if (var1 instanceof Collection && ((Collection)var1).isEmpty()) {
         return Unit.INSTANCE;
      } else {
         Object var3 = this.yieldAll(var1.iterator(), var2);
   ...
   public final Object yieldAll(Sequence<? extends T> var1, Continuation<? super Unit> var2) {
      Object var3 = this.yieldAll(var1.iterator(), var2);
      return var3 == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? var3 : Unit.INSTANCE;
   }
}
