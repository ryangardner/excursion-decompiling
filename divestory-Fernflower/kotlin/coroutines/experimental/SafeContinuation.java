...
public final class SafeContinuation<T> implements Continuation<T> {
   ...
   public final Object getResult() {
      ...
      Object var2 = UNDECIDED;
      Object var3 = var1;
      if (var1 == var2) {
         if (RESULT.compareAndSet(this, var2, IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
      ...
      if (var3 == RESUMED) {
         return IntrinsicsKt.getCOROUTINE_SUSPENDED();
      } else if (!(var3 instanceof SafeContinuation.Fail)) {
         return var3;
      } else {
         throw ((SafeContinuation.Fail)var3).getException();
      }
   }
   ...
   public void resume(T var1) {
      while(true) {
         ...
         Object var3 = UNDECIDED;
         if (var2 == var3) {
            if (RESULT.compareAndSet(this, var3, var1)) {
               return;
            }
         } else {
   ...
   public void resumeWithException(Throwable var1) {
      ...
      do {
         ...
         return;
      } while(!RESULT.compareAndSet(this, var3, new SafeContinuation.Fail(var1)));
