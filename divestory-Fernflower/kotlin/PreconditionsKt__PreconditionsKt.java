...
class PreconditionsKt__PreconditionsKt extends PreconditionsKt__AssertionsJVMKt {
   ...
   private static final void check(boolean var0, Function0<? extends Object> var1) {
      if (!var0) {
         throw (Throwable)(new IllegalStateException(var1.invoke().toString()));
      }
   }

   private static final <T> T checkNotNull(T var0) {
      if (var0 != null) {
         return var0;
      } else {
   ...
   private static final <T> T checkNotNull(T var0, Function0<? extends Object> var1) {
      if (var0 != null) {
         return var0;
      } else {
         throw (Throwable)(new IllegalStateException(var1.invoke().toString()));
   ...
   private static final void require(boolean var0, Function0<? extends Object> var1) {
      if (!var0) {
         throw (Throwable)(new IllegalArgumentException(var1.invoke().toString()));
      }
   }

   private static final <T> T requireNotNull(T var0) {
      if (var0 != null) {
         return var0;
      } else {
   ...
   private static final <T> T requireNotNull(T var0, Function0<? extends Object> var1) {
      if (var0 != null) {
         return var0;
      } else {
         throw (Throwable)(new IllegalArgumentException(var1.invoke().toString()));
