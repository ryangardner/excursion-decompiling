...
class SequencesKt__SequenceBuilderKt {
   ...
   private static final <T> Iterator<T> buildIterator(Function2<? super SequenceScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> var0) {
      return SequencesKt.iterator(var0);
   }
   ...
   private static final <T> Sequence<T> buildSequence(final Function2<? super SequenceScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> var0) {
   ...
   public static final <T> Iterator<T> iterator(Function2<? super SequenceScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> var0) {
   ...
   public static final <T> Sequence<T> sequence(final Function2<? super SequenceScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> var0) {
      Intrinsics.checkParameterIsNotNull(var0, "block");
      return (Sequence)(new Sequence<T>() {
         public Iterator<T> iterator() {
            return SequencesKt.iterator(var0);
