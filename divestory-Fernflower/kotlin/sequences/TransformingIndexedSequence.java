...
public final class TransformingIndexedSequence<T, R> implements Sequence<R> {
   ...
   public TransformingIndexedSequence(Sequence<? extends T> var1, Function2<? super Integer, ? super T, ? extends R> var2) {
   ...
   public Iterator<R> iterator() {
      return (Iterator)(new Iterator<R>() {
         ...
         public R next() {
            Function2 var1 = TransformingIndexedSequence.this.transformer;
            int var2 = this.index++;
            if (var2 < 0) {
               CollectionsKt.throwIndexOverflow();
            }

            return var1.invoke(var2, this.iterator.next());
         }
