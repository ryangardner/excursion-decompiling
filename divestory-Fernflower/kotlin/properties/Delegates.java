...
public final class Delegates {
   ...
   public final <T> ReadWriteProperty<Object, T> observable(final T var1, final Function3<? super KProperty<?>, ? super T, ? super T, Unit> var2) {
      Intrinsics.checkParameterIsNotNull(var2, "onChange");
      return (ReadWriteProperty)(new ObservableProperty<T>(var1) {
         protected void afterChange(KProperty<?> var1x, T var2x, T var3) {
            Intrinsics.checkParameterIsNotNull(var1x, "property");
            var2.invoke(var1x, var2x, var3);
         }
      });
   }

   public final <T> ReadWriteProperty<Object, T> vetoable(final T var1, final Function3<? super KProperty<?>, ? super T, ? super T, Boolean> var2) {
      Intrinsics.checkParameterIsNotNull(var2, "onChange");
      return (ReadWriteProperty)(new ObservableProperty<T>(var1) {
         protected boolean beforeChange(KProperty<?> var1x, T var2x, T var3) {
            Intrinsics.checkParameterIsNotNull(var1x, "property");
            return (Boolean)var2.invoke(var1x, var2x, var3);
         }
      });
   }
}
