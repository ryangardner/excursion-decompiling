...
public interface KMutableProperty0<R> extends KProperty0<R>, KMutableProperty<R> {
   KMutableProperty0.Setter<R> getSetter();
   ...
   @Metadata(
      ...
      d2 = {"Lkotlin/reflect/KMutableProperty0$Setter;", "R", "Lkotlin/reflect/KMutableProperty$Setter;", "Lkotlin/Function1;", "", "kotlin-stdlib"},
      k = 1,
      mv = {1, 1, 16}
   )
