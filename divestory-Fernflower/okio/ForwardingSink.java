...
@Metadata(
   ...
   d2 = {"Lokio/ForwardingSink;", "Lokio/Sink;", "delegate", "(Lokio/Sink;)V", "()Lokio/Sink;", "close", "", "-deprecated_delegate", "flush", "timeout", "Lokio/Timeout;", "toString", "", "write", "source", "Lokio/Buffer;", "byteCount", "", "okio"},
   k = 1,
   mv = {1, 1, 16}
)
public abstract class ForwardingSink implements Sink {
   ...
   public final Sink _deprecated_delegate/* $FF was: -deprecated_delegate*/() {
