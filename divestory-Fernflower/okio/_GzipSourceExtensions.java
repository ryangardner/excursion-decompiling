...
public final class _GzipSourceExtensions {
   ...
   // $FF: synthetic method
   public static final boolean access$getBit(int var0, int var1) {
      return getBit(var0, var1);
   }

   private static final boolean getBit(int var0, int var1) {
      boolean var2 = true;
      if ((var0 >> var1 & 1) != 1) {
         var2 = false;
      }
   ...
   public static final GzipSource gzip(Source var0) {
