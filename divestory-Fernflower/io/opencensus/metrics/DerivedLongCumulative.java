...
public abstract class DerivedLongCumulative {
   static DerivedLongCumulative newNoopDerivedLongCumulative(String var0, String var1, String var2, List<LabelKey> var3) {
      return DerivedLongCumulative.NoopDerivedLongCumulative.create(var0, var1, var2, var3);
   }
   ...
   private static final class NoopDerivedLongCumulative extends DerivedLongCumulative {
      ...
      NoopDerivedLongCumulative(String var1, String var2, String var3, List<LabelKey> var4) {
      ...
      static DerivedLongCumulative.NoopDerivedLongCumulative create(String var0, String var1, String var2, List<LabelKey> var3) {
         return new DerivedLongCumulative.NoopDerivedLongCumulative(var0, var1, var2, var3);
      }
