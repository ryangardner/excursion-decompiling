...
public abstract class DerivedDoubleCumulative {
   static DerivedDoubleCumulative newNoopDerivedDoubleCumulative(String var0, String var1, String var2, List<LabelKey> var3) {
      return DerivedDoubleCumulative.NoopDerivedDoubleCumulative.create(var0, var1, var2, var3);
   }
   ...
   private static final class NoopDerivedDoubleCumulative extends DerivedDoubleCumulative {
      ...
      NoopDerivedDoubleCumulative(String var1, String var2, String var3, List<LabelKey> var4) {
      ...
      static DerivedDoubleCumulative.NoopDerivedDoubleCumulative create(String var0, String var1, String var2, List<LabelKey> var3) {
         return new DerivedDoubleCumulative.NoopDerivedDoubleCumulative(var0, var1, var2, var3);
      }

      public void clear() {
      }

      public <T> void createTimeSeries(List<LabelValue> var1, T var2, ToDoubleFunction<T> var3) {
