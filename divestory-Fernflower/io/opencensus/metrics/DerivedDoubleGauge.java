...
public abstract class DerivedDoubleGauge {
   static DerivedDoubleGauge newNoopDerivedDoubleGauge(String var0, String var1, String var2, List<LabelKey> var3) {
      return DerivedDoubleGauge.NoopDerivedDoubleGauge.create(var0, var1, var2, var3);
   }
   ...
   private static final class NoopDerivedDoubleGauge extends DerivedDoubleGauge {
      ...
      NoopDerivedDoubleGauge(String var1, String var2, String var3, List<LabelKey> var4) {
      ...
      static DerivedDoubleGauge.NoopDerivedDoubleGauge create(String var0, String var1, String var2, List<LabelKey> var3) {
         return new DerivedDoubleGauge.NoopDerivedDoubleGauge(var0, var1, var2, var3);
      }
