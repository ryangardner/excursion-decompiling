...
public class POP3SClient extends POP3Client {
   ...
   public POP3SClient(String var1) {
      this(var1, false);
   }

   public POP3SClient(String var1, boolean var2) {
      this(var1, var2, (SSLContext)null);
   }

   public POP3SClient(String var1, boolean var2, SSLContext var3) {
      this.context = null;
      this.suites = null;
      this.protocols = null;
   ...
   public POP3SClient(SSLContext var1) {
      this(false, var1);
   }

   public POP3SClient(boolean var1) {
      this("TLS", var1);
   }

   public POP3SClient(boolean var1, SSLContext var2) {
      this("TLS", var1, var2);
   }
