...
public final class TelnetCommand {
   ...
   private static final String[] __commandString = new String[]{"IAC", "DONT", "DO", "WONT", "WILL", "SB", "GA", "EL", "EC", "AYT", "AO", "IP", "BRK", "DMARK", "NOP", "SE", "EOR", "ABORT", "SUSP", "EOF"};

   private TelnetCommand() {
   }

   public static final String getCommand(int var0) {
      return __commandString[255 - var0];
   }

   public static final boolean isValidCommand(int var0) {
      boolean var1;
      if (var0 <= 255 && var0 >= 236) {
         var1 = true;
      } else {
         var1 = false;
      }
