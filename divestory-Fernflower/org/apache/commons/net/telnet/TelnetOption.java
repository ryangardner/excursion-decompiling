...
public class TelnetOption {
   ...
   public static final String getOption(int var0) {
      return __optionString[var0].length() == 0 ? "UNASSIGNED" : __optionString[var0];
   }

   public static final boolean isValidOption(int var0) {
      boolean var1;
      if (var0 <= 255) {
         var1 = true;
      } else {
