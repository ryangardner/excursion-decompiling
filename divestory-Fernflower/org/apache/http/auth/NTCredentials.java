...
public class NTCredentials implements Credentials, Serializable {
   ...
   public NTCredentials(String var1) {
      if (var1 != null) {
         ...
         if (var2 >= 0) {
            this.principal = new NTUserPrincipal(var1.substring(0, var2).toUpperCase(Locale.ENGLISH), var1.substring(var2 + 1));
         } else {
   ...
   public boolean equals(Object var1) {
      if (this == var1) {
         ...
         if (var1 instanceof NTCredentials) {
            ...
            if (LangUtils.equals((Object)this.principal, (Object)var2.principal) && LangUtils.equals((Object)this.workstation, (Object)var2.workstation)) {
               return true;
            }
         }
