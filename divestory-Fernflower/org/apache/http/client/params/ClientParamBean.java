...
public class ClientParamBean extends HttpAbstractParamBean {
   ...
   @Deprecated
   public void setConnectionManagerFactory(ClientConnectionManagerFactory var1) {
      this.params.setParameter("http.connection-manager.factory-object", var1);
   }
   ...
   public void setDefaultHeaders(Collection<Header> var1) {
