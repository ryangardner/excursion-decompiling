...
public class PieChart extends PieRadarChartBase<PieData> {
   ...
   private void calcAngles() {
      ...
      float var5 = this.mMinAngleForSlices;
      boolean var17;
      if (var5 != 0.0F && (float)var1 * var5 <= this.mMaxAngle) {
         var17 = true;
      } else {
         var17 = false;
      }
      ...
      for(int var9 = 0; var7 < ((PieData)this.mData).getDataSetCount(); ++var7) {
         IPieDataSet var10 = (IPieDataSet)var4.get(var7);

         float var14;
         for(int var11 = 0; var11 < var10.getEntryCount(); var5 = var14) {
            float var12 = this.calcAngle(Math.abs(((PieEntry)var10.getEntryForIndex(var11)).getY()), var3);
            float var13 = var8;
            var14 = var5;
            if (var17) {
               var14 = this.mMinAngleForSlices;
               var13 = var12 - var14;
               if (var13 <= 0.0F) {
                  var6[var9] = var14;
                  var13 = var8 + -var13;
            ...
            float[] var15 = this.mDrawAngles;
            var15[var9] = var12;
            if (var9 == 0) {
               this.mAbsoluteAngles[var9] = var15[var9];
            } else {
               float[] var16 = this.mAbsoluteAngles;
               var16[var9] = var16[var9 - 1] + var15[var9];
            }
      ...
      if (var17) {
         for(var2 = 0; var2 < var1; ++var2) {
            var6[var2] -= (var6[var2] - this.mMinAngleForSlices) / var5 * var8;
            if (var2 == 0) {
               this.mAbsoluteAngles[0] = var6[0];
            } else {
               float[] var18 = this.mAbsoluteAngles;
               var18[var2] = var18[var2 - 1] + var6[var2];
            }
         }

         this.mDrawAngles = var6;
      }
   ...
   public int getIndexForAngle(float var1) {
      ...
      while(true) {
         float[] var3 = this.mAbsoluteAngles;
         if (var2 >= var3.length) {
            return -1;
         }
   ...
   public float getRadius() {
      RectF var1 = this.mCircleBox;
      return var1 == null ? 0.0F : Math.min(var1.width() / 2.0F, this.mCircleBox.height() / 2.0F);
   }
   ...
   public void setDrawRoundedSlices(boolean var1) {
      this.mDrawRoundedSlices = var1;
   }
   ...
   public void setMinAngleForSlices(float var1) {
      float var2 = this.mMaxAngle;
      if (var1 > var2 / 2.0F) {
         var2 /= 2.0F;
      } else {
         var2 = var1;
