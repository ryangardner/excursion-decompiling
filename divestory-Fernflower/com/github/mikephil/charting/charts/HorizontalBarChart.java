...
public class HorizontalBarChart extends BarChart {
   ...
   public void calculateOffsets() {
      ...
      if (this.mAxisRight.needsOffset()) {
         var2 = var4 + this.mAxisRight.getRequiredHeightSpace(this.mAxisRendererRight.getPaintAxisLabels());
      }

      float var6 = (float)this.mXAxis.mLabelRotatedWidth;
      var4 = var1;
      float var7 = var3;
      ...
      var1 = var7 + this.getExtraRightOffset();
      var2 += this.getExtraBottomOffset();
      var4 += this.getExtraLeftOffset();
      var7 = Utils.convertDpToPixel(this.mMinOffset);
      this.mViewPortHandler.restrainViewPort(Math.max(var7, var4), Math.max(var7, var5), Math.max(var7, var1), Math.max(var7, var2));
      if (this.mLogEnabled) {
