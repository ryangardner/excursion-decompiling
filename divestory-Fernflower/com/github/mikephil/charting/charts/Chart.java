...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends ViewGroup implements ChartInterface {
   ...
   public void animateXY(int var1, int var2, Easing.EasingFunction var3) {
      this.mAnimator.animateXY(var1, var2, var3);
   }
   ...
   protected void drawDescription(Canvas var1) {
      Description var2 = this.mDescription;
      if (var2 != null && var2.isEnabled()) {
         MPPointF var5 = this.mDescription.getPosition();
   ...
   protected void drawMarkers(Canvas var1) {
      if (this.mMarker != null && this.isDrawMarkersEnabled() && this.valuesToHighlight()) {
         ...
         while(true) {
            Highlight[] var3 = this.mIndicesToHighlight;
            if (var2 >= var3.length) {
               break;
            }

            Highlight var4 = var3[var2];
            IDataSet var5 = this.mData.getDataSetByIndex(var4.getDataSetIndex());
            Entry var7 = this.mData.getEntryForHighlight(this.mIndicesToHighlight[var2]);
            int var6 = var5.getEntryIndex(var7);
            if (var7 != null && (float)var6 <= (float)var5.getEntryCount() * this.mAnimator.getPhaseX()) {
               float[] var8 = this.getMarkerPosition(var4);
               if (this.mViewPortHandler.isInBounds(var8[0], var8[1])) {
                  this.mMarker.refreshContent(var7, var4);
                  this.mMarker.draw(var1, var8[0], var8[1]);
               }
            }
   ...
   protected void init() {
      ...
      var1.setColor(Color.rgb(247, 189, 51));
   ...
   public boolean isEmpty() {
      ChartData var1 = this.mData;
      if (var1 == null) {
         return true;
      } else {
         return var1.getEntryCount() <= 0;
      }
   }
   ...
   public boolean saveToGallery(String var1) {
      return this.saveToGallery(var1, "", "MPAndroidChart-Library Save", CompressFormat.PNG, 40);
   }

   public boolean saveToGallery(String var1, int var2) {
      return this.saveToGallery(var1, "", "MPAndroidChart-Library Save", CompressFormat.PNG, var2);
   }
   ...
   public boolean saveToGallery(String var1, String var2, String var3, CompressFormat var4, int var5) {
      ...
      if (!var12 && !var11.mkdirs()) {
         ...
         var5 = null.$SwitchMap$android$graphics$Bitmap$CompressFormat[var4.ordinal()];
         String var20 = "image/png";
         StringBuilder var18;
         String var22;
         if (var5 != 1) {
            if (var5 != 2) {
         ...
         try {
            FileOutputStream var21 = new FileOutputStream(var1);
            this.getChartBitmap().compress(var4, var6, var21);
            var21.flush();
            var21.close();
   ...
   protected void setupDefaultFormatter(float var1, float var2) {
      ChartData var3 = this.mData;
      if (var3 != null && var3.getEntryCount() >= 2) {
         var1 = Math.abs(var2 - var1);
      } else {
         var1 = Math.max(Math.abs(var1), Math.abs(var2));
      }

      int var4 = Utils.getDecimals(var1);
      this.mDefaultValueFormatter.setup(var4);
   }
