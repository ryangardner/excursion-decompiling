...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>> extends Chart<T> implements BarLineScatterCandleBubbleDataProvider {
   ...
   protected void calculateLegendOffsets(RectF var1) {
      ...
      if (this.mLegend != null && this.mLegend.isEnabled() && !this.mLegend.isDrawInsideEnabled()) {
         int var2 = null.$SwitchMap$com$github$mikephil$charting$components$Legend$LegendOrientation[this.mLegend.getOrientation().ordinal()];
         if (var2 != 1) {
            if (var2 == 2) {
               var2 = null.$SwitchMap$com$github$mikephil$charting$components$Legend$LegendVerticalAlignment[this.mLegend.getVerticalAlignment().ordinal()];
               if (var2 != 1) {
                  if (var2 == 2) {
            ...
            var2 = null.$SwitchMap$com$github$mikephil$charting$components$Legend$LegendHorizontalAlignment[this.mLegend.getHorizontalAlignment().ordinal()];
            if (var2 != 1) {
               if (var2 != 2) {
                  if (var2 == 3) {
                     var2 = null.$SwitchMap$com$github$mikephil$charting$components$Legend$LegendVerticalAlignment[this.mLegend.getVerticalAlignment().ordinal()];
   ...
   public void calculateOffsets() {
      if (!this.mCustomViewPortEnabled) {
         ...
         float var4 = this.mOffsetsBuffer.bottom + 0.0F;
         float var5 = var1;
         ...
         if (this.mAxisRight.needsOffset()) {
            var1 = var3 + this.mAxisRight.getRequiredWidthSpace(this.mAxisRendererRight.getPaintAxisLabels());
         }
         ...
         var4 = var6 + this.getExtraTopOffset();
         var1 += this.getExtraRightOffset();
         var3 += this.getExtraBottomOffset();
         var6 = var5 + this.getExtraLeftOffset();
         var5 = Utils.convertDpToPixel(this.mMinOffset);
         this.mViewPortHandler.restrainViewPort(Math.max(var5, var6), Math.max(var5, var4), Math.max(var5, var1), Math.max(var5, var3));
         if (this.mLogEnabled) {
   ...
   protected void onDraw(Canvas var1) {
      ...
      if (this.mData != null) {
         ...
         if (this.mLogEnabled) {
            ...
            long var5 = this.totalTime + var2;
            this.totalTime = var5;
            long var7 = this.drawCycles + 1L;
            this.drawCycles = var7;
            var7 = var5 / var7;
            StringBuilder var9 = new StringBuilder();
            var9.append("Drawtime: ");
            var9.append(var2);
            var9.append(" ms, average: ");
            var9.append(var7);
            var9.append(" ms, cycles: ");
            var9.append(this.drawCycles);
            Log.i("MPAndroidChart", var9.toString());
         }
   ...
   protected void onSizeChanged(int var1, int var2, int var3, int var4) {
      ...
      if (this.mKeepPositionOnRotation) {
         var5[0] = this.mViewPortHandler.contentLeft();
