...
public class CandleDataSet extends LineScatterCandleRadarDataSet<CandleEntry> implements ICandleDataSet {
   ...
   protected void copy(CandleDataSet var1) {
      super.copy(var1);
      var1.mShadowWidth = this.mShadowWidth;
      var1.mShowCandleBar = this.mShowCandleBar;
      var1.mBarSpace = this.mBarSpace;
      var1.mShadowColorSameAsCandle = this.mShadowColorSameAsCandle;
      var1.mHighLightColor = this.mHighLightColor;
      var1.mIncreasingPaintStyle = this.mIncreasingPaintStyle;
      var1.mDecreasingPaintStyle = this.mDecreasingPaintStyle;
      var1.mNeutralColor = this.mNeutralColor;
      var1.mIncreasingColor = this.mIncreasingColor;
      var1.mDecreasingColor = this.mDecreasingColor;
      var1.mShadowColor = this.mShadowColor;
   }
