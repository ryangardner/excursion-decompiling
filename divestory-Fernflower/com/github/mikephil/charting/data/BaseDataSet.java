...
public abstract class BaseDataSet<T extends Entry> implements IDataSet<T> {
   ...
   protected void copy(BaseDataSet var1) {
      var1.mAxisDependency = this.mAxisDependency;
      var1.mColors = this.mColors;
      var1.mDrawIcons = this.mDrawIcons;
      var1.mDrawValues = this.mDrawValues;
      var1.mForm = this.mForm;
      var1.mFormLineDashEffect = this.mFormLineDashEffect;
      var1.mFormLineWidth = this.mFormLineWidth;
      var1.mFormSize = this.mFormSize;
      var1.mGradientColor = this.mGradientColor;
      var1.mGradientColors = this.mGradientColors;
      var1.mHighlightEnabled = this.mHighlightEnabled;
      var1.mIconsOffset = this.mIconsOffset;
      var1.mValueColors = this.mValueColors;
      var1.mValueFormatter = this.mValueFormatter;
      var1.mValueColors = this.mValueColors;
      var1.mValueTextSize = this.mValueTextSize;
      var1.mVisible = this.mVisible;
   }
   ...
   public int getColor(int var1) {
      List var2 = this.mColors;
      return (Integer)var2.get(var1 % var2.size());
   }
   ...
   public GradientColor getGradientColor(int var1) {
      List var2 = this.mGradientColors;
      return (GradientColor)var2.get(var1 % var2.size());
   }
   ...
   public void setGradientColor(int var1, int var2) {
      this.mGradientColor = new GradientColor(var1, var2);
   }

   public void setGradientColors(List<GradientColor> var1) {
      this.mGradientColors = var1;
   }
