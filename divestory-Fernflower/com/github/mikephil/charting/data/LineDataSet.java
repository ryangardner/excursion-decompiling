...
public class LineDataSet extends LineRadarDataSet<Entry> implements ILineDataSet {
   ...
   protected void copy(LineDataSet var1) {
      super.copy(var1);
      var1.mCircleColors = this.mCircleColors;
      var1.mCircleHoleColor = this.mCircleHoleColor;
      var1.mCircleHoleRadius = this.mCircleHoleRadius;
      var1.mCircleRadius = this.mCircleRadius;
      var1.mCubicIntensity = this.mCubicIntensity;
      var1.mDashPathEffect = this.mDashPathEffect;
      var1.mDrawCircleHole = this.mDrawCircleHole;
      var1.mDrawCircles = this.mDrawCircleHole;
      var1.mFillFormatter = this.mFillFormatter;
      var1.mMode = this.mMode;
   }
   ...
   public void setCircleHoleColor(int var1) {
      this.mCircleHoleColor = var1;
   }
   ...
   public static enum Mode {
      ...
      static {
         LineDataSet.Mode var0 = new LineDataSet.Mode("HORIZONTAL_BEZIER", 3);
         HORIZONTAL_BEZIER = var0;
      }
   }
}
