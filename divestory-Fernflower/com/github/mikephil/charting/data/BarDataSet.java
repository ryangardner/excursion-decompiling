...
public class BarDataSet extends BarLineScatterCandleBubbleDataSet<BarEntry> implements IBarDataSet {
   ...
   protected void copy(BarDataSet var1) {
      super.copy(var1);
      var1.mStackSize = this.mStackSize;
      var1.mBarShadowColor = this.mBarShadowColor;
      var1.mBarBorderWidth = this.mBarBorderWidth;
      var1.mStackLabels = this.mStackLabels;
      var1.mHighLightAlpha = this.mHighLightAlpha;
   }
