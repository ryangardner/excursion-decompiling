...
public abstract class LineScatterCandleRadarDataSet<T extends Entry> extends BarLineScatterCandleBubbleDataSet<T> implements ILineScatterCandleRadarDataSet<T> {
   ...
   protected void copy(LineScatterCandleRadarDataSet var1) {
      super.copy(var1);
      var1.mDrawHorizontalHighlightIndicator = this.mDrawHorizontalHighlightIndicator;
      var1.mDrawVerticalHighlightIndicator = this.mDrawVerticalHighlightIndicator;
      var1.mHighlightLineWidth = this.mHighlightLineWidth;
      var1.mHighlightDashPathEffect = this.mHighlightDashPathEffect;
   }
