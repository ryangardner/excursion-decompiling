...
public class PieDataSet extends DataSet<PieEntry> implements IPieDataSet {
   ...
   protected void copy(PieDataSet var1) {
      super.copy(var1);
   }
   ...
   public void setUsingSliceColorAsValueLineColor(boolean var1) {
      this.mUsingSliceColorAsValueLineColor = var1;
   }
   ...
   public static enum ValuePosition {
      ...
      static {
         PieDataSet.ValuePosition var0 = new PieDataSet.ValuePosition("OUTSIDE_SLICE", 1);
         OUTSIDE_SLICE = var0;
      }
   }
}
