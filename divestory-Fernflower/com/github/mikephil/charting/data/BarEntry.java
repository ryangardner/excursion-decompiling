...
public class BarEntry extends Entry {
   ...
   protected void calcRanges() {
      ...
      if (var1 != null && var1.length != 0) {
         ...
         while(true) {
            ...
            if (var6 < 0.0F) {
               var6 = var2 - var6;
               var5[var3] = new Range(var2, var6);
               var2 = var6;
            } else {
               var6 += var4;
               var5[var3] = new Range(var4, var6);
               var4 = var6;
            }
   ...
   public float getSumBelow(int var1) {
      ...
      if (var2 == null) {
         ...
         for(int var4 = var2.length - 1; var4 > var1 && var4 >= 0; --var4) {
