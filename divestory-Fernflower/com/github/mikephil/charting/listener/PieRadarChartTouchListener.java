...
public class PieRadarChartTouchListener extends ChartTouchListener<PieRadarChartBase<?>> {
   ...
   private float calculateVelocity() {
      if (this._velocitySamples.isEmpty()) {
         ...
         var1 = this._velocitySamples;
         PieRadarChartTouchListener.AngularVelocitySample var4 = (PieRadarChartTouchListener.AngularVelocitySample)var1.get(var1.size() - 1);
            ...
            if (var5 != 0) {
               if (var5 != 1) {
                  ...
                  if (((PieRadarChartBase)this.mChart).isDragDecelerationEnabled()) {
                     this.stopDeceleration();
                     this.sampleVelocity(var3, var4);
                     var4 = this.calculateVelocity();
                     this.mDecelerationAngularVelocity = var4;
                     if (var4 != 0.0F) {
