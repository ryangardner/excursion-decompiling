...
public class BarLineChartTouchListener extends ChartTouchListener<BarLineChartBase<? extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>>> {
      ...
      if (var1.getPointerCount() >= 2) {
         ...
         if (var3 > this.mMinScalePointerDistance) {
            ...
            if (var6 == 4) {
               ...
               if (var12 || var11) {
                  this.mMatrix.set(this.mSavedMatrix);
                  this.mMatrix.postScale(var13, var10, var4.x, var4.y);
                  if (var2 != null) {
                     var2.onChartScale(var1, var13, var10);
                  }
               }
   ...
   public void computeScroll() {
      ...
      if (var1 != 0.0F || this.mDecelerationVelocity.y != 0.0F) {
         ...
         float var6 = (float)(var3 - this.mDecelerationLastTime) / 1000.0F;
         var1 = this.mDecelerationVelocity.x;
         ...
         if (var5 != 0) {
            ...
            if (var5 != 1) {
               if (var5 != 2) {
                  ...
                  ((BarLineChartBase)this.mChart).disableScroll();
                  boolean var7 = ((BarLineChartBase)this.mChart).isDragXEnabled();
                  var8 = 0.0F;
                  if (var7) {
                     var6 = var2.getX() - this.mTouchStartPoint.x;
                  } else {
                     var6 = 0.0F;
                  }

                  if (((BarLineChartBase)this.mChart).isDragYEnabled()) {
                     var8 = var2.getY() - this.mTouchStartPoint.y;
                  }

                  this.performDrag(var2, var6, var8);
                  ...
                  if (this.mTouchMode == 0 && Math.abs(distance(var2.getX(), this.mTouchStartPoint.x, var2.getY(), this.mTouchStartPoint.y)) > this.mDragTriggerDist && ((BarLineChartBase)this.mChart).isDragEnabled()) {
                     ...
                     if (var11) {
                        var6 = Math.abs(var2.getX() - this.mTouchStartPoint.x);
                        var8 = Math.abs(var2.getY() - this.mTouchStartPoint.y);
                        if ((((BarLineChartBase)this.mChart).isDragXEnabled() || var8 >= var6) && (((BarLineChartBase)this.mChart).isDragYEnabled() || var8 <= var6)) {
                           this.mLastGesture = ChartTouchListener.ChartGesture.DRAG;
                           this.mTouchMode = 1;
                        }
               ...
               var6 = var9.getYVelocity(var12);
               var8 = var9.getXVelocity(var12);
               if ((Math.abs(var8) > (float)Utils.getMinimumFlingVelocity() || Math.abs(var6) > (float)Utils.getMinimumFlingVelocity()) && this.mTouchMode == 1 && ((BarLineChartBase)this.mChart).isDragDecelerationEnabled()) {
                  this.stopDeceleration();
                  ...
                  this.mDecelerationVelocity.y = var6;
                  Utils.postInvalidateOnAnimation(this.mChart);
               }
