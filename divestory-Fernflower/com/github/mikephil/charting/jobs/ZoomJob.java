...
public class ZoomJob extends ViewPortJob {
   ...
   static {
      ObjectPool var0 = ObjectPool.create(1, new ZoomJob((ViewPortHandler)null, 0.0F, 0.0F, 0.0F, 0.0F, (Transformer)null, (YAxis.AxisDependency)null, (View)null));
      pool = var0;
      var0.setReplenishPercentage(0.5F);
   }
