...
public abstract class AxisBase extends ComponentBase {
   ...
   public String getFormattedLabel(int var1) {
      return var1 >= 0 && var1 < this.mEntries.length ? this.getValueFormatter().getAxisLabel(this.mEntries[var1], this) : "";
   }
   ...
   public ValueFormatter getValueFormatter() {
      ValueFormatter var1 = this.mAxisValueFormatter;
      if (var1 == null || var1 instanceof DefaultAxisValueFormatter && ((DefaultAxisValueFormatter)var1).getDecimalDigits() != this.mDecimals) {
   ...
   public void setDrawGridLinesBehindData(boolean var1) {
      this.mDrawGridLinesBehindData = var1;
   }
