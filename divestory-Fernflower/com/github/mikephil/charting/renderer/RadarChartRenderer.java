...
public class RadarChartRenderer extends LineRadarRenderer {
   ...
   public void drawData(Canvas var1) {
      ...
      Iterator var4 = var2.getDataSets().iterator();

      while(var4.hasNext()) {
         IRadarDataSet var5 = (IRadarDataSet)var4.next();
         if (var5.isVisible()) {
            this.drawDataSet(var1, var5, var3);
         }
      }
   ...
   public void drawValues(Canvas var1) {
      ...
      for(int var10 = 0; var10 < ((RadarData)this.mChart.getData()).getDataSetCount(); ++var10) {
         ...
         if (this.shouldDrawValues(var11)) {
            ...
            ValueFormatter var12 = var11.getValueFormatter();
            MPPointF var13 = MPPointF.getInstance(var11.getIconsOffset());
            ...
            for(int var14 = 0; var14 < var11.getEntryCount(); ++var14) {
               ...
               float var17 = this.mChart.getYChartMin();
               float var18 = (float)var14 * var4 * var2;
               Utils.getPosition(var6, (var16 - var17) * var5 * var3, var18 + this.mChart.getRotationAngle(), var7);
               if (var11.isDrawValuesEnabled()) {
                  this.drawValue(var1, var12.getRadarLabel(var15), var7.x, var7.y - var9, var11.getValueTextColor(var14));
               }

               if (var15.getIcon() != null && var11.isDrawIconsEnabled()) {
                  Drawable var19 = var15.getIcon();
                  Utils.getPosition(var6, var15.getY() * var5 * var3 + var13.y, var18 + this.mChart.getRotationAngle(), var8);
                  var8.y += var13.x;
                  Utils.drawImage(var1, var19, (int)var8.x, (int)var8.y, var19.getIntrinsicWidth(), var19.getIntrinsicHeight());
               }
            }
   ...
   protected void drawWeb(Canvas var1) {
      ...
      int var9;
      for(var9 = 0; var9 < var7; var9 += var6 + 1) {
      ...
      for(var9 = 0; var9 < var7; ++var9) {
         ...
         while(var6 < ((RadarData)this.mChart.getData()).getEntryCount()) {
            ...
            var1.drawLine(var8.x, var8.y, var10.x, var10.y, this.mWebPaint);
         }
      }
