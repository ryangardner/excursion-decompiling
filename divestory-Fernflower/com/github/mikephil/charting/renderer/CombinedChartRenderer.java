   ...
   public void drawHighlighted(Canvas var1, Highlight[] var2) {
      ...
      if (var3 != null) {
         ...
         while(var4.hasNext()) {
            ...
            List var11 = this.mHighlightBuffer;
            var5.drawHighlighted(var1, (Highlight[])var11.toArray(new Highlight[var11.size()]));
         }
