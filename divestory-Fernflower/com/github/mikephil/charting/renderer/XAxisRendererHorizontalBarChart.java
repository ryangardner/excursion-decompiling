...
public class XAxisRendererHorizontalBarChart extends XAxisRenderer {
   ...
   protected void drawLabels(Canvas var1, float var2, MPPointF var3) {
      ...
      for(var8 = 0; var8 < var6; var8 += 2) {
         if (var5) {
            var7[var8 + 1] = this.mXAxis.mCenteredEntries[var8 / 2];
         } else {
            var7[var8 + 1] = this.mXAxis.mEntries[var8 / 2];
         }
      }
      ...
      for(var8 = 0; var8 < var6; var8 += 2) {
         float var9 = var7[var8 + 1];
         if (this.mViewPortHandler.isInBoundsY(var9)) {
            this.drawLabel(var1, this.mXAxis.getValueFormatter().getAxisLabel(this.mXAxis.mEntries[var8 / 2], this.mXAxis), var2, var9, var3, var4);
         }
      }
