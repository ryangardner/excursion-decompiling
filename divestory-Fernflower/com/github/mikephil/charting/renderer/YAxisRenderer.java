   ...
   public void renderAxisLabels(Canvas var1) {
      if (this.mYAxis.isEnabled() && this.mYAxis.isDrawLabelsEnabled()) {
         ...
         label26: {
            float var3;
            label25: {
               var2 = this.getTransformedPositions();
               this.mAxisLabelPaint.setTypeface(this.mYAxis.getTypeface());
               this.mAxisLabelPaint.setTextSize(this.mYAxis.getTextSize());
               this.mAxisLabelPaint.setColor(this.mYAxis.getTextColor());
               var3 = this.mYAxis.getXOffset();
               var4 = (float)Utils.calcTextHeight(this.mAxisLabelPaint, "A") / 2.5F;
               var5 = this.mYAxis.getYOffset();
               ...
               if (var6 == YAxis.AxisDependency.LEFT) {
                  if (var7 != YAxis.YAxisLabelPosition.OUTSIDE_CHART) {
                     ...
                     var8 = this.mViewPortHandler.offsetLeft();
                     break label25;
                  }
                  ...
                  if (var7 == YAxis.YAxisLabelPosition.OUTSIDE_CHART) {
                     this.mAxisLabelPaint.setTextAlign(Align.LEFT);
                     var8 = this.mViewPortHandler.contentRight();
                     break label25;
                  }
         ...
         this.drawYLabels(var1, var8, var2, var4 + var5);
      }
