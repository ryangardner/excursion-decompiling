   ...
   protected List<Highlight> buildHighlights(IDataSet var1, int var2, float var3, DataSet.Rounding var4) {
      ...
      if (var7.size() == 0) {
         ...
         while(var9.hasNext()) {
            ...
            MPPointD var10 = this.mChart.getTransformer(var1.getAxisDependency()).getPixelForValues(var11.getX(), var11.getY());
            var5.add(new Highlight(var11.getX(), var11.getY(), (float)var10.x, (float)var10.y, var2, var1.getAxisDependency()));
         }
