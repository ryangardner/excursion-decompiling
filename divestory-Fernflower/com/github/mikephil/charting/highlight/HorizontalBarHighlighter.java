   ...
   protected List<Highlight> buildHighlights(IDataSet var1, int var2, float var3, DataSet.Rounding var4) {
      ...
      if (var7.size() == 0) {
         ...
         while(var10.hasNext()) {
            ...
            MPPointD var9 = ((BarDataProvider)this.mChart).getTransformer(var1.getAxisDependency()).getPixelForValues(var11.getY(), var11.getX());
            var5.add(new Highlight(var11.getX(), var11.getY(), (float)var9.x, (float)var9.y, var2, var1.getAxisDependency()));
         }
