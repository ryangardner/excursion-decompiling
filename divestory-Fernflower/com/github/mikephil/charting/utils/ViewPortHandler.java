...
public class ViewPortHandler {
   ...
   public boolean isFullyZoomedOutX() {
      float var1 = this.mScaleX;
      float var2 = this.mMinScaleX;
      boolean var3;
      if (var1 <= var2 && var2 <= 1.0F) {
         var3 = true;
      } else {
         var3 = false;
      }
   ...
   public boolean isFullyZoomedOutY() {
      float var1 = this.mScaleY;
      float var2 = this.mMinScaleY;
      boolean var3;
      if (var1 <= var2 && var2 <= 1.0F) {
         var3 = true;
      } else {
   ...
   public void limitTransAndScale(Matrix var1, RectF var2) {
      ...
      float[] var3 = this.matrixBuffer;
      float var4 = var3[2];
      float var5 = var3[0];
      float var6 = var3[5];
      float var7 = var3[4];
      this.mScaleX = Math.min(Math.max(this.mMinScaleX, var5), this.mMaxScaleX);
      this.mScaleY = Math.min(Math.max(this.mMinScaleY, var7), this.mMaxScaleY);
      var5 = 0.0F;
      if (var2 != null) {
         var5 = var2.width();
         var7 = var2.height();
      ...
      this.mTransX = Math.min(Math.max(var4, -var5 * (this.mScaleX - 1.0F) - this.mTransOffsetX), this.mTransOffsetX);
      var5 = Math.max(Math.min(var6, var7 * (this.mScaleY - 1.0F) + this.mTransOffsetY), -this.mTransOffsetY);
      this.mTransY = var5;
      float[] var8 = this.matrixBuffer;
      var8[2] = this.mTransX;
      var8[0] = this.mScaleX;
      var8[5] = var5;
      var8[4] = this.mScaleY;
