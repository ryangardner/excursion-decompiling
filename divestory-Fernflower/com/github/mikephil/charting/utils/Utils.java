...
public abstract class Utils {
   ...
   public static float convertDpToPixel(float var0) {
      DisplayMetrics var1 = mMetrics;
      if (var1 == null) {
         Log.e("MPChartLib-Utils", "Utils NOT INITIALIZED. You need to call Utils.init(...) at least once before calling Utils.convertDpToPixel(...). Otherwise conversion does not take place.");
         return var0;
      } else {
         return var0 * var1.density;
      }
   }
   ...
   public static String[] convertStrings(List<String> var0) {
      ...
      for(int var3 = 0; var3 < var1; ++var3) {
         var2[var3] = (String)var0.get(var3);
      }
   ...
   public static String formatNumber(float var0, int var1, boolean var2, char var3) {
      ...
      if (var0 == 0.0F) {
         ...
         long var10 = (long)Math.round(var0 * (float)POW_10[var9]);
         var1 = 34;
         boolean var12 = false;

         while(true) {
            while(var10 != 0L || var5 < var9 + 1) {
               int var13 = (int)(var10 % 10L);
               var10 /= 10L;
               int var14 = var1 - 1;
               var4[var1] = (char)((char)(var13 + 48));
               ++var5;
               if (var5 == var9) {
                  var1 = var14 - 1;
                  var4[var14] = (char)44;
                  ...
                  label59: {
                     if (var2 && var10 != 0L && var5 > var9) {
                        if (var12) {
                           if ((var5 - var9) % 4 == 0) {
                              var1 = var14 - 1;
                              var4[var14] = (char)var3;
                              break label59;
                           }
                        } else if ((var5 - var9) % 4 == 3) {
                           var1 = var14 - 1;
                           var4[var14] = (char)var3;
                           break label59;
                        }
            ...
            var1 = 35 - var1;
            return String.valueOf(var4, var1, 35 - var1);
         }
      }
   }
