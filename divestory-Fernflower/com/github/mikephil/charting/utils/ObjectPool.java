...
public class ObjectPool<T extends ObjectPool.Poolable> {
   ...
   private void resizePool() {
      ...
      int var2 = var1 * 2;
      this.desiredCapacity = var2;
      Object[] var3 = new Object[var2];

      for(var2 = 0; var2 < var1; ++var2) {
         var3[var2] = this.objects[var2];
      }
      ...
      try {
         if (var1.currentOwnerId != ObjectPool.Poolable.NO_OWNER) {
            if (var1.currentOwnerId == this.poolId) {
               IllegalArgumentException var7 = new IllegalArgumentException("The object passed is already stored in this pool!");
               throw var7;
            }
         ...
         int var4 = this.objectsPointer + 1;
         this.objectsPointer = var4;
         if (var4 >= this.objects.length) {
            this.resizePool();
         }
   ...
   public void recycle(List<T> var1) {
      synchronized(this){}
