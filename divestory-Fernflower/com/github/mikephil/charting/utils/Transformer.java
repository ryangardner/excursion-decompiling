...
public class Transformer {
   ...
   public MPPointD getPixelForValues(float var1, float var2) {
      float[] var3 = this.ptsBuffer;
      var3[0] = var1;
      var3[1] = var2;
      this.pointValuesToPixel(var3);
      var3 = this.ptsBuffer;
      return MPPointD.getInstance((double)var3[0], (double)var3[1]);
   }
   ...
   public void getValuesByTouchPoint(float var1, float var2, MPPointD var3) {
      float[] var4 = this.ptsBuffer;
      var4[0] = var1;
      var4[1] = var2;
      this.pixelsToValue(var4);
