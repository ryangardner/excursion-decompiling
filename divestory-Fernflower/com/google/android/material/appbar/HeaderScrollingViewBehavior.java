   ...
   public boolean onMeasureChild(CoordinatorLayout var1, View var2, int var3, int var4, int var5, int var6) {
      ...
      if (var7 == -1 || var7 == -2) {
         ...
         if (var8 != null) {
            ...
            if (var9 > 0) {
               var5 = var9;
               if (ViewCompat.getFitsSystemWindows(var8)) {
                  WindowInsetsCompat var10 = var1.getLastWindowInsets();
                  var5 = var9;
                  if (var10 != null) {
                     var5 = var9 + var10.getSystemWindowInsetTop() + var10.getSystemWindowInsetBottom();
                  }
               }
            } else {
               var5 = var1.getHeight();
            ...
            var5 += this.getScrollRange(var8);
            var9 = var8.getMeasuredHeight();
            if (this.shouldHeaderOverlapScrollingChild()) {
               var2.setTranslationY((float)(-var9));
            } else {
               var5 -= var9;
            }
            ...
            var1.onMeasureChild(var2, var3, var4, MeasureSpec.makeMeasureSpec(var5, var9), var6);
            return true;
         }
      }
