...
public class BottomSheetDialog extends AppCompatDialog {
   ...
   private FrameLayout ensureContainerAndBehavior() {
      if (this.container == null) {
         FrameLayout var1 = (FrameLayout)View.inflate(this.getContext(), R.layout.design_bottom_sheet_dialog, (ViewGroup)null);
         this.container = var1;
         BottomSheetBehavior var2 = BottomSheetBehavior.from((FrameLayout)var1.findViewById(R.id.design_bottom_sheet));
         this.behavior = var2;
   ...
   private View wrapInBottomSheet(int var1, View var2, LayoutParams var3) {
      ...
      CoordinatorLayout var4 = (CoordinatorLayout)this.container.findViewById(R.id.coordinator);
      View var5 = var2;
      if (var1 != 0) {
         var5 = var2;
         if (var2 == null) {
            var5 = this.getLayoutInflater().inflate(var1, var4, false);
         }
      }

      FrameLayout var6 = (FrameLayout)this.container.findViewById(R.id.design_bottom_sheet);
      var6.removeAllViews();
      if (var3 == null) {
         var6.addView(var5);
      } else {
         var6.addView(var5, var3);
      }

      var4.findViewById(R.id.touch_outside).setOnClickListener(new OnClickListener() {
