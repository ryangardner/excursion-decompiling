...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
   ...
   public ExtendedFloatingActionButton(Context var1, AttributeSet var2) {
      this(var1, var2, R.attr.extendedFloatingActionButtonStyle);
   }
   ...
   public ExtendedFloatingActionButton(Context var1, AttributeSet var2, int var3) {
      ...
      this.showStrategy = new ExtendedFloatingActionButton.ShowStrategy(this.changeVisibilityTracker);
      ...
      this.behavior = new ExtendedFloatingActionButton.ExtendedFloatingActionButtonBehavior(var4, var2);
      TypedArray var10 = ThemeEnforcement.obtainStyledAttributes(var4, var2, R.styleable.ExtendedFloatingActionButton, var3, DEF_STYLE_RES);
      MotionSpec var5 = MotionSpec.createFromAttribute(var4, var10, R.styleable.ExtendedFloatingActionButton_showMotionSpec);
      MotionSpec var6 = MotionSpec.createFromAttribute(var4, var10, R.styleable.ExtendedFloatingActionButton_hideMotionSpec);
      MotionSpec var7 = MotionSpec.createFromAttribute(var4, var10, R.styleable.ExtendedFloatingActionButton_extendMotionSpec);
      MotionSpec var8 = MotionSpec.createFromAttribute(var4, var10, R.styleable.ExtendedFloatingActionButton_shrinkMotionSpec);
      ...
      this.shrinkStrategy = new ExtendedFloatingActionButton.ChangeSizeStrategy(var9, new ExtendedFloatingActionButton.Size() {
         ...
         public LayoutParams getLayoutParams() {
            return new LayoutParams(this.getWidth(), this.getHeight());
         }
      ...
      var10.recycle();
      this.setShapeAppearanceModel(ShapeAppearanceModel.builder(var4, var2, var3, DEF_STYLE_RES, ShapeAppearanceModel.PILL).build());
   }
   ...
   class ChangeSizeStrategy extends BaseMotionStrategy {
      ...
      public void onAnimationEnd() {
         ...
         if (var1 != null) {
            var1.width = this.size.getLayoutParams().width;
            var1.height = this.size.getLayoutParams().height;
         }
      }
   ...
   protected static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.Behavior<T> {
      ...
      public ExtendedFloatingActionButtonBehavior(Context var1, AttributeSet var2) {
         super(var1, var2);
         TypedArray var3 = var1.obtainStyledAttributes(var2, R.styleable.ExtendedFloatingActionButton_Behavior_Layout);
         this.autoHideEnabled = var3.getBoolean(R.styleable.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoHide, false);
         this.autoShrinkEnabled = var3.getBoolean(R.styleable.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoShrink, true);
         var3.recycle();
      }
      ...
      public boolean getInsetDodgeRect(CoordinatorLayout var1, ExtendedFloatingActionButton var2, Rect var3) {
         return super.getInsetDodgeRect(var1, var2, var3);
      }
