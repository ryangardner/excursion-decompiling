...
class FloatingActionButtonImpl {
   ...
   private ArrayList<FloatingActionButtonImpl.InternalTransformationCallback> transformationCallbacks;
   ...
   private void calculateImageMatrixFromScale(float var1, Matrix var2) {
      ...
      if (var3 != null && this.maxImageSize != 0) {
         ...
         int var6 = this.maxImageSize;
         var5.set(0.0F, 0.0F, (float)var6, (float)var6);
         var2.setRectToRect(var4, var5, ScaleToFit.CENTER);
         var6 = this.maxImageSize;
         var2.postScale(var1, var1, (float)var6 / 2.0F, (float)var6 / 2.0F);
      }
   ...
   private void workAroundOreoBug(ObjectAnimator var1) {
      if (VERSION.SDK_INT == 26) {
         var1.setEvaluator(new TypeEvaluator<Float>() {
            FloatEvaluator floatEvaluator = new FloatEvaluator();

            public Float evaluate(float var1, Float var2, Float var3) {
               float var4 = this.floatEvaluator.evaluate(var1, var2, var3);
               var1 = var4;
               if (var4 < 0.1F) {
                  var1 = 0.0F;
               }
   ...
   void getPadding(Rect var1) {
      ...
      if (this.ensureMinTouchTargetSize) {
         var2 = (this.minTouchTargetSize - this.view.getSizeDimension()) / 2;
      } else {
         var2 = 0;
      }
      ...
      if (this.shadowPaddingEnabled) {
         var3 = this.getElevation() + this.pressedTranslationZ;
      } else {
         var3 = 0.0F;
      }

      int var4 = Math.max(var2, (int)Math.ceil((double)var3));
      var2 = Math.max(var2, (int)Math.ceil((double)(var3 * 1.5F)));
      var1.set(var4, var2, var4, var2);
   }
      ...
      if (!this.isOrWillBeHidden()) {
         ...
         if (this.shouldAnimateVisibilityChange()) {
            ...
            if (var5 != null) {
               ...
               while(var6.hasNext()) {
                  var8.addListener((AnimatorListener)var6.next());
               }
            }

            var8.start();
         } else {
            FloatingActionButton var9 = this.view;
            byte var4;
            if (var2) {
               var4 = 8;
            } else {
            ...
            var9.internalSetVisibility(var4, var2);
            if (var1 != null) {
               var1.onHidden();
            }
         }
