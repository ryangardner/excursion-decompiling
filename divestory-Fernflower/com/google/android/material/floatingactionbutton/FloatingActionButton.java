...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
   ...
   public FloatingActionButton(Context var1, AttributeSet var2, int var3) {
      ...
      TypedArray var5 = ThemeEnforcement.obtainStyledAttributes(var4, var2, R.styleable.FloatingActionButton, var3, DEF_STYLE_RES);
      this.backgroundTint = MaterialResources.getColorStateList(var4, var5, R.styleable.FloatingActionButton_backgroundTint);
      this.backgroundTintMode = ViewUtils.parseTintMode(var5.getInt(R.styleable.FloatingActionButton_backgroundTintMode, -1), (Mode)null);
      this.rippleColor = MaterialResources.getColorStateList(var4, var5, R.styleable.FloatingActionButton_rippleColor);
      this.size = var5.getInt(R.styleable.FloatingActionButton_fabSize, -1);
      this.customSize = var5.getDimensionPixelSize(R.styleable.FloatingActionButton_fabCustomSize, 0);
      this.borderWidth = var5.getDimensionPixelSize(R.styleable.FloatingActionButton_borderWidth, 0);
      float var6 = var5.getDimension(R.styleable.FloatingActionButton_elevation, 0.0F);
      float var7 = var5.getDimension(R.styleable.FloatingActionButton_hoveredFocusedTranslationZ, 0.0F);
      float var8 = var5.getDimension(R.styleable.FloatingActionButton_pressedTranslationZ, 0.0F);
      this.compatPadding = var5.getBoolean(R.styleable.FloatingActionButton_useCompatPadding, false);
      int var9 = this.getResources().getDimensionPixelSize(R.dimen.mtrl_fab_min_touch_target);
      this.maxImageSize = var5.getDimensionPixelSize(R.styleable.FloatingActionButton_maxImageSize, 0);
      MotionSpec var10 = MotionSpec.createFromAttribute(var4, var5, R.styleable.FloatingActionButton_showMotionSpec);
      MotionSpec var12 = MotionSpec.createFromAttribute(var4, var5, R.styleable.FloatingActionButton_hideMotionSpec);
      ShapeAppearanceModel var13 = ShapeAppearanceModel.builder(var4, var2, var3, DEF_STYLE_RES, ShapeAppearanceModel.PILL).build();
      boolean var11 = var5.getBoolean(R.styleable.FloatingActionButton_ensureMinTouchTargetSize, false);
      this.setEnabled(var5.getBoolean(R.styleable.FloatingActionButton_android_enabled, true));
      var5.recycle();
      AppCompatImageHelper var14 = new AppCompatImageHelper(this);
      this.imageHelper = var14;
      var14.loadFromAttributes(var2, var3);
      ...
      this.getImpl().setMinTouchTargetSize(var9);
      this.getImpl().setElevation(var6);
      this.getImpl().setHoveredFocusedTranslationZ(var7);
      this.getImpl().setPressedTranslationZ(var8);
      this.getImpl().setMaxImageSize(this.maxImageSize);
      this.getImpl().setShowMotionSpec(var10);
      this.getImpl().setHideMotionSpec(var12);
      this.getImpl().setEnsureMinTouchTargetSize(var11);
   ...
   private void onApplySupportImageTint() {
      ...
      if (var1 != null) {
         ...
         if (var2 == null) {
            ...
            int var3 = var2.getColorForState(this.getDrawableState(), 0);
            Mode var4 = this.imageMode;
            Mode var5 = var4;
            if (var4 == null) {
               var5 = Mode.SRC_IN;
            }

            var1.mutate().setColorFilter(AppCompatDrawableManager.getPorterDuffColorFilter(var3, var5));
         }
      }
   }
   ...
   public void addTransformationCallback(TransformationCallback<? extends FloatingActionButton> var1) {
   ...
   protected Parcelable onSaveInstanceState() {
      ...
      ExtendableSavedState var3 = new ExtendableSavedState((Parcelable)var2);
   ...
   public void removeTransformationCallback(TransformationCallback<? extends FloatingActionButton> var1) {
   ...
   private class ShadowDelegateImpl implements ShadowViewDelegate {
      ...
      public void setShadowPadding(int var1, int var2, int var3, int var4) {
         ...
         var5.setPadding(var1 + var5.imagePadding, var2 + FloatingActionButton.this.imagePadding, var3 + FloatingActionButton.this.imagePadding, var4 + FloatingActionButton.this.imagePadding);
      }
   }
   ...
   class TransformationCallbackWrapper<T extends FloatingActionButton> implements FloatingActionButtonImpl.InternalTransformationCallback {
      ...
      TransformationCallbackWrapper(TransformationCallback<T> var2) {
         this.listener = var2;
      }

      public boolean equals(Object var1) {
         boolean var2;
         if (var1 instanceof FloatingActionButton.TransformationCallbackWrapper && ((FloatingActionButton.TransformationCallbackWrapper)var1).listener.equals(this.listener)) {
            var2 = true;
         } else {
            var2 = false;
         }
