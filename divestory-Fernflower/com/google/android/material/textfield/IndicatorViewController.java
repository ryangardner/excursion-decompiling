...
final class IndicatorViewController {
   ...
   private void createCaptionAnimators(List<Animator> var1, boolean var2, TextView var3, int var4, int var5, int var6) {
   ...
   void addIndicator(TextView var1, int var2) {
      ...
      if (this.indicatorArea == null && this.captionArea == null) {
         ...
         var4 = new LayoutParams(0, -2, 1.0F);
         this.indicatorArea.addView(this.captionArea, var4);
      ...
      if (this.isCaptionView(var2)) {
         ...
         this.indicatorArea.addView(var1, var4);
      }
   ...
   void setErrorContentDescription(CharSequence var1) {
      this.errorViewContentDescription = var1;
