...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
   ...
   DropdownMenuEndIconDelegate(TextInputLayout var1) {
      ...
      this.endIconChangedListener = new TextInputLayout.OnEndIconChangedListener() {
         public void onEndIconChanged(TextInputLayout var1, int var2) {
            AutoCompleteTextView var3 = (AutoCompleteTextView)var1.getEditText();
            if (var3 != null && var2 == 3) {
               var3.removeTextChangedListener(DropdownMenuEndIconDelegate.this.exposedDropdownEndIconTextWatcher);
               if (var3.getOnFocusChangeListener() == DropdownMenuEndIconDelegate.this.onFocusChangeListener) {
                  var3.setOnFocusChangeListener((OnFocusChangeListener)null);
               }

               var3.setOnTouchListener((OnTouchListener)null);
   ...
   private void addRippleEffect(AutoCompleteTextView var1) {
      if (var1.getKeyListener() == null) {
         ...
         MaterialShapeDrawable var3 = this.textInputLayout.getBoxBackground();
         int var4 = MaterialColors.getColor(var1, R.attr.colorControlHighlight);
         int[][] var5 = new int[][]{{16842919}, new int[0]};
         if (var2 == 2) {
            this.addRippleEffectOnOutlinedLayout(var1, var4, var5, var3);
         } else if (var2 == 1) {
            this.addRippleEffectOnFilledLayout(var1, var4, var5, var3);
         }
   ...
   private void addRippleEffectOnFilledLayout(AutoCompleteTextView var1, int var2, int[][] var3, MaterialShapeDrawable var4) {
      ...
      int[] var6 = new int[]{var2, var5};
      if (IS_LOLLIPOP) {
         ViewCompat.setBackground(var1, new RippleDrawable(new ColorStateList(var3, var6), var4, var4));
      } else {
         MaterialShapeDrawable var7 = new MaterialShapeDrawable(var4.getShapeAppearanceModel());
         var7.setFillColor(new ColorStateList(var3, var6));
         LayerDrawable var10 = new LayerDrawable(new Drawable[]{var4, var7});
         int var8 = ViewCompat.getPaddingStart(var1);
         int var9 = var1.getPaddingTop();
         var5 = ViewCompat.getPaddingEnd(var1);
         var2 = var1.getPaddingBottom();
         ViewCompat.setBackground(var1, var10);
         ViewCompat.setPaddingRelative(var1, var8, var9, var5, var2);
      }

   }

   private void addRippleEffectOnOutlinedLayout(AutoCompleteTextView var1, int var2, int[][] var3, MaterialShapeDrawable var4) {
      int var5 = MaterialColors.getColor(var1, R.attr.colorSurface);
   ...
   private void setUpDropdownShowHideBehavior(final AutoCompleteTextView var1) {
      ...
      var1.setOnFocusChangeListener(this.onFocusChangeListener);
      if (IS_LOLLIPOP) {
   ...
   void initialize() {
      float var1 = (float)this.context.getResources().getDimensionPixelOffset(R.dimen.mtrl_shape_corner_size_small_component);
      float var2 = (float)this.context.getResources().getDimensionPixelOffset(R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
      int var3 = this.context.getResources().getDimensionPixelOffset(R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
      ...
      if (IS_LOLLIPOP) {
         var3 = R.drawable.mtrl_dropdown_arrow;
      } else {
         var3 = R.drawable.mtrl_ic_arrow_drop_down;
      }
