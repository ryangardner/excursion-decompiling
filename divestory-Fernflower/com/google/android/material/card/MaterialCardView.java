...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
   ...
   public MaterialCardView(Context var1, AttributeSet var2, int var3) {
      ...
      TypedArray var4 = ThemeEnforcement.obtainStyledAttributes(this.getContext(), var2, R.styleable.MaterialCardView, var3, DEF_STYLE_RES);
   ...
   private RectF getBoundsAsRectF() {
      ...
      var1.set(this.cardViewHelper.getBackground().getBounds());
      return var1;
   }
   ...
   public void onInitializeAccessibilityEvent(AccessibilityEvent var1) {
      ...
      var1.setClassName("androidx.cardview.widget.CardView");
   ...
   public void setCardForegroundColor(ColorStateList var1) {
      this.cardViewHelper.setCardForegroundColor(var1);
   }
   ...
   public void setClickable(boolean var1) {
      ...
      MaterialCardViewHelper var2 = this.cardViewHelper;
      if (var2 != null) {
         var2.updateClickable();
      }
   ...
   public void setShapeAppearanceModel(ShapeAppearanceModel var1) {
      if (VERSION.SDK_INT >= 21) {
         this.setClipToOutline(var1.isRoundRect(this.getBoundsAsRectF()));
      }
