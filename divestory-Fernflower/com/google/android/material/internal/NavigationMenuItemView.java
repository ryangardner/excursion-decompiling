...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
   ...
   public NavigationMenuItemView(Context var1, AttributeSet var2, int var3) {
      ...
      this.setIconSize(var1.getResources().getDimensionPixelSize(R.dimen.design_navigation_icon_size));
      CheckedTextView var4 = (CheckedTextView)this.findViewById(R.id.design_menu_item_text);
      this.textView = var4;
   ...
   private StateListDrawable createDefaultBackground() {
      ...
      if (this.getContext().getTheme().resolveAttribute(androidx.appcompat.R.attr.colorControlHighlight, var1, true)) {
   ...
   public void setIcon(Drawable var1) {
      ...
      if (var1 != null) {
         ...
         if (this.emptyDrawable == null) {
            var1 = ResourcesCompat.getDrawable(this.getResources(), R.drawable.navigation_empty_icon, this.getContext().getTheme());
            this.emptyDrawable = var1;
            if (var1 != null) {
               var3 = this.iconSize;
               var1.setBounds(0, 0, var3, var3);
            }
         }
