...
public class ForegroundLinearLayout extends LinearLayoutCompat {
   ...
   public ForegroundLinearLayout(Context var1, AttributeSet var2, int var3) {
      ...
      TypedArray var5 = ThemeEnforcement.obtainStyledAttributes(var1, var2, R.styleable.ForegroundLinearLayout, var3, 0);
      this.foregroundGravity = var5.getInt(R.styleable.ForegroundLinearLayout_android_foregroundGravity, this.foregroundGravity);
