...
public class SwitchMaterial extends SwitchCompat {
   ...
   public SwitchMaterial(Context var1, AttributeSet var2, int var3) {
      ...
      TypedArray var4 = ThemeEnforcement.obtainStyledAttributes(var1, var2, R.styleable.SwitchMaterial, var3, DEF_STYLE_RES);
      this.useMaterialThemeColors = var4.getBoolean(R.styleable.SwitchMaterial_useMaterialThemeColors, false);
      var4.recycle();
   }

   private ColorStateList getMaterialThemeColorsThumbTintList() {
      if (this.materialThemeColorsThumbTintList == null) {
         int var1 = MaterialColors.getColor(this, R.attr.colorSurface);
         int var2 = MaterialColors.getColor(this, R.attr.colorControlActivated);
         float var3 = this.getResources().getDimension(R.dimen.mtrl_switch_thumb_elevation);
         float var4 = var3;
         if (this.elevationOverlayProvider.isThemeElevationOverlayEnabled()) {
            var4 = var3 + ViewUtils.getParentAbsoluteElevation(this);
         }

         int var5 = this.elevationOverlayProvider.compositeOverlayIfNeeded(var1, var4);
         int[] var6 = new int[ENABLED_CHECKED_STATES.length];
         var6[0] = MaterialColors.layer(var1, var2, 1.0F);
         var6[1] = var5;
         var6[2] = MaterialColors.layer(var1, var2, 0.38F);
         var6[3] = var5;
   ...
   private ColorStateList getMaterialThemeColorsTrackTintList() {
      if (this.materialThemeColorsTrackTintList == null) {
         ...
         int var2 = MaterialColors.getColor(this, R.attr.colorSurface);
         int var3 = MaterialColors.getColor(this, R.attr.colorControlActivated);
         int var4 = MaterialColors.getColor(this, R.attr.colorOnSurface);
         var1[0] = MaterialColors.layer(var2, var3, 0.54F);
         var1[1] = MaterialColors.layer(var2, var4, 0.32F);
         var1[2] = MaterialColors.layer(var2, var3, 0.12F);
         var1[3] = MaterialColors.layer(var2, var4, 0.12F);
         this.materialThemeColorsTrackTintList = new ColorStateList(ENABLED_CHECKED_STATES, var1);
      }
