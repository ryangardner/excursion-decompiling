...
public final class MaterialContainerTransform extends Transition {
   ...
   private static final class TransitionDrawable extends Drawable {
      ...
      private TransitionDrawable(PathMotion var1, View var2, RectF var3, ShapeAppearanceModel var4, float var5, View var6, RectF var7, ShapeAppearanceModel var8, float var9, int var10, int var11, int var12, int var13, boolean var14, boolean var15, FadeModeEvaluator var16, FitModeEvaluator var17, MaterialContainerTransform.ProgressThresholdsGroup var18, boolean var19) {
         ...
         WindowManager var23 = (WindowManager)var2.getContext().getSystemService("window");
         DisplayMetrics var21 = new DisplayMetrics();
         var23.getDefaultDisplay().getMetrics(var21);
         this.displayWidth = (float)var21.widthPixels;
         this.displayHeight = (float)var21.heightPixels;
      ...
      private void updateProgress(float var1) {
         ...
         float var4 = var8[0];
         float var5 = var8[1];
         float var6 = (Float)Preconditions.checkNotNull(this.progressThresholds.scale.start);
         var3 = (Float)Preconditions.checkNotNull(this.progressThresholds.scale.end);
         FitModeResult var9 = this.fitModeEvaluator.evaluate(var1, var6, var3, this.startBounds.width(), this.startBounds.height(), this.endBounds.width(), this.endBounds.height());
         this.fitModeResult = var9;
         this.currentStartBounds.set(var4 - var9.currentStartWidth / 2.0F, var5, this.fitModeResult.currentStartWidth / 2.0F + var4, this.fitModeResult.currentStartHeight + var5);
         this.currentEndBounds.set(var4 - this.fitModeResult.currentEndWidth / 2.0F, var5, var4 + this.fitModeResult.currentEndWidth / 2.0F, this.fitModeResult.currentEndHeight + var5);
         this.currentStartBoundsMasked.set(this.currentStartBounds);
         this.currentEndBoundsMasked.set(this.currentEndBounds);
         var5 = (Float)Preconditions.checkNotNull(this.progressThresholds.scaleMask.start);
         var3 = (Float)Preconditions.checkNotNull(this.progressThresholds.scaleMask.end);
         ...
         var3 = TransitionUtils.lerp(0.0F, 1.0F, var5, var3, var1);
         if (!var7) {
            var3 = 1.0F - var3;
         }
         ...
         var6 = calculateElevationDxMultiplier(this.currentMaskBounds, this.displayWidth);
         var5 = calculateElevationDyMultiplier(this.currentMaskBounds, this.displayHeight);
         var3 = this.currentElevation;
         var6 = (float)((int)(var6 * var3));
         var5 = (float)((int)(var5 * var3));
         this.currentElevationDy = var5;
         this.shadowPaint.setShadowLayer(var3, var6, var5, 754974720);
         var5 = (Float)Preconditions.checkNotNull(this.progressThresholds.fade.start);
         var3 = (Float)Preconditions.checkNotNull(this.progressThresholds.fade.end);
         this.fadeModeResult = this.fadeModeEvaluator.evaluate(var1, var5, var3);
