...
class UtcDates {
   ...
   static Calendar getDayCopy(Calendar var0) {
      Calendar var1 = getUtcCalendarOf(var0);
      var0 = getUtcCalendar();
      var0.set(var1.get(1), var1.get(2), var1.get(5));
      return var0;
   }
   ...
   static String getTextInputHint(Resources var0, SimpleDateFormat var1) {
      ...
      String var2 = var0.getString(R.string.mtrl_picker_text_input_year_abbr);
      String var3 = var0.getString(R.string.mtrl_picker_text_input_month_abbr);
      return var4.replaceAll("d", var0.getString(R.string.mtrl_picker_text_input_day_abbr)).replaceAll("M", var3).replaceAll("y", var2);
   }

   static TimeSource getTimeSource() {
      TimeSource var0 = (TimeSource)timeSourceRef.get();
      TimeSource var1 = var0;
      if (var0 == null) {
         var1 = TimeSource.system();
      }
   ...
   static Calendar getTodayCalendar() {
      Calendar var0 = getTimeSource().now();
      var0.set(11, 0);
      var0.set(12, 0);
      var0.set(13, 0);
      var0.set(14, 0);
   ...
   private static SimpleDateFormat getYearMonthFormat(Locale var0) {
      return getSimpleFormat("LLLL, yyyy", var0);
   }
   ...
   private static String removeYearFromDateFormatPattern(String var0) {
      ...
      if (var1 >= var0.length()) {
         ...
         String var2 = "EMd";
         int var3 = findCharactersInDateFormatPattern(var0, "EMd", 1, var1);
         if (var3 < var0.length()) {
         ...
         return var0.replace(var0.substring(findCharactersInDateFormatPattern(var0, var2, -1, var1) + 1, var3), " ").trim();
      }
   }

   static void setTimeSource(TimeSource var0) {
      timeSourceRef.set(var0);
   }
}
