...
class DaysOfWeekAdapter extends BaseAdapter {
   ...
   private int positionToDayOfWeek(int var1) {
      int var2 = var1 + this.firstDayOfWeek;
   ...
   public View getView(int var1, View var2, ViewGroup var3) {
      ...
      if (var2 == null) {
         var4 = (TextView)LayoutInflater.from(var3.getContext()).inflate(R.layout.mtrl_calendar_day_of_week, var3, false);
      }
      ...
      var4.setContentDescription(String.format(var3.getContext().getString(R.string.mtrl_picker_day_of_week_column_header), this.calendar.getDisplayName(7, 2, Locale.getDefault())));
      return var4;
   }
}
