...
class YearGridAdapter extends RecyclerView.Adapter<YearGridAdapter.ViewHolder> {
   ...
   private OnClickListener createYearClickListener(final int var1) {
      return new OnClickListener() {
         public void onClick(View var1x) {
            ...
            var2 = YearGridAdapter.this.materialCalendar.getCalendarConstraints().clamp(var2);
   ...
   public void onBindViewHolder(YearGridAdapter.ViewHolder var1, int var2) {
      ...
      String var3 = var1.textView.getContext().getString(R.string.mtrl_picker_navigate_to_year_description);
   ...
   public YearGridAdapter.ViewHolder onCreateViewHolder(ViewGroup var1, int var2) {
      return new YearGridAdapter.ViewHolder((TextView)LayoutInflater.from(var1.getContext()).inflate(R.layout.mtrl_calendar_year, var1, false));
   }
