...
abstract class DateFormatTextWatcher implements TextWatcher {
   ...
   DateFormatTextWatcher(String var1, DateFormat var2, TextInputLayout var3, CalendarConstraints var4) {
      ...
      this.outOfRange = var3.getContext().getString(R.string.mtrl_picker_out_of_range);
   }
   ...
   public void onTextChanged(CharSequence var1, int var2, int var3, int var4) {
      if (TextUtils.isEmpty(var1)) {
         ...
         try {
            ...
            String var7 = this.textInputLayout.getContext().getString(R.string.mtrl_picker_invalid_format);
            String var8 = String.format(this.textInputLayout.getContext().getString(R.string.mtrl_picker_invalid_format_use), this.formatHint);
            String var9 = String.format(this.textInputLayout.getContext().getString(R.string.mtrl_picker_invalid_format_example), this.dateFormat.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis())));
            TextInputLayout var12 = this.textInputLayout;
