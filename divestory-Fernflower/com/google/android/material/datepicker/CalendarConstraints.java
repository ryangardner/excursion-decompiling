...
public final class CalendarConstraints implements Parcelable {
   ...
   Month clamp(Month var1) {
      if (var1.compareTo(this.start) < 0) {
         return this.start;
      } else {
         Month var2 = var1;
         if (var1.compareTo(this.end) > 0) {
            var2 = this.end;
         }
   ...
   public boolean equals(Object var1) {
      ...
      if (this == var1) {
         ...
         CalendarConstraints var3 = (CalendarConstraints)var1;
         if (!this.start.equals(var3.start) || !this.end.equals(var3.end) || !this.openAt.equals(var3.openAt) || !this.validator.equals(var3.validator)) {
            var2 = false;
         }
   ...
   boolean isWithinBounds(long var1) {
      Month var3 = this.start;
      boolean var4 = true;
      if (var3.getDay(1) <= var1) {
         var3 = this.end;
