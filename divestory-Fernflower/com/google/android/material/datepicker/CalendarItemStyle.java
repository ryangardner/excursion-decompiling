...
final class CalendarItemStyle {
   ...
   static CalendarItemStyle create(Context var0, int var1) {
      ...
      TypedArray var3 = var0.obtainStyledAttributes(var1, R.styleable.MaterialCalendarItem);
      Rect var4 = new Rect(var3.getDimensionPixelOffset(R.styleable.MaterialCalendarItem_android_insetLeft, 0), var3.getDimensionPixelOffset(R.styleable.MaterialCalendarItem_android_insetTop, 0), var3.getDimensionPixelOffset(R.styleable.MaterialCalendarItem_android_insetRight, 0), var3.getDimensionPixelOffset(R.styleable.MaterialCalendarItem_android_insetBottom, 0));
      ColorStateList var5 = MaterialResources.getColorStateList(var0, var3, R.styleable.MaterialCalendarItem_itemFillColor);
      ColorStateList var6 = MaterialResources.getColorStateList(var0, var3, R.styleable.MaterialCalendarItem_itemTextColor);
      ColorStateList var7 = MaterialResources.getColorStateList(var0, var3, R.styleable.MaterialCalendarItem_itemStrokeColor);
      var1 = var3.getDimensionPixelSize(R.styleable.MaterialCalendarItem_itemStrokeWidth, 0);
      ShapeAppearanceModel var8 = ShapeAppearanceModel.builder(var0, var3.getResourceId(R.styleable.MaterialCalendarItem_itemShapeAppearance, 0), var3.getResourceId(R.styleable.MaterialCalendarItem_itemShapeAppearanceOverlay, 0)).build();
      var3.recycle();
