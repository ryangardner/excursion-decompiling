...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
   ...
   public MaterialAlertDialogBuilder(Context var1, int var2) {
      ...
      Theme var6 = var3.getTheme();
      this.backgroundInsets = MaterialDialogs.getDialogBackgroundInsets(var3, DEF_STYLE_ATTR, DEF_STYLE_RES);
      var2 = MaterialColors.getColor(var3, R.attr.colorSurface, this.getClass().getCanonicalName());
      MaterialShapeDrawable var4 = new MaterialShapeDrawable(var3, (AttributeSet)null, DEF_STYLE_ATTR, DEF_STYLE_RES);
      ...
      if (VERSION.SDK_INT >= 28) {
         ...
         float var5 = var7.getDimension(this.getContext().getResources().getDisplayMetrics());
         if (var7.type == 5 && var5 >= 0.0F) {
            var4.setCornerSize(var5);
         }
      }
   ...
   private static Context createMaterialAlertDialogThemedContext(Context var0) {
      ...
      var0 = MaterialThemeOverlay.wrap(var0, (AttributeSet)null, DEF_STYLE_ATTR, DEF_STYLE_RES);
   ...
   private static int getOverridingThemeResId(Context var0, int var1) {
      int var2 = var1;
      if (var1 == 0) {
         var2 = getMaterialAlertDialogThemeOverlay(var0);
      }
