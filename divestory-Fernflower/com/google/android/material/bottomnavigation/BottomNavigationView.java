...
public class BottomNavigationView extends FrameLayout {
   ...
   public BottomNavigationView(Context var1, AttributeSet var2, int var3) {
      ...
      TintTypedArray var6 = ThemeEnforcement.obtainTintedStyledAttributes(var1, var2, R.styleable.BottomNavigationView, var3, R.style.Widget_Design_BottomNavigationView, R.styleable.BottomNavigationView_itemTextAppearanceInactive, R.styleable.BottomNavigationView_itemTextAppearanceActive);
      if (var6.hasValue(R.styleable.BottomNavigationView_itemIconTint)) {
         this.menuView.setIconTintList(var6.getColorStateList(R.styleable.BottomNavigationView_itemIconTint));
      } else {
         BottomNavigationMenuView var5 = this.menuView;
         var5.setIconTintList(var5.createDefaultColorStateList(16842808));
      }

      this.setItemIconSize(var6.getDimensionPixelSize(R.styleable.BottomNavigationView_itemIconSize, this.getResources().getDimensionPixelSize(R.dimen.design_bottom_navigation_icon_size)));
      if (var6.hasValue(R.styleable.BottomNavigationView_itemTextAppearanceInactive)) {
         this.setItemTextAppearanceInactive(var6.getResourceId(R.styleable.BottomNavigationView_itemTextAppearanceInactive, 0));
      }

      if (var6.hasValue(R.styleable.BottomNavigationView_itemTextAppearanceActive)) {
         this.setItemTextAppearanceActive(var6.getResourceId(R.styleable.BottomNavigationView_itemTextAppearanceActive, 0));
      }

      if (var6.hasValue(R.styleable.BottomNavigationView_itemTextColor)) {
         this.setItemTextColor(var6.getColorStateList(R.styleable.BottomNavigationView_itemTextColor));
      }
      ...
      if (var6.hasValue(R.styleable.BottomNavigationView_elevation)) {
         ViewCompat.setElevation(this, (float)var6.getDimensionPixelSize(R.styleable.BottomNavigationView_elevation, 0));
      }

      ColorStateList var7 = MaterialResources.getColorStateList(var1, var6, R.styleable.BottomNavigationView_backgroundTint);
      DrawableCompat.setTintList(this.getBackground().mutate(), var7);
      this.setLabelVisibilityMode(var6.getInteger(R.styleable.BottomNavigationView_labelVisibilityMode, -1));
      this.setItemHorizontalTranslationEnabled(var6.getBoolean(R.styleable.BottomNavigationView_itemHorizontalTranslationEnabled, true));
      var3 = var6.getResourceId(R.styleable.BottomNavigationView_itemBackground, 0);
      if (var3 != 0) {
         this.menuView.setItemBackgroundRes(var3);
      } else {
         this.setItemRippleColor(MaterialResources.getColorStateList(var1, var6, R.styleable.BottomNavigationView_itemRippleColor));
      }

      if (var6.hasValue(R.styleable.BottomNavigationView_menu)) {
         this.inflateMenu(var6.getResourceId(R.styleable.BottomNavigationView_menu, 0));
      }
      ...
      this.menu.setCallback(new MenuBuilder.Callback() {
         public boolean onMenuItemSelected(MenuBuilder var1, MenuItem var2) {
            BottomNavigationView.OnNavigationItemReselectedListener var4 = BottomNavigationView.this.reselectedListener;
            boolean var3 = true;
            if (var4 != null && var2.getItemId() == BottomNavigationView.this.getSelectedItemId()) {
               BottomNavigationView.this.reselectedListener.onNavigationItemReselected(var2);
               return true;
            } else {
               if (BottomNavigationView.this.selectedListener == null || BottomNavigationView.this.selectedListener.onNavigationItemSelected(var2)) {
                  var3 = false;
               }
