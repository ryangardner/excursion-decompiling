...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
   ...
   private FrameLayout getCustomParentForBadge(View var1) {
      ...
      Object var3 = null;
      FrameLayout var4 = (FrameLayout)var3;
      if (var1 == var2) {
         var4 = (FrameLayout)var3;
   ...
   public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo var1) {
      ...
      if (var2 != null && var2.isVisible()) {
         CharSequence var5 = this.itemData.getTitle();
         if (!TextUtils.isEmpty(this.itemData.getContentDescription())) {
            var5 = this.itemData.getContentDescription();
         }
      ...
      var4.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(0, 1, this.getItemPosition(), 1, false, this.isSelected()));
      if (this.isSelected()) {
         var4.setClickable(false);
         var4.removeAction(AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_CLICK);
      }

      var4.setRoleDescription(this.getResources().getString(R.string.item_view_role_description));
   }
      ...
      if (var3 != -1) {
         if (var3 != 0) {
            if (var3 != 1) {
               ...
               var2 = this.smallLabel;
               var4 = this.scaleUpFactor;
               this.setViewValues(var2, var4, var4, 4);
            } else {
               this.setViewLayoutParams(this.icon, this.defaultMargin, 49);
               var2 = this.largeLabel;
               var4 = this.scaleDownFactor;
               this.setViewValues(var2, var4, var4, 4);
   ...
   public void setTitle(CharSequence var1) {
      ...
      if (var3 != null) {
         if (TextUtils.isEmpty(var3.getTooltipText())) {
            var4 = var1;
         } else {
            var4 = this.itemData.getTooltipText();
         }
      }
