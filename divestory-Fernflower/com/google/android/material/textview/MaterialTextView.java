...
public class MaterialTextView extends AppCompatTextView {
   ...
   public MaterialTextView(Context var1, AttributeSet var2, int var3, int var4) {
      super(MaterialThemeOverlay.wrap(var1, var2, var3, var4), var2, var3);
   ...
   private void applyLineHeightFromViewAppearance(Theme var1, int var2) {
      TypedArray var3 = var1.obtainStyledAttributes(var2, R.styleable.MaterialTextAppearance);
      var2 = readFirstAvailableDimension(this.getContext(), var3, R.styleable.MaterialTextAppearance_android_lineHeight, R.styleable.MaterialTextAppearance_lineHeight);
      var3.recycle();
      if (var2 >= 0) {
   ...
   private static boolean canApplyTextAppearanceLineHeight(Context var0) {
      return MaterialAttributes.resolveBoolean(var0, R.attr.textAppearanceLineHeightEnabled, true);
   }

   private static int findViewAppearanceResourceId(Theme var0, AttributeSet var1, int var2, int var3) {
      TypedArray var4 = var0.obtainStyledAttributes(var1, R.styleable.MaterialTextView, var2, var3);
      var2 = var4.getResourceId(R.styleable.MaterialTextView_android_textAppearance, -1);
      var4.recycle();
      return var2;
   }
   ...
   private static int readFirstAvailableDimension(Context var0, TypedArray var1, int... var2) {
      ...
      int var4;
      for(var4 = -1; var3 < var2.length && var4 < 0; ++var3) {
   ...
   private static boolean viewAttrsHasLineHeight(Context var0, Theme var1, AttributeSet var2, int var3, int var4) {
      TypedArray var6 = var1.obtainStyledAttributes(var2, R.styleable.MaterialTextView, var3, var4);
      var3 = R.styleable.MaterialTextView_android_lineHeight;
      boolean var5 = false;
      var3 = readFirstAvailableDimension(var0, var6, var3, R.styleable.MaterialTextView_lineHeight);
      var6.recycle();
      if (var3 != -1) {
         var5 = true;
      }
