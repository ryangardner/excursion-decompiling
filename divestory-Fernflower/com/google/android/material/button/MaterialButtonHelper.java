...
class MaterialButtonHelper {
   ...
   private Drawable createBackground() {
      MaterialShapeDrawable var1 = new MaterialShapeDrawable(this.shapeAppearanceModel);
      var1.initializeElevationOverlay(this.materialButton.getContext());
      DrawableCompat.setTintList(var1, this.backgroundTint);
      Mode var2 = this.backgroundTintMode;
      if (var2 != null) {
         DrawableCompat.setTintMode(var1, var2);
      }

      var1.setStroke((float)this.strokeWidth, this.strokeColor);
      MaterialShapeDrawable var8 = new MaterialShapeDrawable(this.shapeAppearanceModel);
      var8.setTint(0);
      float var3 = (float)this.strokeWidth;
      int var4;
      if (this.shouldDrawSurfaceColorStroke) {
         var4 = MaterialColors.getColor(this.materialButton, R.attr.colorSurface);
      } else {
         var4 = 0;
      }

      var8.setStroke(var3, var4);
      if (IS_LOLLIPOP) {
         ...
         RippleDrawable var7 = new RippleDrawable(RippleUtils.sanitizeRippleDrawableColor(this.rippleColor), this.wrapDrawableWithInset(new LayerDrawable(new Drawable[]{var8, var1})), this.maskDrawable);
         ...
         LayerDrawable var6 = new LayerDrawable(new Drawable[]{var8, var1, this.maskDrawable});
   ...
   private void updateStroke() {
      MaterialShapeDrawable var1 = this.getMaterialShapeDrawable();
      MaterialShapeDrawable var2 = this.getSurfaceColorStrokeDrawable();
      if (var1 != null) {
         var1.setStroke((float)this.strokeWidth, this.strokeColor);
         if (var2 != null) {
            float var3 = (float)this.strokeWidth;
   ...
   void loadFromAttributes(TypedArray var1) {
      this.insetLeft = var1.getDimensionPixelOffset(R.styleable.MaterialButton_android_insetLeft, 0);
      ...
      int var2;
      if (var1.hasValue(R.styleable.MaterialButton_cornerRadius)) {
         var2 = var1.getDimensionPixelSize(R.styleable.MaterialButton_cornerRadius, -1);
      ...
      this.checkable = var1.getBoolean(R.styleable.MaterialButton_android_checkable, false);
      int var3 = var1.getDimensionPixelSize(R.styleable.MaterialButton_elevation, 0);
      int var4 = ViewCompat.getPaddingStart(this.materialButton);
      var2 = this.materialButton.getPaddingTop();
      int var5 = ViewCompat.getPaddingEnd(this.materialButton);
      int var6 = this.materialButton.getPaddingBottom();
      if (var1.hasValue(R.styleable.MaterialButton_android_background)) {
         ...
         if (var7 != null) {
            var7.setElevation((float)var3);
         }
      }

      ViewCompat.setPaddingRelative(this.materialButton, var4 + this.insetLeft, var2 + this.insetTop, var5 + this.insetRight, var6 + this.insetBottom);
   }
