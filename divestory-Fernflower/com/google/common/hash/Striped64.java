...
abstract class Striped64 extends Number {
   ...
   final void retryUpdate(long var1, @NullableDecl int[] var3, boolean var4) {
      int var6;
      int var7;
      if (var3 == null) {
      ...
      while(true) {
         ...
         boolean var10001;
         Throwable var56;
         Striped64.Cell var58;
         boolean var59;
         if (var57 != null) {
            int var10 = var57.length;
            if (var10 > 0) {
               label1010: {
                  Striped64.Cell var61 = var57[var10 - 1 & var8];
                  if (var61 == null) {
                     if (this.busy == 0) {
                        var58 = new Striped64.Cell(var1);
                     ...
                     var12 = var61.value;
                     if (var61.cas(var12, this.fn(var12, var1))) {
                        break;
                     }
                                 ...
                                 label998: {
                                    label1040: {
                                       try {
                                          ...
                                          var11 = new Striped64.Cell[var10 << 1];
