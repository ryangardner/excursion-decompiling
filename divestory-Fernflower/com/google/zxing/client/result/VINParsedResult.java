...
public final class VINParsedResult extends ParsedResult {
   ...
   public String getDisplayResult() {
      ...
      var1.append(this.worldManufacturerID);
      var1.append(' ');
      var1.append(this.vehicleDescriptorSection);
      var1.append(' ');
      var1.append(this.vehicleIdentifierSection);
      var1.append('\n');
      String var2 = this.countryCode;
      if (var2 != null) {
         var1.append(var2);
         var1.append(' ');
      }

      var1.append(this.modelYear);
      var1.append(' ');
      var1.append(this.plantCode);
      var1.append(' ');
      var1.append(this.sequentialNumber);
      var1.append('\n');
