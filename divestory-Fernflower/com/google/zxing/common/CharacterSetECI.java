...
public enum CharacterSetECI {
   ...
   static {
      CharacterSetECI var0 = new CharacterSetECI("EUC_KR", 26, 30, new String[]{"EUC-KR"});
      EUC_KR = var0;
      VALUE_TO_ECI = new HashMap();
      NAME_TO_ECI = new HashMap();
      CharacterSetECI[] var1 = values();
      int var2 = var1.length;

      for(int var3 = 0; var3 < var2; ++var3) {
         var0 = var1[var3];
         int[] var4 = var0.values;
         int var5 = var4.length;

         int var6;
         for(var6 = 0; var6 < var5; ++var6) {
            int var7 = var4[var6];
            VALUE_TO_ECI.put(var7, var0);
         }

         NAME_TO_ECI.put(var0.name(), var0);
         String[] var9 = var0.otherEncodingNames;
         var5 = var9.length;

         for(var6 = 0; var6 < var5; ++var6) {
            String var8 = var9[var6];
            NAME_TO_ECI.put(var8, var0);
         }
      }
