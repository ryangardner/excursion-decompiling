   ...
   public BitMatrix sampleGrid(BitMatrix var1, int var2, int var3, PerspectiveTransform var4) throws NotFoundException {
      if (var2 > 0 && var3 > 0) {
         ...
         for(var2 = 0; var2 < var3; ++var2) {
            ...
            int var9;
            for(var9 = 0; var9 < var6; var9 += 2) {
               var7[var9] = (float)(var9 / 2) + 0.5F;
               var7[var9 + 1] = var8 + 0.5F;
            }

            var4.transformPoints(var7);
            checkAndNudgePoints(var1, var7);

            for(var9 = 0; var9 < var6; var9 += 2) {
               try {
                  if (var1.get((int)var7[var9], (int)var7[var9 + 1])) {
