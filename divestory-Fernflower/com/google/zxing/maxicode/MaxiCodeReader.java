...
public final class MaxiCodeReader implements Reader {
      ...
      if (var1 == null) {
         ...
         for(int var6 = 0; var6 < 33; ++var6) {
            ...
            for(int var8 = 0; var8 < 30; ++var8) {
               if (var0.get((var8 * var4 + var4 / 2 + (var6 & 1) * var4 / 2) / 30 + var2, var7 + var3)) {
                  var9.set(var8, var6);
               }
            }
         }
   ...
   public Result decode(BinaryBitmap var1, Map<DecodeHintType, ?> var2) throws NotFoundException, ChecksumException, FormatException {
      if (var2 != null && var2.containsKey(DecodeHintType.PURE_BARCODE)) {
         ...
         DecoderResult var6 = this.decoder.decode(var3, var2);
         ResultPoint[] var4 = NO_POINTS;
         Result var5 = new Result(var6.getText(), var6.getRawBytes(), var4, BarcodeFormat.MAXICODE);
         String var7 = var6.getECLevel();
         if (var7 != null) {
            var5.putMetadata(ResultMetadataType.ERROR_CORRECTION_LEVEL, var7);
         }
