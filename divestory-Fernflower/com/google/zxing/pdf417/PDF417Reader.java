...
public final class PDF417Reader implements Reader, MultipleBarcodeReader {
   private static Result[] decode(BinaryBitmap var0, Map<DecodeHintType, ?> var1, boolean var2) throws NotFoundException, FormatException, ChecksumException {
      ArrayList var3 = new ArrayList();
      PDF417DetectorResult var7 = Detector.detect(var0, var1, var2);

      Result var8;
      for(Iterator var6 = var7.getPoints().iterator(); var6.hasNext(); var3.add(var8)) {
         ResultPoint[] var4 = (ResultPoint[])var6.next();
         DecoderResult var5 = PDF417ScanningDecoder.decode(var7.getBits(), var4[4], var4[5], var4[6], var4[7], getMinCodewordWidth(var4), getMaxCodewordWidth(var4));
   ...
   private static int getMaxWidth(ResultPoint var0, ResultPoint var1) {
      return var0 != null && var1 != null ? (int)Math.abs(var0.getX() - var1.getX()) : 0;
   }
   ...
   private static int getMinWidth(ResultPoint var0, ResultPoint var1) {
      return var0 != null && var1 != null ? (int)Math.abs(var0.getX() - var1.getX()) : Integer.MAX_VALUE;
   }
   ...
   public Result decode(BinaryBitmap var1, Map<DecodeHintType, ?> var2) throws NotFoundException, FormatException, ChecksumException {
   ...
   public Result[] decodeMultiple(BinaryBitmap var1, Map<DecodeHintType, ?> var2) throws NotFoundException {
      try {
         Result[] var4 = decode(var1, var2, true);
         return var4;
