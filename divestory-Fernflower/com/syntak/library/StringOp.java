...
public class StringOp {
   ...
   public static void changeSearchViewTextColor(View var0, int var1) {
      if (var0 != null) {
         if (var0 instanceof TextView) {
            ((TextView)var0).setTextColor(var1);
         } else if (var0 instanceof ViewGroup) {
            ViewGroup var3 = (ViewGroup)var0;

            for(int var2 = 0; var2 < var3.getChildCount(); ++var2) {
               changeSearchViewTextColor(var3.getChildAt(var2), var1);
            }
         }
      }
   ...
   public static Bitmap encodeQR(String var0) {
      QRCodeWriter var1 = new QRCodeWriter();

      WriterException var10000;
      label51: {
         int var2;
         int var3;
         Bitmap var10;
         ...
         boolean var10001;
         try {
            var12 = var1.encode(var0, BarcodeFormat.QR_CODE, 512, 512);
            var2 = var12.getWidth();
            var3 = var12.getHeight();
            var10 = Bitmap.createBitmap(var2, var3, Config.RGB_565);
      ...
      WriterException var11 = var10000;
   ...
   public static String[] getStringArrayFromIntent(Intent var0) {
      ArrayList var3 = getUriFromIntent(var0);
      String[] var1 = new String[var3.size()];

      for(int var2 = 0; var2 < var3.size(); ++var2) {
         var1[var2] = ((Uri)var3.get(var2)).getPath();
      }

      return var1;
   }

   public static ArrayList<Uri> getUriFromIntent(Intent var0) {
      ArrayList var1 = new ArrayList();
      Uri var2 = var0.getData();
      if (var2 != null) {
         var1.add(var2);
      } else if (var0.getClipData() != null) {
         ClipData var4 = var0.getClipData();

         for(int var3 = 0; var3 < var4.getItemCount(); ++var3) {
            var1.add(var4.getItemAt(var3).getUri());
         }
      }
   ...
   public static Uri getUriFromPath(String var0) {
      return Uri.fromFile(new File("/sdcard/sample.jpg"));
   }
   ...
   public static boolean highlightSearched(TextView var0, String var1, String var2) {
      ...
      if (var1 != null && var1.length() > 0) {
         ...
         StringBuilder var8 = new StringBuilder();
         var8.append("<font color='");
         var8.append(var4);
         var8.append("'>");
         var4 = var8.toString();
         int var5 = var3.toLowerCase().indexOf(var1.toLowerCase(), 0);

         int var6;
         int var7;
         for(var2 = var3; var5 >= 0; var5 = var2.toLowerCase().indexOf(var1.toLowerCase(), var5 + var6 + var7 + 7)) {
            StringBuilder var9 = new StringBuilder();
            var9.append(var2.substring(0, var5));
            var9.append(var4);
            var9.append(var2.substring(var5, var1.length() + var5));
            var9.append("</font>");
            var9.append(var2.substring(var1.length() + var5));
            var2 = var9.toString();
            var6 = var4.length();
            var7 = var1.length();
         }

         var0.setText(Html.fromHtml(var2));
         return true;
      } else {
         return false;
      }
   ...
   public static void setTextViewMaxWidth(TextView var0, int var1) {
      try {
         Field var2 = var0.getClass().getDeclaredField("mMaxWidth");
