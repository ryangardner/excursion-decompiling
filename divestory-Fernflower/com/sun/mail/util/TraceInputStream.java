...
public class TraceInputStream extends FilterInputStream {
   ...
   public TraceInputStream(InputStream var1, OutputStream var2) {
      super(var1);
      this.traceOut = var2;
   }
   ...
   public int read(byte[] var1, int var2, int var3) throws IOException {
      ...
      if (this.trace && var4 != -1) {
         if (this.quote) {
            for(var3 = 0; var3 < var4; ++var3) {
               this.writeByte(var1[var2 + var3]);
            }
         } else {
            this.traceOut.write(var1, var2, var4);
         }
      }
