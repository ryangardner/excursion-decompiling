...
public abstract class EventListener {
   ...
   public void canceled(Call var1) {
      Intrinsics.checkParameterIsNotNull(var1, "call");
   }

   public void connectEnd(Call var1, InetSocketAddress var2, Proxy var3, Protocol var4) {
      Intrinsics.checkParameterIsNotNull(var1, "call");
      Intrinsics.checkParameterIsNotNull(var2, "inetSocketAddress");
      Intrinsics.checkParameterIsNotNull(var3, "proxy");
   }

   public void connectFailed(Call var1, InetSocketAddress var2, Proxy var3, Protocol var4, IOException var5) {
      Intrinsics.checkParameterIsNotNull(var1, "call");
      Intrinsics.checkParameterIsNotNull(var2, "inetSocketAddress");
      Intrinsics.checkParameterIsNotNull(var3, "proxy");
   ...
   public void dnsEnd(Call var1, String var2, List<InetAddress> var3) {
      Intrinsics.checkParameterIsNotNull(var1, "call");
   ...
   public void proxySelectEnd(Call var1, HttpUrl var2, List<Proxy> var3) {
      Intrinsics.checkParameterIsNotNull(var1, "call");
      Intrinsics.checkParameterIsNotNull(var2, "url");
      Intrinsics.checkParameterIsNotNull(var3, "proxies");
   }

   public void proxySelectStart(Call var1, HttpUrl var2) {
      Intrinsics.checkParameterIsNotNull(var1, "call");
      Intrinsics.checkParameterIsNotNull(var2, "url");
   }
   ...
   public void requestFailed(Call var1, IOException var2) {
      Intrinsics.checkParameterIsNotNull(var1, "call");
      Intrinsics.checkParameterIsNotNull(var2, "ioe");
   }
   ...
   public void responseFailed(Call var1, IOException var2) {
      Intrinsics.checkParameterIsNotNull(var1, "call");
      Intrinsics.checkParameterIsNotNull(var2, "ioe");
   }
   ...
   public void satisfactionFailure(Call var1, Response var2) {
      Intrinsics.checkParameterIsNotNull(var1, "call");
      Intrinsics.checkParameterIsNotNull(var2, "response");
   }

   public void secureConnectEnd(Call var1, Handshake var2) {
      Intrinsics.checkParameterIsNotNull(var1, "call");
   }
   ...
   @Metadata(
      bv = {1, 0, 3},
      d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0006"},
      d2 = {"Lokhttp3/EventListener$Factory;", "", "create", "Lokhttp3/EventListener;", "call", "Lokhttp3/Call;", "okhttp"},
      k = 1,
      mv = {1, 1, 16}
   )
