...
@Metadata(
   ...
   d2 = {"Lokhttp3/CipherSuite;", "", "javaName", "", "(Ljava/lang/String;)V", "()Ljava/lang/String;", "-deprecated_javaName", "toString", "Companion", "okhttp"},
   k = 1,
   mv = {1, 1, 16}
)
public final class CipherSuite {
   public static final CipherSuite.Companion Companion = new CipherSuite.Companion((DefaultConstructorMarker)null);
   private static final Map<String, CipherSuite> INSTANCES = (Map)(new LinkedHashMap());
   private static final Comparator<String> ORDER_BY_NAME = (Comparator)(new Comparator<String>() {
      public int compare(String var1, String var2) {
         Intrinsics.checkParameterIsNotNull(var1, "a");
   ...
   // $FF: synthetic method
   public CipherSuite(String var1, DefaultConstructorMarker var2) {
      this(var1);
   }

   @JvmStatic
   public static final CipherSuite forJavaName(String var0) {
      synchronized(CipherSuite.class){}

      CipherSuite var3;
      try {
         var3 = Companion.forJavaName(var0);
      } finally {
         ;
      }
   ...
   public static final class Companion {
      ...
      private final CipherSuite init(String var1, int var2) {
         CipherSuite var3 = new CipherSuite(var1, (DefaultConstructorMarker)null);
         CipherSuite.INSTANCES.put(var1, var3);
         return var3;
      }

      private final String secondaryName(String var1) {
         StringBuilder var2;
         String var3;
         if (StringsKt.startsWith$default(var1, "TLS_", false, 2, (Object)null)) {
            ...
            var3 = var1;
            if (StringsKt.startsWith$default(var1, "SSL_", false, 2, (Object)null)) {
               var2 = new StringBuilder();
               var2.append("TLS_");
               if (var1 == null) {
                  throw new TypeCastException("null cannot be cast to non-null type java.lang.String");
      ...
      @JvmStatic
      public final CipherSuite forJavaName(String var1) {
         synchronized(this){}
         ...
         label185: {
            ...
            try {
               ...
               var2 = (CipherSuite)CipherSuite.INSTANCES.get(var1);
            ...
            CipherSuite var3 = var2;
            if (var2 != null) {
               return var3;
            }

            try {
               var2 = (CipherSuite)CipherSuite.INSTANCES.get(((CipherSuite.Companion)this).secondaryName(var1));
            ...
            if (var2 == null) {
               try {
                  var3 = new CipherSuite(var1, (DefaultConstructorMarker)null);
