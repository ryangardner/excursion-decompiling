...
public final class DeferredSocketAdapter implements SocketAdapter {
   ...
   public DeferredSocketAdapter(DeferredSocketAdapter.Factory var1) {
      Intrinsics.checkParameterIsNotNull(var1, "socketAdapterFactory");
      super();
      this.socketAdapterFactory = var1;
   }

   private final SocketAdapter getDelegate(SSLSocket var1) {
      synchronized(this){}

      SocketAdapter var4;
      try {
         if (this.delegate == null && this.socketAdapterFactory.matchesSocket(var1)) {
            this.delegate = this.socketAdapterFactory.create(var1);
         }
   ...
   public void configureTlsExtensions(SSLSocket var1, String var2, List<? extends Protocol> var3) {
      ...
      SocketAdapter var4 = this.getDelegate(var1);
      if (var4 != null) {
   ...
   public String getSelectedProtocol(SSLSocket var1) {
      Intrinsics.checkParameterIsNotNull(var1, "sslSocket");
      SocketAdapter var2 = this.getDelegate(var1);
      String var3;
      if (var2 != null) {
   ...
   @Metadata(
      bv = {1, 0, 3},
      d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&J\u0010\u0010\u0006\u001a\u00020\u00072\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\b"},
      d2 = {"Lokhttp3/internal/platform/android/DeferredSocketAdapter$Factory;", "", "create", "Lokhttp3/internal/platform/android/SocketAdapter;", "sslSocket", "Ljavax/net/ssl/SSLSocket;", "matchesSocket", "", "okhttp"},
      k = 1,
      mv = {1, 1, 16}
   )
   public interface Factory {
      SocketAdapter create(SSLSocket var1);
