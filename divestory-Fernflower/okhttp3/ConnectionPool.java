...
public final class ConnectionPool {
   ...
   public ConnectionPool(int var1, long var2, TimeUnit var4) {
      Intrinsics.checkParameterIsNotNull(var4, "timeUnit");
      this(new RealConnectionPool(TaskRunner.INSTANCE, var1, var2, var4));
   }

   public ConnectionPool(RealConnectionPool var1) {
